...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Impostazioni di tono e lunghezza";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot sta analizzando la conversazione e creando una risposta personalizzata.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "La risposta suggerita è pronta. Rivedi il suggerimento prima di inviarlo.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Controlla la tua risposta prima di inviarla.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Suggerimento AI";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Il sistema non è riuscito a estrarre il riepilogo del ticket. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Il sistema ha generato una risposta non valida. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Il sistema non è riuscito a convalidare la tua licenza. Controlla le tue credenziali e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Il sistema non è riuscito a generare un prompt. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Il sistema non è riuscito a salvare la risposta. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "L'AI Support Copilot è scaduto. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot è temporaneamente non disponibile. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Il sistema ha riscontrato un errore di autenticazione. Controlla le tue credenziali di AI Support Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Il sistema non può connettersi a AI Support Copilot. Controlla la tua connessione di rete e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Il sistema ha riscontrato un errore nel database. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Il sistema non è riuscito a decifrare i dati. Per assistenza, contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Il sistema non è riuscito a crittografare i dati. Per assistenza, contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Si è verificato un errore imprevisto. Riprova o contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Il saldo del tuo credito è insufficiente. Aggiungi crediti al tuo account e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Il sistema ha riscontrato un errore interno. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Il tuo input non è valido. Controlla i tuoi dati e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "La tua richiesta utilizza un formato non valido. Controlla i dati inseriti e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Il sistema non è riuscito a verificare la firma della richiesta. Controlla la tua chiave di licenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Scegli una valutazione a stelle compresa tra 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "I dati del tuo biglietto non sono validi o non sono validi. Controlla i dati inseriti e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "L'ID di traccia deve utilizzare un formato UUID valido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Il sistema non è riuscito a trovare l'articolo della knowledge base.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Il sistema ha già registrato questa licenza. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "La tua licenza AI è scaduta. Rinnova l'abbonamento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licenza non è valida. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Il sistema non è riuscito a trovare la tua licenza. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "La tua licenza AI è stata sospesa. Per assistenza, contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La chiave API del provider AI non è valida. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Il sistema non è riuscito a trovare alcun articolo pertinente della knowledge base.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot ha restituito un errore. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Hai superato il limite di tariffa. Riprova tra qualche istante.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Il sistema non è riuscito a generare un suggerimento di intelligenza artificiale.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Il sistema ha riscontrato un errore durante la ricerca nella knowledge base. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot è temporaneamente non disponibile. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Il sistema ha impiegato troppo tempo per rispondere. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Mancano i dati crittografati richiesti.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Le credenziali del tuo client OAuth non sono valide. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Il tuo token OAuth non è valido o il tuo provider lo ha revocato. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Il tuo token OAuth è scaduto. Effettua nuovamente l'autenticazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Il sistema non è riuscito a decifrare i dati del ticket. Controlla le chiavi di crittografia e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "I dati forniti non sono validi o danneggiati. Inserisci nuovamente le informazioni e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Il sistema non è riuscito a sanificare i dati sensibili. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Il sistema è scaduto durante la sanificazione dei dati. Riprova.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Hai inviato troppe richieste. Riprova tra qualche istante.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Il sistema non è riuscito a trovare il record richiesto.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot è temporaneamente non disponibile. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Non sei autorizzato ad accedere a questo biglietto. Controlla le tue autorizzazioni e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Il sistema non è riuscito a trovare il biglietto. Controlla le informazioni sul biglietto e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Il sistema non è riuscito a convalidare la tua richiesta. Controlla i dati inseriti e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Il sistema ha riscontrato un errore di esecuzione. Riprova.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Rivedi i dati sanificati, quindi conferma di essere pronto a generare una risposta.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Il sistema ha caricato e sanificato i dati (risposte%s ). Controlla i dati sanificati prima di generare una risposta suggerita.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Elimina valutazione";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot ha trovato i seguenti articoli della knowledge base:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Modifica risposta:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Il sistema non è riuscito a generare un suggerimento. Riprova più tardi.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generazione di una risposta...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generazione di suggerimenti AI...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Il sistema non è riuscito a generare un suggerimento: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Quanto è stato utile questo suggerimento?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserisci nella risposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Inserisci una data valida.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Mancano le informazioni obbligatorie. Controlla i dati inseriti e riprova.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Inserisci le informazioni richieste in %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "Il sistema ha riscontrato un errore di rete. Riprova.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Il sistema ha riscontrato un errore di rete: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Il sistema non ha generato alcun suggerimento. Riprova.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Il sistema non ha utilizzato alcun articolo della knowledge base per generare questa risposta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Questo ticket non ha ancora ricevuto risposte.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Il sistema non è riuscito a caricare i dati sanificati. Ricarica i dati del ticket.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Inserisci un oggetto.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "L'operazione %s non è riuscita. Riprova.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Seleziona una valutazione.";
$_ADMINLANG['aiSuggestions']['processing'] = "Elaborando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Il sistema sta elaborando la tua richiesta. Attendi prego...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Valuta il suggerimento.";
...
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Il sistema non è riuscito a salvare la tua valutazione. Riprova.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Il sistema ha utilizzato i seguenti articoli della knowledge base per generare questa risposta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Rigenera";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Hai raggiunto il massimo di tre rigenerazioni. Utilizza il suggerimento attuale.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Rigenerante...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Ti restano le rigenerazioni %s .";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Il sistema sta rimuovendo le informazioni sensibili e si sta preparando ad analizzare i tuoi contenuti.";
...
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Il sistema ha rigenerato la tua risposta";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Esamina attentamente i dati del biglietto sanificato di seguito. Rimuovi o maschera tutte le informazioni sensibili prima di generare suggerimenti di intelligenza artificiale.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Rivedi i dati igienizzati";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Il sistema non è riuscito a sanificare i dati del ticket. Riprova.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Il sistema non è riuscito a caricare i dati del ticket.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Il sistema non è riuscito a trovare la casella di risposta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Data sconosciuta";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Errore sconosciuto";
$_ADMINLANG['aiSuggestions']['youRated'] = "Hai valutato questa risposta:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS non supporta la versione PHP <strong>:version</strong>. WHMCS <strong>supporta solo le versioni PHP da :minVersion a :maxVersion.</strong>";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "Non puoi aggiungere un metodo di pagamento per questo gateway di pagamento tramite l'Area di amministrazione.";
