...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Ajustes de tono y longitud";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot está analizando la conversación y elaborando una respuesta personalizada.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "La respuesta sugerida está lista. Revisa la sugerencia antes de enviarla.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Revisa tu respuesta antes de enviarla.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugerencia de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "El sistema no pudo extraer el resumen del ticket. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "El sistema generó una respuesta no válida. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "El sistema no pudo validar su licencia. Compruebe sus credenciales e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "El sistema no pudo generar un mensaje. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "El sistema no pudo guardar la respuesta. Inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "Se agotó el tiempo de espera del copiloto de soporte de IA. Inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot no está disponible temporalmente. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "El sistema detectó un error de autenticación. Comprueba tus credenciales de AI Support Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "El sistema no puede conectarse a AI Support Copilot. Comprueba la conexión de red e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "El sistema encontró un error en la base de datos. Inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "El sistema no pudo descifrar los datos. Para obtener ayuda, ponte en contacto con el servicio de asistencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "El sistema no pudo cifrar los datos. Para obtener ayuda, ponte en contacto con el servicio de asistencia.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Su saldo crediticio es insuficiente. Añade créditos a tu cuenta e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "El sistema detectó un error interno. Vuelva a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "La entrada no es válida. Comprueba los datos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Tu solicitud utiliza un formato no válido. Comprueba los datos introducidos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "El sistema no pudo verificar la firma de la solicitud. Comprueba tu clave de licencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Elige una valoración de estrellas entre 1 y 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Los datos de tu billete no son válidos o están mal formados. Comprueba los datos introducidos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "El identificador de seguimiento debe utilizar un formato de UUID válido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "El sistema no pudo encontrar el artículo de la base de conocimiento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "El sistema ya ha registrado esta licencia. Compruebe la configuración e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Tu licencia de IA ha caducado. Renueva tu suscripción.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licencia no es válida. Compruebe la configuración e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "El sistema no pudo encontrar su licencia. Compruebe la configuración e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Se ha suspendido tu licencia de IA. Para obtener ayuda, ponte en contacto con el servicio de asistencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La clave de API del proveedor de IA no es válida. Comprueba la configuración e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "El sistema no pudo encontrar ningún artículo relevante de la base de conocimientos.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot ha devuelto un error. Vuelve a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Has superado tu límite de tarifa. Vuelve a intentarlo en unos instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "El sistema no pudo generar una sugerencia de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "El sistema encontró un error al buscar en la base de conocimientos. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot no está disponible temporalmente. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "El sistema tardó demasiado en responder. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Faltan los datos cifrados necesarios.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Tus credenciales de cliente de OAuth no son válidas. Comprueba la configuración e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Tu token de OAuth no es válido o tu proveedor lo ha revocado. Comprueba la configuración e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Tu token de OAuth ha caducado. Vuelve a autenticarte e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "El sistema no pudo descifrar los datos del ticket. Compruebe las claves de cifrado e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Los datos proporcionados no son válidos o están dañados. Vuelva a introducir la información e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "El sistema no pudo desinfectar los datos confidenciales. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Se agotó el tiempo de espera del sistema mientras se desinfectaban los datos. Vuelva a intentarlo.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Has enviado demasiadas solicitudes. Vuelve a intentarlo en unos instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "El sistema no pudo encontrar el registro solicitado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot no está disponible temporalmente. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "No tienes permiso para acceder a esta entrada. Comprueba tus permisos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "El sistema no pudo encontrar el billete. Comprueba la información del billete e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "El sistema no pudo validar su solicitud. Comprueba los datos introducidos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "El sistema detectó un error de ejecución. Vuelva a intentarlo.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Revisa los datos desinfectados y, a continuación, confirma que estás listo para generar una respuesta.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "El sistema ha cargado y desinfectado los datos (respuestas de%s ). Revisa los datos desinfectados antes de generar una respuesta sugerida.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Eliminar calificación";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot encontró los siguientes artículos de la base de conocimiento:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Editar respuesta:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "El sistema no pudo generar ninguna sugerencia. Vuelve a intentarlo más tarde.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generando una respuesta...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generando una sugerencia de IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "El sistema no pudo generar una sugerencia: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "¿Qué tan útil fue esta sugerencia?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insertar en la respuesta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Introduzca una fecha válida.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Te falta la información requerida. Comprueba las entradas e inténtalo de nuevo.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Ingresa la información requerida en %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "El sistema detectó un error de red. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "El sistema detectó un error de red: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "El sistema no generó ninguna sugerencia. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "El sistema no utilizó ningún artículo de la base de conocimientos para generar esta respuesta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Este ticket aún no tiene ninguna respuesta.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "El sistema no pudo cargar los datos desinfectados. Recarga los datos del billete.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Introduzca un asunto.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "La operación %s falló. Inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Selecciona una valoración.";
$_ADMINLANG['aiSuggestions']['processing'] = "Procesando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "El sistema está procesando su solicitud. Espere, por favor...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Valora la sugerencia.";
...
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "El sistema no ha podido guardar tu valoración. Vuelve a intentarlo.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "El sistema utilizó los siguientes artículos de la base de conocimiento para generar esta respuesta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Has alcanzado el máximo de tres regeneraciones. Utilice la sugerencia actual.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerador...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Te quedan las regeneraciones %s .";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "El sistema elimina la información confidencial y se prepara para analizar tu contenido.";
...
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "La respuesta se generó correctamente.";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Su respuesta generada por IA está lista";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "El sistema ha regenerado tu respuesta";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Revisa cuidadosamente los datos desinfectados de las entradas que aparecen a continuación. Elimine o oculte toda la información confidencial antes de generar sugerencias de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Revise los datos desinfectados";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "El sistema no pudo desinfectar los datos de las entradas. Inténtalo de nuevo.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "El sistema no pudo cargar los datos del ticket.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "El sistema no pudo encontrar el cuadro de respuesta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Fecha desconocida";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Error desconocido";
$_ADMINLANG['aiSuggestions']['youRated'] = "Calificaste esta respuesta:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS no admite la versión <strong>:version</strong>de PHP. WHMCS <strong>solo</strong> admite las versiones de PHP :minVersion a :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "No puede agregar un método de pago para esta pasarela de pago a través del Área de administración.";
