...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Réglages de tonalité et de longueur";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot analyse la conversation et élabore une réponse personnalisée.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "La réponse que vous suggérez est prête. Passez en revue la suggestion avant de l'envoyer.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Vérifiez votre réponse avant de l'envoyer.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Suggestion d'IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Le système n'a pas pu extraire le résumé du ticket. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Le système a généré une réponse non valide. Essaie encore une fois.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Le système n'a pas pu valider votre licence. Vérifiez vos informations d'identification et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Le système n'a pas pu générer d'invite. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Le système n'a pas pu enregistrer la réponse. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "AI Support Copilot a expiré. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot est temporairement indisponible. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Le système a rencontré une erreur d'authentification. Vérifiez vos informations d'identification AI Support Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Le système ne peut pas se connecter à AI Support Copilot. Vérifiez votre connexion réseau et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Le système a rencontré une erreur de base de données. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Le système n'a pas pu déchiffrer les données. Pour obtenir de l'aide, contactez le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Le système n'a pas pu chiffrer les données. Pour obtenir de l'aide, contactez le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Une erreur inattendue s'est produite. Réessayez ou contactez le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Votre solde créditeur est insuffisant. Ajoutez des crédits à votre compte et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Le système a rencontré une erreur interne. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Votre saisie n'est pas valide. Vérifiez vos données et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Le format de votre demande n'est pas valide. Vérifiez les données saisies et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Le système n'a pas pu vérifier la signature de la demande. Vérifiez votre clé de licence.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Choisissez une note entre 1 et 5 étoiles.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Les données de votre billet ne sont pas valides ou sont mal formées. Vérifiez vos données d'entrée et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "L'ID de trace doit utiliser un format UUID valide.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Le système n'a pas pu trouver l'article de la base de connaissances.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Le système a déjà enregistré cette licence. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Votre licence AI a expiré. Renouvelez votre abonnement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licence n'est pas valide. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Le système n'a pas pu trouver votre licence. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Votre licence AI a été suspendue. Pour obtenir de l'aide, contactez le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La clé d'API du fournisseur d'IA n'est pas valide. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Le système n'a trouvé aucun article pertinent de la base de connaissances.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot a renvoyé une erreur. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Vous avez dépassé votre limite tarifaire. Réessayez dans quelques instants.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Le système n'a pas réussi à générer de suggestion d'IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Le système a rencontré une erreur lors de la recherche dans la base de connaissances. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot est temporairement indisponible. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Le système a mis trop de temps à réagir. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Les données cryptées requises sont manquantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Les informations d'identification de votre client OAuth ne sont pas valides. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Votre jeton OAuth n'est pas valide ou votre fournisseur l'a révoqué. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Votre jeton OAuth a expiré. Authentifiez-vous à nouveau et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Le système n'a pas pu déchiffrer les données du ticket. Vérifiez les clés de chiffrement et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Les données fournies ne sont pas valides ou sont corrompues. Entrez de nouveau les informations et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Le système n'a pas réussi à nettoyer les données sensibles. Essaie encore.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Le système a expiré pendant la désinfection des données. Essaie encore une fois.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Vous avez envoyé trop de demandes. Réessayez dans quelques instants.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Le système n'a pas pu trouver l'enregistrement demandé.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot est temporairement indisponible. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Vous n'êtes pas autorisé à accéder à ce ticket. Vérifiez vos autorisations et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Le système n'a pas pu trouver le ticket. Vérifiez les informations relatives au ticket et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Le système n'a pas pu valider votre demande. Vérifiez votre saisie et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Le système a rencontré une erreur d'exécution. Essaie encore.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Passez en revue les données nettoyées, puis confirmez que vous êtes prêt à générer une réponse.";
$_ADMINLANG['aiSuggestions']['customer'] = "Client";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Le système a chargé et nettoyé les données (réponses%s ). Passez en revue les données nettoyées avant de générer une réponse suggérée.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Supprimer l'évaluation";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot a trouvé les articles suivants de la base de connaissances :";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Modifier la réponse :";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Le système n'a pas pu générer de suggestion. Réessayez plus tard.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Génération d'une réponse...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Génération de suggestions d'IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Le système n'a pas pu générer de suggestion : %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Dans quelle mesure cette suggestion vous a-t-elle été utile ?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insérer dans la réponse";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Entrez une date valide.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Il vous manque les informations requises. Vérifiez vos saisies et réessayez.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Entrez les informations requises dans %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "Le système a rencontré une erreur réseau. Réessayez.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Le système a rencontré une erreur réseau : %s  : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Le système n'a généré aucune suggestion. Réessayez.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Le système n'a utilisé aucun article de la base de connaissances pour générer cette réponse.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Il n'y a pas encore de réponse pour ce ticket.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Le système n'a pas pu charger les données nettoyées. Rechargez les données du ticket.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Entrez un objet.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "L'opération %s a échoué. Réessayez.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Sélectionnez une note.";
$_ADMINLANG['aiSuggestions']['processing'] = "Traitement...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Le système traite votre demande. Veuillez patienter...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Évaluez la suggestion.";
...
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Le système n'a pas pu enregistrer votre note. Réessayez.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Le système a utilisé les articles de la base de connaissances suivants pour générer cette réponse :";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Régénérez";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Vous avez atteint le maximum de trois régénérations. Veuillez utiliser la suggestion actuelle.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Régénérant...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Il vous reste des régénérations %s .";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Le système supprime les informations sensibles et se prépare à analyser votre contenu.";
...
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Le système a régénéré votre réponse";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Lisez attentivement les données des billets assainies ci-dessous. Supprimez ou masquez toutes les informations sensibles avant de générer des suggestions d'IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Examiner les données désinfectées";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Le système n'a pas pu nettoyer les données du ticket. Réessayez.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Le système n'a pas pu charger les données du ticket.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Le système n'a pas pu trouver la boîte de réponse.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Date inconnue";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Erreur inconnue";
$_ADMINLANG['aiSuggestions']['youRated'] = "Vous avez noté cette réponse :";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS ne prend pas en charge la version <strong>:version</strong>de PHP. WHMCS <strong>seul</strong> prend en charge les versions de PHP :minVersion à :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "Vous ne pouvez pas ajouter de mode de paiement pour cette passerelle de paiement via la zone d'administration.";
