...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Tone and Length Settings";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot is analyzing the conversation and crafting a personalized reply.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Your suggested reply is ready. Review the suggestion before sending it.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Review your reply before sending.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "AI Suggestion";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "The system could not extract the ticket digest. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "The system generated an invalid reply. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "The system could not validate your license. Check your credentials and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "The system could not generate a prompt. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "The system could not save the reply. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "AI Support Copilot timed out. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot is temporarily unavailable. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "The system encountered an authentication error. Check your AI Support Copilot credentials.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "The system cannot connect to AI Support Copilot. Check your network connection and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "The system encountered a database error. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "The system couldn’t decrypt the data. For assistance, contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "The system couldn’t encrypt the data. For assistance, contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "An unexpected error occurred. Try again or contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Your credit balance is insufficient. Add credits to your account and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "The system encountered an internal error. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Your input is invalid. Check your data and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Your request uses an invalid format. Check your input data and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "The system couldn’t verify the request signature. Check your license key.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Choose a star rating between 1 and 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Your ticket data is invalid or malformed. Check your input data and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "The trace ID must use a valid UUID format.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "The system could not find the knowledgebase article.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "The system has already registered this license. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Your AI license has expired. Renew your subscription.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "The license is invalid. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "The system could not find your license. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Your AI license has been suspended. For assistance, contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "The AI provider API key is invalid. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "The system could not find any relevant knowledgebase articles.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot returned an error. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "You have exceeded your rate limit. Try again in a few moments.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "The system failed to generate an AI suggestion.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "The system encountered an error while searching the knowledgebase. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot is temporarily unavailable. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "The system took too long to respond. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "The required encrypted data is missing.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Your OAuth client credentials are invalid. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Your OAuth token is invalid, or your provider has revoked it. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Your OAuth token has expired. Re-authenticate and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "The system could not decrypt the ticket data. Check the encryption keys and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "The provided data is invalid or corrupt. Re-enter the information and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "The system failed to sanitize sensitive data. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "The system timed out while sanitizing data. Try again.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "You have sent too many requests. Try again in a few moments.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "The system could not find the requested record.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot is temporarily unavailable. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "You don't have permission to access this ticket. Check your permissions and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "The system could not find the ticket. Check the ticket information and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "The system could not validate your request. Check your input and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "The system encountered an execution error. Try again.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Review the sanitized data, then confirm you are ready to generate a reply.";
$_ADMINLANG['aiSuggestions']['customer'] = "Customer";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "The system has loaded and sanitized the data (%s replies). Review the sanitized data before you generate a suggested reply.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Delete Rating";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot found the following knowledgebase articles:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Edit Reply:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "The system couldn’t generate a suggestion. Try again later.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generating a reply...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generating AI suggestion...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "The system couldn’t generate a suggestion: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "How helpful was this suggestion?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insert into Reply";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Enter a valid date.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "You are missing required information. Check your entries and try again.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Enter the required information in %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "The system encountered a network error. Try again.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "The system encountered a network error: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "The system did not generate a suggestion. Try again.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "The system did not use any knowledgebase articles to generate this reply.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "This ticket does not have any replies yet.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "The system couldn’t load the sanitized data. Reload the ticket data.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Enter a subject.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "The %s operation failed. Try again.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Select a rating.";
$_ADMINLANG['aiSuggestions']['processing'] = "Processing...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "The system is processing your request. Please wait...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Rate the suggestion.";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Rating deleted successfully";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Excellent";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "The system couldn’t save your rating. Try again.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "The system used the following knowledgebase articles to generate this reply:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerate";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "You have reached the maximum of three regenerations. Please use the current suggestion.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerating...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "You have %s regenerations remaining.";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "The system is removing sensitive information and preparing to analyze your content.";
...
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Reply generated successfully.";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Your AI-generated response is ready";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "The system has regenerated your reply";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Carefully review the sanitized ticket data below. Remove or mask all sensitive information before generating AI suggestions.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Review Sanitized Data";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "The system couldn’t sanitize the ticket data. Try again.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "The system could not load the ticket data.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "The system could not find the reply box.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Unknown Date";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Unknown error";
$_ADMINLANG['aiSuggestions']['youRated'] = "You rated this reply:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS does not support PHP version <strong>:version</strong>. WHMCS <strong>only</strong> supports PHP versions :minVersion through :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "You cannot add a payment method for this payment gateway through the Admin Area.";
