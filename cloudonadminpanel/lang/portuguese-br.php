...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Configurações de tom e comprimento";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "O AI Support Copilot está analisando a conversa e criando uma resposta personalizada.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Sua resposta sugerida está pronta. Analise a sugestão antes de enviá-la.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Revise sua resposta antes de enviar.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugestão de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "O sistema não conseguiu extrair o resumo do ticket. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "O sistema gerou uma resposta inválida. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "O sistema não pôde validar sua licença. Verifique suas credenciais e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "O sistema não conseguiu gerar um prompt. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "O sistema não conseguiu salvar a resposta. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "O AI Support Copilot atingiu o tempo limite. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "O AI Support Copilot está temporariamente indisponível. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "O sistema encontrou um erro de autenticação. Verifique suas credenciais do AI Support Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "O sistema não pode se conectar ao AI Support Copilot. Verifique sua conexão de rede e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "O sistema encontrou um erro no banco de dados. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "O sistema não conseguiu descriptografar os dados. Para obter ajuda, entre em contato com o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "O sistema não conseguiu criptografar os dados. Para obter ajuda, entre em contato com o suporte.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Seu saldo de crédito é insuficiente. Adicione créditos à sua conta e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "O sistema encontrou um erro interno. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Sua entrada é inválida. Verifique seus dados e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Sua solicitação usa um formato inválido. Verifique seus dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "O sistema não conseguiu verificar a assinatura da solicitação. Verifique sua chave de licença.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Escolha uma classificação por estrelas entre 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Os dados do seu bilhete são inválidos ou estão malformados. Verifique seus dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "O ID de rastreamento deve usar um formato UUID válido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "O sistema não conseguiu encontrar o artigo da base de conhecimento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "O sistema já registrou essa licença. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Sua licença de IA expirou. Renove sua assinatura.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "A licença é inválida. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "O sistema não conseguiu encontrar sua licença. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Sua licença de IA foi suspensa. Para obter ajuda, entre em contato com o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "A chave da API do provedor de IA é inválida. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "O sistema não encontrou nenhum artigo relevante da base de conhecimento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "O AI Support Copilot retornou um erro. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Você excedeu seu limite de tarifa. Tente novamente em alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "O sistema falhou ao gerar uma sugestão de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "O sistema encontrou um erro ao pesquisar na base de conhecimento. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "O AI Support Copilot está temporariamente indisponível. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "O sistema demorou muito para responder. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Os dados criptografados necessários estão ausentes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Suas credenciais de cliente OAuth são inválidas. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Seu token OAuth é inválido ou seu provedor o revogou. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Seu token OAuth expirou. Reautentique e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "O sistema não conseguiu descriptografar os dados do ticket. Verifique as chaves de criptografia e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Os dados fornecidos são inválidos ou estão corrompidos. Insira as informações novamente e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "O sistema falhou ao limpar dados confidenciais. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "O sistema atingiu o tempo limite ao limpar os dados. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Você enviou muitos pedidos. Tente novamente em alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "O sistema não conseguiu encontrar o registro solicitado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "O AI Support Copilot está temporariamente indisponível. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Você não tem permissão para acessar esse ticket. Verifique suas permissões e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "O sistema não conseguiu encontrar o tíquete. Verifique as informações do tíquete e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "O sistema não pôde validar sua solicitação. Verifique sua entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "O sistema encontrou um erro de execução. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Revise os dados higienizados e confirme que você está pronto para gerar uma resposta.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "O sistema carregou e higienizou os dados (respostas%s ). Analise os dados higienizados antes de gerar uma resposta sugerida.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Excluir classificação";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "O AI Support Copilot encontrou os seguintes artigos da base de conhecimento:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Editar resposta:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "O sistema não conseguiu gerar uma sugestão. Tente novamente mais tarde.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Gerando uma resposta...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Gerando sugestão de IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "O sistema não conseguiu gerar uma sugestão: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Quão útil foi essa sugestão?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserir na resposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Insira uma data válida.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Você não tem as informações necessárias. Verifique suas entradas e tente novamente.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Insira as informações necessárias em %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "O sistema encontrou um erro de rede. Tente novamente.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "O sistema encontrou um erro de rede: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "O sistema não gerou uma sugestão. Tente novamente.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "O sistema não usou nenhum artigo da base de conhecimento para gerar essa resposta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Este ticket ainda não tem nenhuma resposta.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "O sistema não conseguiu carregar os dados higienizados. Recarregue os dados do ticket.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Insira um assunto.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "A operação %s falhou. Tente novamente.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Selecione uma classificação.";
$_ADMINLANG['aiSuggestions']['processing'] = "Processando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "O sistema está processando sua solicitação. Por favor, espere...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Avalie a sugestão.";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Classificação excluída com sucesso";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Boa";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "O sistema não conseguiu salvar sua avaliação. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "O sistema usou os seguintes artigos da base de conhecimento para gerar essa resposta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Você atingiu o máximo de três regenerações. Use a sugestão atual.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerando...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Você tem regenerações %s restantes.";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "O sistema está removendo informações confidenciais e se preparando para analisar seu conteúdo.";
...
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "O sistema regenerou sua resposta";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Analise cuidadosamente os dados higienizados do tíquete abaixo. Remova ou mascare todas as informações confidenciais antes de gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Revise os dados higienizados";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "O sistema não conseguiu limpar os dados do ticket. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "O sistema não conseguiu carregar os dados do ticket.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "O sistema não conseguiu encontrar a caixa de resposta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Data desconhecida";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Erro desconhecido";
$_ADMINLANG['aiSuggestions']['youRated'] = "Você avaliou esta resposta:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "O WHMCS não suporta a versão <strong>:version</strong>do PHP. WHMCS <strong>apenas</strong> suporta as versões PHP :minVersion a :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "Você não pode adicionar uma forma de pagamento para esse gateway de pagamento por meio da Área Administrativa.";
