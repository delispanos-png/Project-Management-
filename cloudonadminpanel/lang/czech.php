...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Nastavení tónu a délky";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot analyzuje konverzaci a vytváří osobní odpověď.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Vaše navrhovaná odpověď je připravena. Před odesláním si návrh přečtěte.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Před odesláním zkontrolujte svou odpověď.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Návrh AI";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Systém nemohl extrahovat přehled lístků. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Systém vygeneroval neplatnou odpověď. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Systém nemohl ověřit vaši licenci. Zkontrolujte své přihlašovací údaje a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Systém nemohl vygenerovat výzvu. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Systém nemohl uložit odpověď. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "AI Support Copilot vypršel časový limit. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot je dočasně nedostupný. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Systém narazil na chybu ověřování. Zkontrolujte své přihlašovací údaje pro podporu AI Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Systém se nemůže připojit k AI Support Copilot. Zkontrolujte připojení k síti a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Systém narazil na chybu databáze. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Systém nedokázal dešifrovat data. Pro pomoc se obraťte na podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Systém nedokázal zašifrovat data. Pro pomoc kontaktujte podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Došlo k neočekávané chybě. Zkuste to znovu nebo kontaktujte podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Váš úvěrový zůstatek je nedostatečný. Přidejte kredity na svůj účet a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Systém narazil na interní chybu. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Váš vstup je neplatný. Zkontrolujte svá data a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Váš požadavek používá neplatný formát. Zkontrolujte vstupní data a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Systém nemohl ověřit podpis požadavku. Zkontrolujte licenční klíč.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Vyberte si hodnocení hvězdičkami mezi 1 a 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Vaše údaje o vstupenkách jsou neplatné nebo chybné. Zkontrolujte vstupní data a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "ID trasování musí používat platný formát UUID.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Systém nemohl najít článek znalostní báze.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Systém již tuto licenci zaregistroval. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Platnost vaší licence AI vypršela. Obnovte své předplatné.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "Licence je neplatná. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Systém nemohl najít vaši licenci. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Vaše licence na AI byla pozastavena. Pro pomoc kontaktujte podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "Klíč API poskytovatele AI je neplatný. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Systém nenašel žádné relevantní články znalostní báze.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot vrátila chybu. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Překročili jste limit sazby. Zkuste to znovu za pár okamžiků.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Systém nedokázal vygenerovat návrh AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Při vyhledávání znalostní báze došlo k chybě systému. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot je dočasně nedostupný. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Systém trval příliš dlouho, než odpověděl. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Požadovaná šifrovaná data chybí.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Vaše přihlašovací údaje klienta OAuth jsou neplatné. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Váš token OAuth je neplatný, nebo jej váš poskytovatel zrušil. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Platnost vašeho tokenu OAuth vypršela. Znovu ověřte a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Systém nedokázal dešifrovat údaje o lístku. Zkontrolujte šifrovací klíče a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Poskytnuté údaje jsou neplatné nebo poškozené. Znovu zadejte informace a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Systém nedokázal dezinfikovat citlivá data. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Při dezinfekci dat systém vypršel časový limit. Zkuste to znovu.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Poslali jste příliš mnoho žádostí. Zkuste to znovu za pár okamžiků.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Systém nemohl najít požadovaný záznam.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot je dočasně nedostupný. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Nemáte oprávnění k přístupu k této vstupence. Zkontrolujte svá oprávnění a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Systém nemohl najít lístek. Zkontrolujte informace o lístku a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Systém nemohl potvrdit váš požadavek. Zkontrolujte svůj vstup a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Systém narazil na chybu spuštění. Zkuste to znovu.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Zkontrolujte dezinfikovaná data a poté potvrďte, že jste připraveni vygenerovat odpověď.";
$_ADMINLANG['aiSuggestions']['customer'] = "Zákazník";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Systém načetl a dezinfikoval data (%s odpovědí). Než vygenerujete navrhovanou odpověď, zkontrolujte vyčištěná data.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Odstranit hodnocení";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot našel následující články znalostní báze:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Upravit odpověď:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Systém nemohl vygenerovat návrh. Zkuste to znovu později.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generování odpovědi...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generování návrhu AI...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Systém nemohl vygenerovat návrh: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Jak užitečný byl tento návrh?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Vložit do odpovědi";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Zadejte platné datum.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Chybí vám požadované informace. Zkontrolujte své položky a zkuste to znovu.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Zadejte požadované informace do %s.";
$_ADMINLANG['aiSuggestions']['networkError'] = "Systém narazil na chybu sítě. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Systém narazil na chybu sítě: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Systém nevygeneroval návrh. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Systém nepoužil k vygenerování této odpovědi žádné články znalostní báze.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Tento lístek zatím nemá žádné odpovědi.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Systém nemohl načíst dezinfikovaná data. Znovu načtěte údaje o lístku.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Zadejte předmět.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "Operace %s se nezdařila. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Vyberte hodnocení.";
$_ADMINLANG['aiSuggestions']['processing'] = "Zpracování...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Systém zpracovává váš požadavek. Prosím, počkejte...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Ohodnoťte návrh.";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Hodnocení bylo úspěšně smazáno";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Skvělé";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Systém nemohl uložit vaše hodnocení. Zkuste to znovu.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Systém použil následující články znalostní báze ke generování této odpovědi:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerovat";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Dosáhli jste maximálně tří regenerací. Použijte prosím aktuální návrh.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerační...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Zbývají vám %s regenerace.";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Systém odstraňuje citlivé informace a připravuje se na analýzu vašeho obsahu.";
...
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Odpověď byla úspěšně vygenerována.";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Vaše reakce generovaná umělou inteligencí je připravena";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Systém obnovil Vaši odpověď";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Pečlivě zkontrolujte níže uvedená dezinfikovaná data vstupenek. Před generováním návrhů AI odstraňte nebo maskujte všechny citlivé informace.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Kontrola dezinfikovaných dat";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Systém nedokázal dezinfikovat údaje o lístcích. Zkuste to znovu.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Systém nemohl načíst data tiketu.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Systém nemohl najít pole odpovědi.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Neznámé datum";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Neznámá chyba";
$_ADMINLANG['aiSuggestions']['youRated'] = "Ohodnotili jste tuto odpověď:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS nepodporuje PHP verzi <strong>:version</strong>. WHMCS <strong>pouze</strong> podporuje verze PHP :minVersion až :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "Nelze přidat platební metodu pro tuto platební bránu prostřednictvím oblasti správy.";
