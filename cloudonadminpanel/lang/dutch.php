...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Instellingen voor toon en lengte";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot analyseert het gesprek en stelt een persoonlijk antwoord op.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Je voorgestelde antwoord is klaar. Bekijk de suggestie voordat je deze verstuurt.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Controleer je antwoord voordat je het verstuurt.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "AI-suggestie";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Het systeem kon het ticketoverzicht niet extraheren. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Het systeem heeft een ongeldig antwoord gegenereerd. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Het systeem kon uw licentie niet valideren. Controleer je inloggegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Het systeem kon geen prompt genereren. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Het systeem kon het antwoord niet opslaan. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "AI Support Copilot heeft een time-out gehad. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot is tijdelijk niet beschikbaar. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Er is een authenticatiefout in het systeem opgetreden. Controleer uw inloggegevens voor AI Support Copilot.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Het systeem kan geen verbinding maken met AI Support Copilot. Controleer je netwerkverbinding en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Er is een databasefout opgetreden in het systeem. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Het systeem kon de gegevens niet ontcijferen. Neem voor hulp contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Het systeem kon de gegevens niet versleutelen. Neem voor hulp contact op met de klantenservice.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Je kredietsaldo is onvoldoende. Voeg credits toe aan je account en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Er is een interne fout opgetreden in het systeem. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Je invoer is ongeldig. Controleer je gegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Je aanvraag gebruikt een ongeldige indeling. Controleer je invoergegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Het systeem kon de ondertekening van het verzoek niet verifiëren. Controleer je licentiesleutel.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Kies een sterbeoordeling tussen 1 en 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Je ticketgegevens zijn ongeldig of onjuist. Controleer je invoergegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "De trace-ID moet een geldig UUID-formaat gebruiken.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Het systeem kon het artikel in de kennisbank niet vinden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Het systeem heeft deze licentie al geregistreerd. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Je AI-licentie is verlopen. Verleng je abonnement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "De licentie is ongeldig. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Het systeem kon je licentie niet vinden. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Je AI-licentie is opgeschort. Neem voor hulp contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "De API-sleutel van de AI-provider is ongeldig. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Het systeem kon geen relevante artikelen uit de kennisbank vinden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot heeft een foutmelding geretourneerd. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Je hebt je tarieflimiet overschreden. Probeer het over enkele ogenblikken opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Het systeem kon geen AI-suggestie genereren.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Er is een fout opgetreden tijdens het doorzoeken van de kennisbank. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot is tijdelijk niet beschikbaar. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Het duurde te lang voordat het systeem reageerde. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "De vereiste versleutelde gegevens ontbreken.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "De inloggegevens van uw OAuth-client zijn ongeldig. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Je OAuth-token is ongeldig of je provider heeft het ingetrokken. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Je OAuth-token is verlopen. Authenticeer opnieuw en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Het systeem kon de ticketgegevens niet ontcijferen. Controleer de coderingssleutels en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "De verstrekte gegevens zijn ongeldig of beschadigd. Voer de informatie opnieuw in en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Het systeem kon gevoelige gegevens niet opschonen. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Het systeem heeft een time-out gehad tijdens het opschonen van gegevens. Probeer het nog eens.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Je hebt te veel verzoeken verzonden. Probeer het over enkele ogenblikken opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Het systeem kon het gevraagde record niet vinden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot is tijdelijk niet beschikbaar. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Je hebt geen toestemming om toegang te krijgen tot dit ticket. Controleer je rechten en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Het systeem kon het ticket niet vinden. Controleer de ticketinformatie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Het systeem kon uw aanvraag niet valideren. Controleer je invoer en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Er is een uitvoeringsfout opgetreden in het systeem. Probeer het nog eens.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Controleer de gezuiverde gegevens en bevestig dat u klaar bent om een antwoord te genereren.";
$_ADMINLANG['aiSuggestions']['customer'] = "Klant";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Het systeem heeft de gegevens geladen en ontsmet (%s -antwoorden). Controleer de gezuiverde gegevens voordat u een voorgesteld antwoord genereert.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Beoordeling verwijderen";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot vond de volgende kennisbankartikelen:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Antwoord bewerken:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Het systeem kon geen suggestie genereren. Probeer het later nog eens.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Een antwoord genereren...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "AI-suggestie genereren...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Het systeem kon geen suggestie genereren: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Hoe nuttig was deze suggestie?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "In antwoord invoegen";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Voer een geldige datum in.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Je mist de vereiste informatie. Controleer je gegevens en probeer het opnieuw.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Voer de vereiste informatie in %sin.";
$_ADMINLANG['aiSuggestions']['networkError'] = "Er is een netwerkfout opgetreden in het systeem. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Er is een netwerkfout opgetreden in het systeem: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Het systeem heeft geen suggestie gegenereerd. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Het systeem heeft geen kennisbankartikelen gebruikt om dit antwoord te genereren.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Er zijn nog geen antwoorden op dit ticket.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Het systeem kon de gezuiverde gegevens niet laden. Laad de ticketgegevens opnieuw.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Voer een onderwerp in.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "De %s -bewerking is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Selecteer een beoordeling.";
$_ADMINLANG['aiSuggestions']['processing'] = "Even wachten...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Het systeem verwerkt je aanvraag. Een ogenblik geduld alstublieft...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Beoordeel de suggestie.";
...
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Het systeem kon je beoordeling niet opslaan. Probeer het nog eens.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Het systeem gebruikte de volgende kennisbankartikelen om dit antwoord te genereren:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenereren";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Je hebt het maximum van drie regeneraties bereikt. Gebruik alstublieft de huidige suggestie.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenereren...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Je hebt nog %s regeneraties over.";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Het systeem verwijdert gevoelige informatie en bereidt zich voor om uw inhoud te analyseren.";
...
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Het antwoord is succesvol gegenereerd.";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Je AI-gegenereerde reactie is klaar";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Het systeem heeft je antwoord opnieuw gegenereerd";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Bekijk de gezuiverde ticketgegevens hieronder zorgvuldig. Verwijder of maskeer alle gevoelige informatie voordat u AI-suggesties genereert.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Opgeschoonde gegevens bekijken";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Het systeem kon de ticketgegevens niet opschonen. Probeer het nog eens.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Het systeem kon de ticketgegevens niet laden.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Het systeem kon het antwoordvak niet vinden.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Onbekende datum";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Onbekende fout";
$_ADMINLANG['aiSuggestions']['youRated'] = "Je hebt dit antwoord beoordeeld:";
...
$_ADMINLANG['general']['cronhttprestriction'] = "Cron HTTP Access Restriction";
$_ADMINLANG['general']['cronhttprestrictioninfo'] = "The IP addresses that are able to trigger the crons/cron.php file over HTTP.<br />The system will deny requests from any other IP addresses.<br />If you do not specify any IP addresses, the system denies HTTP access to the cron system entirely and cron access is only available using the CLI.";
...
$_ADMINLANG['healthCheck']['cronHttpAccessBlocked']['body'] = "<p>The system blocked :count unauthenticated HTTP request(s) to crons/cron.php in the last 24 hours because no IP address is allowlisted. If you rely on triggering cron via HTTP, add the calling IP address under :anchorOpenSetup > General Settings > Security:anchorClose. For help, see our :anchorDocsdocumentation:anchorClose.</p>";
$_ADMINLANG['healthCheck']['cronHttpAccessBlocked']['title'] = "Cron HTTP Access Blocked";
...
$_ADMINLANG['healthCheck']['deprecatedModules']['body'] = "The following modules are deprecated and will not receive further updates::modules Migrate to a supported alternative. After you have migrated, manually delete the deprecated module files from your installation. :anchorDocsLearn more:anchorClose.";
$_ADMINLANG['healthCheck']['deprecatedModules']['title'] = "Deprecated Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['addons'] = "Addon Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['fraud'] = "Fraud Protection Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['gateways'] = "Payment Gateway Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['registrars'] = "Domain Registrar Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['servers'] = "Server and Provisioning Modules";
$_ADMINLANG['healthCheck']['deprecatedModules']['type']['support'] = "Support Modules";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS ondersteunt PHP-versie <strong>:version</strong>niet. WHMCS <strong>alleen</strong> ondersteunt PHP-versies :minVersion tot en met :maxVersion.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "U kunt geen betalingsmethode voor deze betalingsgateway toevoegen via het beheergedeelte.";
...
$_ADMINLANG['supportticketdepts']['mailImportCapInvalid'] = "The :inputLabel value must be a whole number between :min and :max.";
$_ADMINLANG['supportticketdepts']['mailImportLimitsTitle'] = "Import Limits";
$_ADMINLANG['supportticketdepts']['mailImportMaxAttachmentMb'] = "Per-Email Attachment Size Limit";
$_ADMINLANG['supportticketdepts']['mailImportMaxAttachmentMbInfo'] = "The maximum size of all attachments for a single email message that the system will import for this department.";
$_ADMINLANG['supportticketdepts']['mailImportMessageCap'] = "Emails Per Import";
$_ADMINLANG['supportticketdepts']['mailImportMessageCapInfo'] = "The maximum number of emails that the system will import for this department during a single system cron run.";
$_ADMINLANG['supportticketdepts']['mailImportPerEmailExceedsTotal'] = "Per-Email Attachment Size Limit cannot exceed the Total Email Attachments Size Limit.";
$_ADMINLANG['supportticketdepts']['mailImportTotalAttachmentMb'] = "Total Email Attachments Size Limit";
$_ADMINLANG['supportticketdepts']['mailImportTotalAttachmentMbInfo'] = "The maximum combined size of all email attachments that the system will import for this department during a single system cron run.";
