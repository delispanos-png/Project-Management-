...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Ton ve Uzunluk Ayarları";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI Support Copilot, sohbeti analiz ediyor ve kişiselleştirilmiş bir yanıt hazırlıyor.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Önerilen cevabınız hazır. Göndermeden önce öneriyi gözden geçirin.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Göndermeden önce cevabınızı gözden geçirin.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Yapay Zeka Önerisi";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Sistem bilet özetini çıkaramadı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Sistem geçersiz bir yanıt oluşturdu. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Sistem lisansınızı doğrulayamadı. Kimlik bilgilerinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Sistem bir komut istemi oluşturamadı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Sistem yanıtı kaydedemedi. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "AI Desteği Copilot zaman aşımına uğradı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "AI Support Copilot geçici olarak kullanılamıyor. Daha sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Sistem bir kimlik doğrulama hatasıyla karşılaştı. AI Support Copilot kimlik bilgilerinizi kontrol edin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Sistem AI Support Copilot'a bağlanamıyor. Ağ bağlantınızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Sistem bir veritabanı hatasıyla karşılaştı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Sistem verilerin şifresini çözemedi. Yardım için destek ile iletişime geçin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Sistem verileri şifreleyemedi. Yardım için destek ile iletişime geçin.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Kredi bakiyeniz yetersiz. Hesabınıza kredi ekleyin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Sistem dahili bir hatayla karşılaştı. Daha sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Girdiniz geçersiz. Verilerinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "İsteğiniz geçersiz bir biçim kullanıyor. Giriş verilerinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Sistem istek imzasını doğrulayamadı. Lisans anahtarınızı kontrol edin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "1 ile 5 arasında bir yıldız derecelendirmesi seçin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Bilet verileriniz geçersiz veya hatalı. Giriş verilerinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "İzleme kimliği geçerli bir UUID biçimi kullanmalıdır.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Sistem bilgi tabanı makalesini bulamadı.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Sistem zaten bu lisansı kaydetti. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "AI lisansınızın süresi doldu. Aboneliğinizi yenileyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "Lisans geçersiz. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Sistem lisansınızı bulamadı. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Yapay zeka lisansınız askıya alındı. Yardım için destek ile iletişime geçin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "AI sağlayıcı API anahtarı geçersiz. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Sistem ilgili bilgi tabanı makaleleri bulamadı.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "AI Support Copilot bir hata döndürdü. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Ücret limitinizi aştınız. Birkaç dakika sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Sistem bir AI önerisi oluşturamadı.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Sistem bilgi tabanında arama yaparken bir hatayla karşılaştı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "AI Support Copilot geçici olarak kullanılamıyor. Daha sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Sistemin yanıt vermesi çok uzun sürdü. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Gerekli şifrelenmiş veriler eksik.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "OAuth istemci kimlik bilgileriniz geçersiz. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "OAuth belirteciniz geçersiz veya sağlayıcınız bunu iptal etti. Yapılandırmanızı kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "OAuth belirtecinizin süresi doldu. Kimlik doğrulamasını yeniden doğrulayın ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Sistem bilet verilerinin şifresini çözemedi. Şifreleme anahtarlarını kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Sağlanan veriler geçersiz veya bozuk. Bilgileri tekrar girin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Sistem hassas verileri temizleyemedi. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Verileri sterilize ederken sistem zaman aşımına uğradı. Tekrar dene.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Çok fazla istek gönderdiniz. Birkaç dakika sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Sistem istenen kaydı bulamadı.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "AI Support Copilot geçici olarak kullanılamıyor. Daha sonra tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Bu bilete erişim izniniz yok. İzinlerinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Sistem bileti bulamadı. Bilet bilgilerini kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Sistem isteğinizi doğrulayamadı. Girdinizi kontrol edin ve tekrar deneyin.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Sistem bir yürütme hatasıyla karşılaştı. Tekrar dene.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Temizlenmiş verileri inceleyin, ardından yanıt oluşturmaya hazır olduğunuzu onaylayın.";
$_ADMINLANG['aiSuggestions']['customer'] = "Müşteri";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Sistem verileri yükledi ve sterilize etti (%s cevapları). Önerilen bir yanıt oluşturmadan önce temizlenmiş verileri inceleyin.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Derecelendirmeyi Sil";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "AI Support Copilot aşağıdaki bilgi tabanı makalelerini buldu:";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Cevabı Düzenle:";
...
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Sistem bir öneri üretemedi. Daha sonra tekrar deneyin.";
...
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Cevap oluşturuluyor...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Yapay zeka önerisi oluşturuluyor...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Sistem bir öneri oluşturamadı: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Bu öneri ne kadar yardımcı oldu?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Yanıta ekle";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Geçerli bir tarih girin.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Gerekli bilgileri kaçırıyorsunuz. Girişlerinizi kontrol edin ve tekrar deneyin.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Gerekli bilgileri %sbölümüne girin.";
$_ADMINLANG['aiSuggestions']['networkError'] = "Sistem bir ağ hatasıyla karşılaştı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Sistem bir ağ hatasıyla karşılaştı: %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Sistem bir öneri oluşturmadı. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Sistem bu yanıtı oluşturmak için herhangi bir bilgi tabanı makalesi kullanmadı.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Bu biletin henüz cevabı yok.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Sistem sterilize edilmiş verileri yükleyemedi. Bilet verilerini yeniden yükleyin.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Bir konu girin.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "%s işlemi başarısız oldu. Tekrar dene.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Bir derecelendirme seçin.";
$_ADMINLANG['aiSuggestions']['processing'] = "İşleniyor...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Sistem talebinizi işleme koyuyor. Lütfen bekleyin...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Öneriyi değerlendirin.";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Derecelendirme başarıyla silindi";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Çok İyi";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Sistem puanınızı kaydedemedi. Tekrar dene.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Sistem bu yanıtı oluşturmak için aşağıdaki bilgi tabanı makalelerini kullandı:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Yeniden Oluşturun";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "En fazla üç rejenerasyona ulaştınız. Lütfen mevcut öneriyi kullanın.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Yenileyici...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Kalan %s yenilenme var.";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Sistem hassas bilgileri kaldırıyor ve içeriğinizi analiz etmeye hazırlanıyor.";
...
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Sistem yanıtınızı yeniden oluşturdu";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Aşağıdaki sterilize edilmiş bilet verilerini dikkatlice inceleyin. Yapay zeka önerileri oluşturmadan önce tüm hassas bilgileri kaldırın veya maskeleyin.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Temizlenmiş Verileri İnceleme";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Sistem bilet verilerini temizleyemedi. Tekrar dene.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Sistem bilet verilerini yükleyemedi.";
...
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Sistem cevap kutusunu bulamadı.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Bilinmeyen Tarih";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Bilinmeyen hata";
$_ADMINLANG['aiSuggestions']['youRated'] = "Bu cevabı değerlendirdiniz:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS PHP sürümünü <strong>:version</strong>desteklemez. WHMCS <strong>sadece</strong> PHP sürümlerini :minVersion ile :maxVersion destekler.";
...
$_ADMINLANG['stripeDynamic']['addNotSupported'] = "Yönetici Alanı üzerinden bu ödeme ağ geçidi için ödeme yöntemi ekleyemezsiniz.";
