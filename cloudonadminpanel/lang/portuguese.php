...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Definições de Tom e Comprimento";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "O AI Support Copilot está a analisar a conversa e a elaborar uma resposta personalizada.";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "A sua resposta sugerida está pronta. Reveja a sugestão antes de enviá-la.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Reveja a sua resposta antes de enviar.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugestão de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "O sistema não conseguiu extrair o ticket digest. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "O sistema gerou uma resposta inválida. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "O sistema não pôde validar a sua licença. Verifique as suas credenciais e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "O sistema não pôde gerar um prompt. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "O sistema não pôde salvar a resposta. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "O Copilot do Suporte AI atingiu o tempo limite. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "O sistema encontrou um erro de autenticação. Verifique as suas credenciais do Copilot do AI Support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "O sistema não consegue estabelecer ligação ao AI Support Copilot. Verifique a ligação à rede e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "O sistema encontrou um erro na base de dados. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "O sistema não conseguiu descriptografar os dados. Para obter assistência, contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "O sistema não conseguiu encriptar os dados. Para obter assistência, contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Ocorreu um erro inesperado. Tente novamente ou contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "O seu saldo de crédito é insuficiente. Adicione créditos à sua conta e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "O sistema encontrou um erro interno. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "A sua entrada é inválida. Verifique os seus dados e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "O seu pedido utiliza um formato inválido. Verifique os dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "O sistema não pôde verificar a assinatura do pedido. Verifique a sua chave de licença.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Escolha uma classificação de estrelas entre 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Os dados do seu bilhete são inválidos ou mal formados. Verifique os dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "O código de rastreamento deve usar um formato UUID válido.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "O sistema já registou esta licença. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "A sua licença de IA expirou. Renove a sua subscrição.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "A licença é inválida. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "O sistema não conseguiu encontrar a sua licença. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "A sua licença de IA foi suspensa. Para obter assistência, contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "A chave da API do fornecedor de IA é inválida. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "O sistema não conseguiu encontrar nenhum artigo relevante da base de conhecimento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "O AI Support Copilot retornou um erro. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Excedeu o seu limite de taxa. Tente novamente daqui a alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "O sistema não conseguiu gerar uma sugestão de IA.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "O sistema demorou demasiado tempo a responder. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Os dados encriptados necessários estão em falta.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "As suas credenciais de cliente OAuth são inválidas. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "O seu token OAuth é inválido ou o fornecedor o revogou. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "O seu token OAuth expirou. Re-autentique e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "O sistema não pôde descriptografar os dados do ticket. Verifique as chaves de encriptação e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Os dados fornecidos são inválidos ou corrompidos. Introduza novamente as informações e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "O sistema não conseguiu higienizar os dados sensíveis. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "O sistema atingiu o tempo limite durante a higienização dos dados. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Os senhores enviaram demasiados pedidos. Tente novamente daqui a alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "O sistema não conseguiu encontrar o registo solicitado.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Não tem permissão para aceder a este bilhete. Verifique as suas permissões e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "O sistema não conseguiu encontrar o bilhete. Verifique as informações do bilhete e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "O sistema não pôde validar o seu pedido. Verifique a sua entrada e tente novamente.";
...
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Revise os dados higienizados e confirme que está pronto para gerar uma resposta.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "O sistema carregou e higienizou os dados (%s respostas). Revise os dados higienizados antes de gerar uma resposta sugerida.";
...
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Quão útil foi esta sugestão?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserir na resposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Introduza uma data válida.";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Falta-lhe as informações necessárias. Verifique as suas entradas e tente novamente.";
...
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Introduza as informações necessárias em %s.";
...
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "O sistema não utilizou nenhum artigo da base de conhecimento para gerar esta resposta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Este bilhete ainda não tem respostas.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "O sistema não conseguiu carregar os dados higienizados. Recarregar os dados do bilhete.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Introduza um assunto.";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "A operação %s falhou. Tente novamente.";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Seleccione uma classificação.";
$_ADMINLANG['aiSuggestions']['processing'] = "A processar…";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "O sistema está a processar o seu pedido. Por favor aguarde...";
...
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "O sistema não conseguiu salvar a sua classificação. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "O sistema utilizou os seguintes artigos da base de conhecimento para gerar esta resposta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Atingiu o máximo de três regenerações. Por favor, use a sugestão atual.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerando...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Restam as regenerações %s .";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "O sistema está a remover informações confidenciais e a preparar-se para analisar o seu conteúdo.";
...
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "O sistema regenerou a sua resposta";
...
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Revise cuidadosamente os dados do bilhete higienizado abaixo. Remova ou mascare todas as informações confidenciais antes de gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Rever Dados Sanitizados";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "O sistema não conseguiu higienizar os dados do bilhete. Tente novamente.";
...
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "O sistema não pôde carregar os dados do ticket.";
...
$_ADMINLANG['aiSuggestions']['youRated'] = "Avaliou esta resposta:";
...
$_ADMINLANG['healthCheck']['phpVersionWhmcsUnsupported'] = "WHMCS não suporta a versão PHP <strong>:version</strong>. WHMCS <strong>apenas</strong> suporta as versões do PHP :minVersion a :maxVersion.";
