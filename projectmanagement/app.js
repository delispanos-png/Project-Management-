...
const CNP_ST = [
  ['online', 'Διαθέσιμος', '#16a26a', 'Δουλεύω κανονικά — γράψτε μου', 'Available'],
  ['away', 'Λείπω', '#e0a020', 'Γυρίζω σε λίγο', 'Away'],
  ['dnd', 'Μην ενοχλείτε', '#e2515f', 'Μη με διακόπτετε — σιγάζουν οι ειδοποιήσεις', 'Do Not Disturb'],
  ['lunch', 'Διάλειμμα', '#16b1a8', 'Φαγητό ή διάλειμμα — σιγάζουν οι ειδοποιήσεις', 'Lunch'],
  ['trip', 'Εκτός έδρας', '#3b82f6', 'Σε πελάτη ή μετακίνηση', 'Business Trip'],
  ['meeting', 'Σε σύσκεψη', '#e0a020', 'Το βάζει το ημερολόγιο', '', 1],
