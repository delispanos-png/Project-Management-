...
(function () {
  ...
  var DICT = {
    ...
    'Μόνο για διαχειριστές.': 'Administrators only.', 'Ενότητες του μενού': 'Menu sections', 'Προαγορά χρόνου': 'Prepaid time', 'Δραστηριότητα': 'Activity', 'Καταγραφή κλήσης': 'Log a call', 'Παράπονα': 'Complaints', 'Παράπονα πελατών': 'Client complaints',
    ...
    /* ── κοστολόγηση PharmacyOne ── */
    'Κοστολόγηση PharmacyOne': 'PharmacyOne costing', 'Παράμετροι': 'Parameters',
    'Τιμοκατάλογος': 'Price list', 'Έγγραφο': 'Document', 'Εκτύπωση': 'Print',
    'Δημιουργία προσφοράς': 'Create quote', 'Ενημέρωση προσφοράς': 'Update quote',
    'Επωνυμία πελάτη…': 'Client name…', 'Άντληση ΑΑΔΕ': 'Fetch from tax registry',
    'Παράμετροι εγκατάστασης': 'Installation parameters', 'Στοιχεία εγγράφου': 'Document details',
    'Τιμή έκδοσης & επιπλέον χρήστη': 'Edition & extra-user price',
    'Στην προσφορά': 'In the quote', 'πρώτο έτος': 'first year', 'Ετήσιο': 'Annual',
    'Εφάπαξ': 'One-off', 'Μηνιαίο / χρήστη': 'Monthly / user', 'Περιγραφή': 'Description',
    'Έκδοση': 'Edition', 'Υπόψη (ονοματεπώνυμο)': 'Attn. (full name)',
    ...
    'Δώσε 9ψήφιο ΑΦΜ': 'Enter a 9-digit tax number',
    'Αναζήτηση στο μητρώο…': 'Searching the registry…',
    'Δώσε επωνυμία πελάτη': 'Enter a client name',
    'Δεν αποθηκεύτηκε': 'Not saved',
    'Δεν έχεις δικαίωμα στις Προσφορές': 'You don’t have the Quotes permission',
    'Άνοιξε πρώτα την καρτέλα «Έγγραφο»': 'Open the “Document” tab first',
    'Οι αλλαγές ισχύουν μόνο για αυτή την προσφορά — ο γενικός τιμοκατάλογος δεν πειράζεται.':
      'Changes apply to this quote only — the general price list is untouched.',
    /* ── ρυθμίσεις (ενότητες) ── */
