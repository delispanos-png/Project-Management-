...
R.pbx = async function () {
  ...
  <div class="card"><div class="card-h">${I.user} Κατάσταση χειριστή → τηλέφωνο</div>
    <div class="card-b">
      ...
      <div class="px-modes">
        ${[['manual', 'Τίποτα αυτόματο (προεπιλογή)', 'Μόνο ό,τι δηλώνει ο ίδιος ο χειριστής (Λείπω, Γεύμα, Απασχολημένος…). Ο σφυγμός της εφαρμογής δείχνει απλώς ποιος είναι ενεργός στο Project Manager — δεν αγγίζει το τηλέφωνο.'],
           ['meeting', 'Και οι συσκέψεις', 'Σύσκεψη που αποδέχθηκε στο ημερολόγιο → «Do Not Disturb» για όσο κρατά, μετά επιστροφή σε Available. Το «Λείπω» από αδράνεια της εφαρμογής ΔΕΝ αγγίζει το τηλέφωνο.'],
