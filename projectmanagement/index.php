...
<script>window.CNP_BUILD=<?= json_encode($v) ?>;if("serviceWorker" in navigator)navigator.serviceWorker.register("/project/sw.js").catch(()=>{});</script>
...
<script type="module" src="views9.js?v=<?= htmlspecialchars($v) ?>"></script>
<script type="module" src="views10.js?v=<?= htmlspecialchars($v) ?>"></script>
<script type="module" src="views11.js?v=<?= htmlspecialchars($v) ?>"></script>
