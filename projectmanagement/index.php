...
$v = '1.0.' . max(@filemtime(__DIR__ . '/app.js'), @filemtime(__DIR__ . '/app.css'), @filemtime(__DIR__ . '/views2.js'), @filemtime(__DIR__ . '/views3.js'), @filemtime(__DIR__ . '/views4.js'), @filemtime(__DIR__ . '/views5.js'), @filemtime(__DIR__ . '/views6.js'), @filemtime(__DIR__ . '/views7.js'), @filemtime(__DIR__ . '/help.js'), @filemtime(__DIR__ . '/i18n.js'));
?>
<!DOCTYPE html>
<html lang="el">
<head>
