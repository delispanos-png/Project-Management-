...
$_LANG['accountInvite']['youHaveBeenInvited'] = ":clientName vous a envoyé une invitation !";
...
$_LANG['addfundsdescription'] = "Ajoutez des fonds à votre compte pour éviter de multiplier les petites transactions et régler automatiquement les nouvelles factures.";
$_LANG['addfundsintro'] = "Ajouter des fonds à l'avance";
...
$_LANG['additionalInfo'] = "Autres informations";
$_LANG['addmore'] = "Ajouter";
$_LANG['addonsExtras'] = "Modules complémentaires et options";
...
$_LANG['affiliatesbullet1'] = "Bénéficiez d'un dépôt bonus initial sur votre compte d'affiliation.";
$_LANG['affiliatesbullet2'] = "sur chaque paiement effectué par chaque client que vous nous recommandez, et ce, pendant toute la durée de son compte d'hébergement.";
...
$_LANG['affiliatesdescription'] = "Rejoignez notre programme d'affiliation ou consultez vos gains.";
$_LANG['affiliatesdisabled'] = "Nous n'offrons pas de système d'affiliés actuellement.";
$_LANG['affiliatesearn'] = "Percevez";
$_LANG['affiliatesearningstodate'] = "Total des gains jusqu'à ce jour";
$_LANG['affiliatesfootertext'] = "Lorsque vous recommandez notre site web à une personne grâce à votre identifiant de parrainage unique, un cookie contenant cet identifiant est placé sur son ordinateur. Ainsi, si cette personne ajoute le site à ses favoris et y revient plus tard, vous percevrez tout de même votre commission.";
$_LANG['affiliateshostingpackage'] = "Offre d'hébergement";
$_LANG['affiliatesignupinfo1'] = "Nous payons des commissions pour chaque inscription via votre lien personnalisé.";
$_LANG['affiliatesignupinfo2'] = "Nous suivons les internautes référés à l'aide de cookies pour vous permettre d'obtenir votre commission même si l'internaute ne s'inscrit pas instantanément. Les cookies sont valides jusqu'à 90 jours après la visite initiale.";
$_LANG['affiliatesignupinfo3'] = "Pour en savoir plus, veuillez nous contacter.";
$_LANG['affiliatesignupintro'] = "Activez votre compte d'affilié et commencez à gagner de l'argent dès aujourd'hui…";
...
$_LANG['affiliatesintrotext'] = "Activez votre compte d'affilié aujourd'hui :";
$_LANG['affiliateslinktous'] = "Liens";
...
$_LANG['affiliatesreferallink'] = "Lien unique de recommandation";
$_LANG['affiliatesreferals'] = "Vos recommandations";
...
$_LANG['affiliatesvisitorsreferred'] = "Nombre d'internautes recommandés";
...
$_LANG['allthelatest'] = "Actualités de";
$_LANG['alltldpricing'] = "Tous les tarifs TLD";
$_LANG['almostDone'] = "Presque terminé";
$_LANG['alreadyregistered'] = "Vous avez déjà un compte ?";
$_LANG['alreadyunsubscribed'] = "Votre désinscription de notre lettre d'information est déjà effective.";
...
$_LANG['announcementsdescription'] = "Affichez les dernières actualités et annonces.";
...
$_LANG['availcreditbal'] = "Solde créditeur disponible";
$_LANG['availcreditbaldesc'] = "Vous disposez d'un solde créditeur de %s sur votre compte. Celui-ci sera automatiquement appliqué à toute nouvelle facture.";
$_LANG['back'] = "Retour";
...
$_LANG['bandwidthUsage'] = "Utilisation de la bande passante";
$_LANG['bankPaymentDeclined'] = "Les informations du compte bancaire que vous avez saisies ont été refusées. Veuillez essayer un autre compte ou contacter l'assistance.";
$_LANG['bannedbanexpires'] = "Fin du bannissement";
...
$_LANG['bundlemaxusesreached'] = "Offre groupée non disponible";
$_LANG['bundlemaxusesreacheddesc'] = "Le nombre maximum d'utilisations autorisées a été atteint pour cet ensemble. Celui-ci n'est malheureusement plus disponible. N'hésitez pas à nous contacter si nos services vous intéressent !";
$_LANG['bundlereqsnotmet'] = "Tous les prérequis ne sont pas remplis pour cet ensemble";
$_LANG['bundlevaliddateserror'] = "Offre groupée non disponible";
$_LANG['bundlevaliddateserrordesc'] = "Cet ensemble est soit inactif soit expiré. Si vous pensez qu'il y a erreur, veuillez contacter l'assistance.";
$_LANG['bundlewarningdomainaddon'] = "L'option '%s' est obligatoire pour le nom de domaine %s afin que cet ensemble soit éligible.";
...
$_LANG['bundlewarningproductaddonreq'] = "Vous devez sélectionner le module complémentaire '%s' pour le produit %s afin de bénéficier de cet ensemble.";
$_LANG['bundlewarningproductconfopqtyreq'] = "Vous devez placer la quantité sur '%s' pour '%s' pour cet ensemble.";
$_LANG['bundlewarningproductconfopreq'] = "Vous devez sélectionner '%s' pour '%s' pour cet ensemble.";
$_LANG['bundlewarningproductconfopyesnodisable'] = "Vous devez désactiver l'option '%s' afin d'utiliser cet ensemble.";
$_LANG['bundlewarningproductconfopyesnoenable'] = "Vous devez activer l'option '%s' afin d'utiliser cet ensemble.";
$_LANG['bundlewarningproductcycle'] = "Vous devez sélectionner le cycle de facturation '%s' pour le produit %s afin de bénéficier de cet ensemble.";
$_LANG['bundlewarningpromo'] = "Cet ensemble n'est pas cumulable avec d'autres promotions ou offres.";
$_LANG['buy'] = "Acheter";
...
$_LANG['cPanel']['emailAccounts'] = "Comptes courriel";
$_LANG['cPanel']['forwarders'] = "Redirection";
$_LANG['cPanel']['packageNotActive'] = "Statut actuel de l'offre d'hébergement :";
...
$_LANG['cart']['applyCreditAmount'] = "Appliquer <span>:amount</span> de mon solde créditeur à cette commande. Je paierai le montant restant à l'aide du mode de paiement sélectionné ci-dessous.";
...
$_LANG['cart']['applyCreditSkip'] = "N'appliquer aucun crédit de mon solde créditeur à cette commande. Je paierai à l'aide du mode de paiement sélectionné ci-dessous.";
...
$_LANG['cartItemType']['addon'] = "Module complémentaire";
$_LANG['cartItemType']['addons'] = "Modules complémentaires";
...
$_LANG['cartItemType']['domainTransfer'] = "Transfert de domaine";
$_LANG['cartItemType']['domainTransfers'] = "Transferts de domaines";
$_LANG['cartItemType']['domains'] = "Domaines";
...
$_LANG['cartaddandcheckout'] = "Ajouter au panier et commander";
$_LANG['cartaddons'] = "Modules complémentaires";
...
$_LANG['cartavailableaddons'] = "Modules complémentaires disponibles";
...
$_LANG['cartdomaininvalid'] = "Le domaine que vous avez saisi n'est pas valide. Saisissez uniquement la partie après le www. et le TLD.";
$_LANG['cartdomainsconfig'] = "Configuration des domaines";
$_LANG['cartdomainsconfigdesc'] = "Ci-dessous, vous pouvez configurer les domaines de votre panier en choisissant les modules complémentaires souhaités. Saisissez les informations obligatoires et définissez les serveurs de noms qui seront utilisés.";
...
$_LANG['cartdomainshashosting'] = "Avec hébergement";
...
$_LANG['cartdomainunavailablemanual'] = "Ce domaine m'appartient déjà et je vais mettre à jour les serveurs de noms (DNS).";
...
$_LANG['cartemptyconfirm'] = "Voulez-vous vraiment vider votre panier ?";
$_LANG['cartenterdomain'] = "Veuillez saisir ci-dessous le nom de domaine que vous souhaitez utiliser.";
$_LANG['cartenterpromo'] = "Saisissez le code de la promotion";
...
$_LANG['cartexistingclientlogin'] = "Connexion client existante";
...
$_LANG['cartfollowingaddonsavailable'] = "Les modules complémentaires suivants sont disponibles pour vos produits et services actifs.";
...
$_LANG['cartotherdomainsuggestions'] = "Voici d'autres domaines qui pourraient vous intéresser…";
$_LANG['cartproductaddons'] = "Modules complémentaires pour le produit";
$_LANG['cartproductaddonschoosepackage'] = "Choisir une offre";
$_LANG['cartproductaddonsnone'] = "Aucun module complémentaire n'est disponible pour vos produits et services";
$_LANG['cartproductchooseoptions'] = "Choisir les options";
$_LANG['cartproductconfig'] = "Configuration du produit";
$_LANG['cartproductdesc'] = "Des options de configurations supplémentaires sont disponibles pour le produit/le service que vous avez sélectionné.";
$_LANG['cartproductdomain'] = "Domaines";
$_LANG['cartproductdomainchoose'] = "Choisir un domaine";
...
$_LANG['cartqtyenterquantity'] = "Vous souhaitez commander cet article plusieurs fois ? Veuillez saisir la quantité ici :";
$_LANG['cartqtyupdate'] = "Mettre à jour";
$_LANG['cartrecurringcharges'] = "Charges récurrentes";
$_LANG['cartregisterdomainchoice'] = "Enregistrer un nom de domaine";
$_LANG['cartregisterhowlong'] = "Pour combien de temps voulez-vous enregistrer ce domaine ?";
$_LANG['cartremove'] = "Retirer";
$_LANG['cartremoveitemconfirm'] = "Voulez-vous retirer cet article de votre panier ?";
$_LANG['cartremovepromo'] = "Retirer la promotion";
$_LANG['cartreviewcheckout'] = "Vérifier et commander";
$_LANG['cartsetupfees'] = "Frais de configuration";
$_LANG['cartsubdomainchoice'] = "Utiliser un sous-domaine de %s";
$_LANG['carttaxupdateselections'] = "Les taxes peuvent être ajoutées en fonction du pays, de la région (état, province, etc). Cliquez pour recalculer après avoir fait vos choix.";
...
$_LANG['carttransferpossible'] = "Félicitations ! Nous pouvons transférer %s chez nous pour seulement %s.";
$_LANG['carttryanotherdomain'] = "Essayez un autre nom de domaine";
$_LANG['castcontrollogin'] = "Se connecter au panneau de contrôle";
$_LANG['category'] = "Catégorie";
$_LANG['ccexpiringsoon'] = "La carte bancaire expire bientôt.";
$_LANG['ccexpiringsoondesc'] = "Votre carte bancaire expire bientôt. Assurez-vous de %s mettre à jour les informations relatives à votre carte %s dès que possible.";
$_LANG['centovacastlogin'] = "Se connecter à Centova Cast";
$_LANG['change'] = "Changer";
$_LANG['changeCurrency'] = "Changer la devise";
$_LANG['changeDomainNS'] = "Modifier les serveurs de noms vers lesquels votre domaine pointe";
$_LANG['changeRegLock'] = "Modifier le verrouillage de votre domaine";
$_LANG['changenameservers'] = "Changer les serveurs de noms";
$_LANG['changessavedsuccessfully'] = "Les changements ont bien été sauvegardés !";
$_LANG['chatlivehelp'] = "Assistance en direct";
...
$_LANG['clientAlerts']['creditCardExpiring'] = "Votre carte bancaire :creditCardType-:creditCardLastFourDigits expire dans :days jours. Veuillez mettre à jour ces informations dès que possible.";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Vous avez :numberOfInvoices facture(s) impayée(s). Payez-les rapidement pour plus de sérénité.";
$_LANG['clientAlerts']['servicesRenewingSoon'] = ":numberOfServices service(s) sont disponibles pour renouvellement prochainement.";
$_LANG['clientAreaProductAddonsAvailable'] = "Des modules complémentaires sont disponibles pour vos produits/services. <a href=\"cart.php?gid=addons\">Cliquez ici pour les afficher et commander &raquo;</a>.";
...
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "Nous vous recommandons d'activer l'authentification à deux facteurs pour bénéficier d'une sécurité renforcée.";
...
$_LANG['clientHomePanels']['activeProductsServicesNone'] = "Vous n'avez encore aucun produit/service. <a href=\"cart.php\">Passez une commande pour commencer</a>.";
...
$_LANG['clientHomePanels']['affiliateSummaryWithdrawalReady'] = "La balance actuelle de votre commission est de :commissionBalance. Vous pouvez retirer vos gains maintenant.";
...
$_LANG['clientHomePanels']['recentNews'] = "Actualités";
$_LANG['clientHomePanels']['recentSupportTickets'] = "Derniers tickets";
$_LANG['clientHomePanels']['recentSupportTicketsNone'] = "Aucun ticket récent. Si vous avez besoin d'aide, vous pouvez <a href=\"submitticket.php\">ouvrir un ticket</a>.";
...
$_LANG['clientHomeSearchKb'] = "Saisissez une question ici pour rechercher des réponses dans notre base de connaissances…";
$_LANG['clientOwner'] = "Propriétaire";
$_LANG['clientareaaccountaddons'] = "Modules complémentaires du compte";
...
$_LANG['clientareaaddfundsnotallowed'] = "Vous ne pouvez pas continuer pour le moment. Vous devez avoir au moins une commande active avant de pouvoir ajouter des fonds !";
$_LANG['clientareaaddon'] = "Module complémentaire";
$_LANG['clientareaaddonorderconfirmation'] = "Merci ! Votre commande pour le module complémentaire ci-dessous a bien été enregistrée. Veuillez choisir votre mode de paiement ci-dessous.";
$_LANG['clientareaaddonpricing'] = "Tarif";
$_LANG['clientareaaddonsfor'] = "Modules complémentaires pour";
$_LANG['clientareaaddress1'] = "Adresse 1";
$_LANG['clientareaaddress2'] = "Adresse 2";
$_LANG['clientareabacklink'] = "&laquo; Retour";
$_LANG['clientareabwlimit'] = "Limite de la bande passante";
$_LANG['clientareabwusage'] = "Utilisation de la bande passante";
$_LANG['clientareacancel'] = "Annuler les modifications";
$_LANG['clientareacancelconfirmation'] = "Merci. Votre demande d'annulation a été transmise. S'il s'agit d'une erreur, veuillez nous informer : pour cela, envoyez-nous une demande d'assistance afin d'éviter la clôture de votre compte.";
$_LANG['clientareacancelinvalid'] = "Le compte pour lequel vous demandez une annulation est déjà en attente d'annulation.";
...
$_LANG['clientareacancelreason'] = "Veuillez décrire brièvement le motif de l'annulation.";
$_LANG['clientareacancelreasonrequired'] = "Vous devez indiquer un motif d'annulation.";
...
$_LANG['clientareachangesuccessful'] = "Vos informations ont bien été modifiées.";
$_LANG['clientareachoosecontact'] = "Choisir le contact";
$_LANG['clientareacity'] = "Ville";
$_LANG['clientareacompanyname'] = "Nom d'entreprise";
$_LANG['clientareacompleted'] = "Terminée";
$_LANG['clientareaconfirmpassword'] = "Confirmer le mot de passe";
$_LANG['clientareacontactsemails'] = "Préférences de messagerie";
$_LANG['clientareacontactsemailsdomain'] = "Courriels noms de domaines - Avis de renouvellement, Confirmation d'enregistrement, etc.";
$_LANG['clientareacontactsemailsgeneral'] = "Courriels généraux - Annonces globales et rappels de mots de passe";
$_LANG['clientareacontactsemailsinvoice'] = "E-mail de facturation - Facturation et rappels";
$_LANG['clientareacontactsemailsproduct'] = "E-mail produits - Détails de commande, messages de bienvenue, etc.";
$_LANG['clientareacontactsemailssupport'] = "Courriels des demandes d'assistance : recevez une copie de toutes les communications liées aux demandes d'assistance créées par le titulaire du compte parent.";
$_LANG['clientareacountry'] = "Pays";
$_LANG['clientareacurrentsecurityanswer'] = "Veuillez saisir la réponse actuelle.";
...
$_LANG['clientareadeletecontactareyousure'] = "Voulez-vous vraiment supprimer ce contact ?";
$_LANG['clientareadescription'] = "Voir et mettre à jour les infos de votre compte";
...
$_LANG['clientareaemail'] = "Adresse e-mail";
$_LANG['clientareaemaildesc'] = "Historique des e-mails que nous vous avons envoyés";
$_LANG['clientareaemails'] = "Mes e-mails";
...
$_LANG['clientareaerroraddress1'] = "Vous n'avez pas saisi votre adresse (ligne 1).";
$_LANG['clientareaerroraddress12'] = "Votre adresse doit contenir uniquement des lettres, chiffres ou espaces.";
$_LANG['clientareaerrorbannedemail'] = "Nous n'autorisons pas les utilisateurs utilisant le fournisseur d'adresse e-mail que vous avez saisi. Veuillez essayer une autre adresse e-mail.";
$_LANG['clientareaerrorcity'] = "Vous n'avez pas saisi le nom de votre ville.";
...
$_LANG['clientareaerroremail'] = "Vous n'avez pas saisi votre adresse e-mail.";
$_LANG['clientareaerroremailexists'] = "L'adresse e-mail saisie est déjà utilisée.";
$_LANG['clientareaerroremailinvalid'] = "L'adresse e-mail saisie n'est pas valide.";
$_LANG['clientareaerrorfirstname'] = "Vous n'avez pas saisi votre prénom.";
$_LANG['clientareaerrorfirstname2'] = "Le prénom doit contenir uniquement des lettres.";
$_LANG['clientareaerrorisrequired'] = "obligatoire";
$_LANG['clientareaerrorlanguage'] = "Aucune langue valide n'a été indiquée";
$_LANG['clientareaerrorlastname'] = "Vous n'avez pas saisi votre nom.";
$_LANG['clientareaerrorlastname2'] = "Votre nom doit contenir uniquement des lettres.";
$_LANG['clientareaerroroccured'] = "Une erreur est survenue. Veuillez réessayer ultérieurement.";
$_LANG['clientareaerrorpasswordconfirm'] = "Vous avez oublié de confirmer votre mot de passe.";
$_LANG['clientareaerrorpasswordnotmatch'] = "Les mots de passe saisis ne correspondent pas.";
$_LANG['clientareaerrorphonenumber'] = "Vous n'avez pas saisi votre numéro de téléphone.";
$_LANG['clientareaerrorphonenumber2'] = "Votre numéro de téléphone n'est pas valide.";
$_LANG['clientareaerrorpostcode'] = "Vous n'avez pas saisi votre code postal.";
...
$_LANG['clientareaerrorstate'] = "Vous n'avez pas indiqué votre pays.";
$_LANG['clientareaerrorusernotassoc'] = "L'adresse e-mail saisie est déjà utilisée.";
...
$_LANG['clientareafullname'] = "Nom du client";
$_LANG['clientareagrace'] = "Période de grâce (expirée)";
$_LANG['clientareaheader'] = "Bienvenue dans votre espace client ! Dans cet espace, vous pouvez gérer votre compte. Cette page est une vue d'ensemble de votre compte. Vous y trouverez également vos demandes ouvertes et vos factures non payées. Assurez-vous de toujours maintenir à jour vos coordonnées.";
...
$_LANG['clientareahomeloginbtn'] = "Se connecter à l'espace client";
$_LANG['clientareahomeorder'] = "Consultez le formulaire de commande pour découvrir notre offre de produits et de services. Les clients existants peuvent également acheter des modules complémentaires et des offres supplémentaires ici.";
$_LANG['clientareahomeorderbtn'] = "Accéder au formulaire de commande";
$_LANG['clientareahostingaddons'] = "Modules complémentaires";
$_LANG['clientareahostingaddonsintro'] = "Les modules complémentaires suivants sont disponibles pour ce produit.";
$_LANG['clientareahostingaddonsview'] = "Afficher";
$_LANG['clientareahostingamount'] = "Montant";
$_LANG['clientareahostingdomain'] = "Domaine";
$_LANG['clientareahostingnextduedate'] = "Prochaine échéance";
$_LANG['clientareahostingpackage'] = "Offre";
...
$_LANG['clientarealeaveblank'] = "Laissez ce champ vide sauf si vous souhaitez modifier votre mot de passe.";
$_LANG['clientareamodifydomaincontactinfo'] = "Modifier les informations de contact du domaine";
$_LANG['clientareamodifynameservers'] = "Modifier les serveurs de noms";
...
$_LANG['clientareanavccdetails'] = "Infos de la carte bancaire";
$_LANG['clientareanavchangecc'] = "Modifier les infos de la carte bancaire";
$_LANG['clientareanavchangepw'] = "Modifier le mot de passe";
$_LANG['clientareanavcontacts'] = "Gestion des contacts";
$_LANG['clientareanavdetails'] = "Détails du compte";
...
$_LANG['clientareanavsecurityquestions'] = "Changer la question de sécurité";
$_LANG['clientareanavservices'] = "Mes services";
$_LANG['clientareanavsupporttickets'] = "Mes tickets";
$_LANG['clientareanoaddons'] = "Aucun module complémentaire pour ce compte";
$_LANG['clientareanocontacts'] = "Aucun contact trouvé";
$_LANG['clientareapassword'] = "Mot de passe";
$_LANG['clientareapending'] = "En attente";
$_LANG['clientareapendingregistration'] = "Enregistrement en attente";
$_LANG['clientareapendingtransfer'] = "Transfert en attente";
$_LANG['clientareaphonenumber'] = "Numéro de téléphone";
$_LANG['clientareapostcode'] = "Code postal";
$_LANG['clientareaproductdetails'] = "Infos produit";
$_LANG['clientareaproductdetailsintro'] = "Voici un aperçu de tous vos produits/services.";
$_LANG['clientareaproducts'] = "Mes produits et services";
$_LANG['clientareaproductsintro'] = "Voici tous les services de ce compte.";
$_LANG['clientareaproductsnone'] = "Aucun produit/services commandé";
$_LANG['clientareaprojects'] = "Mes projets";
$_LANG['clientarearedemption'] = "Période de rédemption (expirée)";
$_LANG['clientarearegistrationperiod'] = "Durée d'inscription";
$_LANG['clientareasavechanges'] = "Sauvegarder les modifications";
$_LANG['clientareasecurityanswer'] = "Veuillez saisir une réponse.";
...
$_LANG['clientareaterminated'] = "Résilié";
...
$_LANG['clientareaviewaddons'] = "Afficher les modules complémentaires disponibles";
...
$_LANG['clientregisterverifydescription'] = "Veuillez saisir le texte qui se trouve dans l'image ci-dessous dans le champ prévu. Cette mesure est nécessaire pour empêcher les inscriptions automatisées par des 'robots'.";
$_LANG['clientregisterverifyinvalid'] = "Code de l'image incorrect";
$_LANG['close'] = "Fermer";
$_LANG['closed'] = "Fermé";
$_LANG['closewindow'] = "Fermer cette fenêtre";
$_LANG['cloudSlider']['feature01Description'] = "La disponibilité du serveur est critique pour toutes les entreprises : c'est le cœur de votre entreprise d'hébergement. Les serveurs de fichiers, de bases de données, de messagerie et Web sont des éléments indispensables de la plupart des processus d'entreprises. Les temps d'interruption ont des effets négatifs directs sur la productivité, les ventes, les employés et la satisfaction de la clientèle. Voilà pourquoi assurer la disponibilité maximale des serveurs est si important pour nous : nous voulons vous assurer que vos processus d'entreprise en cours d'exécution fonctionnent pleinement afin que vos clients soient satisfaits.";
$_LANG['cloudSlider']['feature01DescriptionTwo'] = "Lorsque vous nous confiez vos besoins professionnels, nous vous garantissons une disponibilité de 99,9 % des services que nous proposons, en dehors de toute maintenance standard.";
...
$_LANG['cloudSlider']['feature03Description'] = "Restez serein ! Nous fournissons un service de surveillance de la sécurité et de protection DDoS disponible 24/7. La protection des données de vos clients est une priorité pour vous, et pour nous aussi. Notre équipe de sécurité et nos systèmes de protection sont opérationnels en permanence afin de fournir le niveau de sécurité nécessaire à l'ère du numérique.";
$_LANG['cloudSlider']['feature03DescriptionTwo'] = "Une large gamme d'outils de sécurité est à votre disposition, y compris les certificats SSL, la configuration de pare-feu, les services de surveillance de la sécurité, l'accès VPN, et plus.";
$_LANG['cloudSlider']['feature03Title'] = "Sécurité de premier ordre";
$_LANG['cloudSlider']['selectProductLevel'] = "Sélectionnez le niveau optimal pour vos besoins !";
$_LANG['codeApplied'] = "Code promotionnel appliqué";
$_LANG['completeorder'] = "Régler la commande";
$_LANG['configModalTitle'] = "Configuration";
$_LANG['configoptionqtyminmax'] = "%s : minimum %s et maximum %s";
...
$_LANG['contactsend'] = "Envoyer un message";
$_LANG['contactsent'] = "Message envoyé";
$_LANG['contactsubject'] = "Objet";
$_LANG['contacttitle'] = "Avant-vente - Contactez-nous";
$_LANG['contactus'] = "Nous contacter";
...
$_LANG['country'] = "Pays";
$_LANG['cpanellogin'] = "Se connecter à cPanel";
$_LANG['cpanelwebmaillogin'] = "Se connecter au Webmail";
$_LANG['cpanelwhmlogin'] = "Se connecter à WHM";
$_LANG['create'] = "Créer";
$_LANG['createNewSupportRequest'] = "Créer une nouvelle demande d'assistance";
$_LANG['createnewcontact'] = "Nouveau contact…";
$_LANG['creditCard']['removeDescription'] = "Voulez-vous vraiment supprimer les détails relatifs à votre carte bancaire ?";
$_LANG['creditCardHolderName'] = "Nom du titulaire de la carte";
$_LANG['creditCardStore'] = "Sauvegarder la carte pour les prochains achats";
$_LANG['creditcard'] = "Payer par carte bancaire";
$_LANG['creditcard3dsecure'] = "À des fins de prévention contre la fraude, nous vous demandons de procéder à la vérification Verified by Visa ou Mastercard SecureCode si vous avez activé ce mode de paiement pour ce service.<br /><br />N'actualisez pas la page et ne revenez pas à la page précédente, car cette transaction risque d'être interrompue ou annulée.";
$_LANG['creditcardcardexpires'] = "Date d'expiration";
$_LANG['creditcardcardissuenum'] = "Numéro d'émission";
...
$_LANG['creditcarddeclined'] = "Votre carte a été refusée. Essayez avec une autre carte ou contactez notre service d'assistance.";
$_LANG['creditcarddelete'] = "Supprimer la carte bancaire enregistrée";
$_LANG['creditcarddeleteconfirmation'] = "Les informations enregistrées concernant votre carte bancaire ont été supprimées de votre compte.";
$_LANG['creditcarddetails'] = "Infos de la carte bancaire";
$_LANG['creditcardenterexpirydate'] = "Vous n'avez pas saisi la date d'expiration.";
$_LANG['creditcardenternewcard'] = "Saisissez les informations de la nouvelle carte ci-dessous.";
$_LANG['creditcardenternumber'] = "Vous n'avez pas saisi le numéro de votre carte.";
$_LANG['creditcardexpirydateinvalid'] = "La date d'expiration doit être saisie au format MM/AA et ne doit pas être antérieure à la date courante.";
$_LANG['creditcardinvalid'] = "Les informations de carte bancaire ne sont pas valides. Essayez avec une autre carte ou contactez notre service d'assistance.";
$_LANG['creditcardnonestored'] = "Aucune carte enregistrée";
$_LANG['creditcardnostore'] = "Cochez cette case si vous souhaitez que les informations de votre carte bancaire NE soient PAS stockées pour les paiements récurrents.";
$_LANG['creditcardnumberinvalid'] = "Le numéro de la carte bancaire n'est pas valide.";
$_LANG['creditcardsecuritynotice'] = "Toutes les données saisies ici sont envoyées de façon sécurisée et sont chiffrées pour éviter les risques de fraude.";
$_LANG['creditcardupdatenotpossible'] = "Les informations de la carte bancaire ne peuvent pas être mises à jour pour le moment. Merci d'essayer ultérieurement.";
$_LANG['creditcarduseexisting'] = "Utiliser la carte existante";
$_LANG['creditcardyourinfo'] = "Informations de facturation";
...
$_LANG['directDebitAccountType'] = "Type de compte bancaire";
...
$_LANG['directDebitErrorAccNumber'] = "Vous devez saisir votre numéro de compte bancaire";
$_LANG['directDebitErrorAccNumberMismatch'] = "Votre numéro de compte et sa confirmation ne correspondent pas";
$_LANG['directDebitErrorAccountType'] = "Vous devez choisir le type de compte bancaire";
...
$_LANG['directDebitErrorNoBankName'] = "Vous devez saisir le nom de votre banque";
...
$_LANG['directDebitPleaseSubmit'] = "Veuillez saisir vos coordonnées bancaires ci-dessous pour payer par prélèvement automatique.";
$_LANG['directDebitSavings'] = "Épargne";
$_LANG['directDebitSubmit'] = "Envoyer";
$_LANG['directDebitThanks'] = "Merci de nous avoir transmis vos informations. Nous allons tenter de traiter votre paiement dans les prochains jours. Nous vous contacterons en cas de problèmes.";
$_LANG['directadminlogin'] = "Se connecter à DirectAdmin";
$_LANG['disable'] = "Désactiver";
$_LANG['disabled'] = "Désactivée";
$_LANG['disclaimers'] = "Avertissements";
$_LANG['discounts'] = "Réductions";
$_LANG['diskSpace'] = "Espace disque";
$_LANG['diskUsage'] = "Utilisation du disque";
$_LANG['dismiss'] = "Rejeter";
$_LANG['dlinvalidlink'] = "Lien suivi non valide. Veuillez contacter l'assistance.";
$_LANG['doToday'] = "Que vous voulez faire aujourd'hui ?";
...
$_LANG['domainContactUs'] = "Nous contacter";
...
$_LANG['domainRenewal']['renewingDomains'] = "Renouveler vos domaines";
...
$_LANG['domainSearch']['notAvailable'] = "Non disponible";
...
$_LANG['domainaddons'] = "Modules complémentaires";
$_LANG['domainaddonsbuynow'] = "Achetez maintenant pour";
$_LANG['domainaddonscancelareyousure'] = "Voulez-vous vraiment désactiver et annuler ce module complémentaire pour le domaine ?";
$_LANG['domainaddonscancelfailed'] = "Échec lors de la désactivation du module complémentaire. Veuillez contacter l'assistance technique.";
$_LANG['domainaddonscancelsuccess'] = "L'option a bien été désactivée.";
$_LANG['domainaddonsconfirm'] = "Confirmer l'annulation";
$_LANG['domainaddonsdnsmanagement'] = "Gestion des enregistrements d'hôtes DNS";
...
$_LANG['domainaddonsinfo'] = "Les modules complémentaires suivants sont disponibles pour votre domaine ou vos domaines…";
...
$_LANG['domainautorenewstatus'] = "Statut de l'autorenouvellement";
...
$_LANG['domainbulksearchintro'] = "Recherchez jusqu'à 20 noms de domaines en même temps. Saisissez un nom de domaine par ligne, sans http:// ni www.";
...
$_LANG['domaincannotbemanaged'] = "ne peut pas être géré automatiquement - merci de contacter le support concernant toute modification que vous souhaitez effectuer";
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "Payer maintenant";
$_LANG['domainchecker']['alreadyincartmsg'] = "Ce domaine est déjà dans votre panier. Procédez au paiement pour finaliser votre achat.";
...
$_LANG['domaincheckerdomainexample'] = " par exemple : example.com";
...
$_LANG['domaincheckerunabletooffertld'] = "Malheureusement, nous ne pouvons pas enregistrer ce TLD actuellement.";
...
$_LANG['domaincontactdetails']['Company Name'] = "Nom d'entreprise";
...
$_LANG['domaincontactdetails']['Email'] = "Adresse e-mail";
$_LANG['domaincontactdetails']['Email Address'] = "Adresse e-mail";
...
$_LANG['domaincontactdetails']['State'] = "État/Province/Région";
...
$_LANG['domaincontactinfo'] = "Infos contact";
$_LANG['domaincontactinfoedit'] = "Modifier les informations du contact";
$_LANG['domaincontactprimary'] = "Données du profil principal";
$_LANG['domaincontactusecustom'] = "Saisissez ci-dessous des informations personnalisées";
...
$_LANG['domaindnsmanagementdesc'] = "Vous pouvez associer votre nom de domaine à un site Web en le faisant pointer vers une adresse IP, rediriger vers un autre site, ou encore pointer vers une page temporaire (appelée parking), etc. Ces enregistrements sont également appelés sous-domaines.";
...
$_LANG['domainemailforwarding'] = "Redirection des e-mails";
...
$_LANG['domainemailforwardinglaunch'] = "Lancer le gestionnaire de redirection d'e-mails";
$_LANG['domainemailforwardingprefix'] = "Préfixe";
$_LANG['domaineppcode'] = "Code EPP";
$_LANG['domaineppcodedesc'] = "Doit être obtenu auprès registraire actuel pour autorisation";
$_LANG['domaineppcoderequired'] = "Vous devez indiquer le code EPP pour";
$_LANG['domainerror'] = "Il y a eu une erreur de connexion au registre du domaine. Veuillez réessayer plus tard.";
$_LANG['domainerrornodomain'] = "Veuillez saisir un nom de domaine valide.";
$_LANG['domainerrortoolong'] = "Le nom de domaine saisi est trop long. Les noms de domaine doivent comporter moins de 67 caractères.";
...
$_LANG['domaininfoexp'] = "À droite vous trouverez les informations relatives à votre nom de domaine. Vous pouvez gérer votre nom de domaine en utilisant les onglets ci-dessus.";
$_LANG['domainintrotext'] = "Inscrivez le nom du domaine et le TLD que vous désirez utiliser ci-dessous. Cliquez sur Vérifier pour voir si le nom de domaine est disponible pour enregistrement.";
$_LANG['domainlockingexp'] = "Verrouillez votre domaine afin d'empêcher son transfert ailleurs sans votre autorisation.";
$_LANG['domainlookupbutton'] = "Chercher";
...
$_LANG['domainnameserver1'] = "Serveurs de noms 1";
$_LANG['domainnameserver2'] = "Serveurs de noms 2";
$_LANG['domainnameserver3'] = "Serveurs de noms 3";
$_LANG['domainnameserver4'] = "Serveurs de noms 4";
$_LANG['domainnameserver5'] = "Serveurs de noms 5";
...
$_LANG['domainprice'] = "Tarif";
$_LANG['domainprivatenameservers'] = "Serveurs de noms privés";
$_LANG['domainregisterns'] = "Enregistrer des serveurs de noms";
$_LANG['domainregisternscurrentip'] = "Adresse IP actuelle";
$_LANG['domainregisternsdel'] = "Supprimer un serveur de noms";
$_LANG['domainregisternsdelsuccess'] = "Le serveur de noms a bien été supprimé.";
...
$_LANG['domainregisternsregsuccess'] = "Le serveur de noms a bien été enregistré.";
$_LANG['domainregistrantchoose'] = "Choisissez le contact que vous voulez utiliser";
$_LANG['domainregistrantinfo'] = "Informations sur le titulaire du domaine";
...
$_LANG['domains']['changePendingFormRequired'] = "Les modifications des informations de contact du titulaire que vous avez effectuées ont bien été envoyées. Pour terminer ce processus, vous devez remplir le formulaire <strong>Changement de titulaire</strong>. Veuillez ouvrir la page :form et remplir le formulaire en suivant les instructions. Ensuite, renvoyez-nous le formulaire pour finaliser le processus.";
...
$_LANG['domains']['deTermsDescription1'] = "Pour enregistrer ou transférer un nom de domaine ou uniquement changer les informations de contact du titulaire, vous devez accepter les CGU .DE";
$_LANG['domains']['deTermsDescription2'] = "(Texte complet des Conditions Générales d'Utilisation : .DE: http://www.denic.de/en/bedingungen.html.)";
...
$_LANG['domains']['irtpLockDescriptionDate'] = "Ce domaine est actuellement verrouillé : aucun transfert n'est possible en raison d'un changement de contact ou d'une nouvelle inscription. Le blocage expirera le :date.";
...
$_LANG['domains']['modifyPending'] = "Vérification requise";
$_LANG['domains']['newRegistration'] = "Un e-mail a été envoyé au propriétaire du domaine enregistré. La vérification doit être complétée pour éviter la suspension.";
$_LANG['domains']['newRegistrationDate'] = "Un e-mail a été envoyé au propriétaire du domaine enregistré. La vérification doit être complétée avant le :date pour éviter la suspension.";
$_LANG['domains']['optOut'] = "Désactivation du verrouillage de transfert (si disponible)";
$_LANG['domains']['optOutReason'] = "Motif du refus (facultatif)";
$_LANG['domains']['resendNotification'] = "Renvoyer l'e-mail de vérification";
$_LANG['domains']['resendNotificationQuestion'] = "Voulez-vous vraiment renvoyer ce courriel ?";
$_LANG['domains']['resendNotificationSuccess'] = "L'e-mail de vérification a été renvoyé.";
$_LANG['domains']['verificationRequired'] = "Vérification requise";
...
$_LANG['domainsPendingRegistration'] = "Enregistrement en attente";
$_LANG['domainsPendingTransfer'] = "Transfert en attente";
...
$_LANG['domainsautorenewdisabledwarning'] = "ATTENTION ! Ce domaine n'est pas configuré pour être renouvelé automatiquement.<br />Il expirera donc et deviendra inactif à sa date d'échéance s'il n'est pas renouvelé manuellement.";
$_LANG['domainsautorenewenable'] = "Activer le renouvellement automatique";
$_LANG['domainsautorenewenabled'] = "Activé";
...
$_LANG['domainsothersuggestions'] = "Les suggestions suivantes vous conviendront peut-être également !";
$_LANG['domainspricing'] = "Tarif des noms de domaine";
$_LANG['domainsregister'] = "Inscription";
...
$_LANG['domainssuggestionswarnings'] = "Les noms de domaine suggérés ne sont pas toujours disponibles. La disponibilité est vérifiée en temps réel au moment de l'ajout à votre panier.";
$_LANG['domainstatus'] = "Statut";
$_LANG['domainstransfer'] = "Transférer";
$_LANG['domaintitle'] = "Vérificateur de domaine";
...
$_LANG['downloadLoginRequiredTagline'] = "Veuillez vous connecter pour accéder au téléchargement de ce fichier.";
...
$_LANG['downloadname'] = "Télécharger";
$_LANG['downloadproductrequired'] = "Pour télécharger ce fichier, vous devez avoir une commande active du produit/service suivant :";
...
$_LANG['downloadsdescription'] = "Afficher notre section de téléchargements";
...
$_LANG['downloadssearch'] = "Parcourir les téléchargements";
...
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute doit être un nombre entier.";
...
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute doit comporter au moins :min caractères.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = "L'attribut :attribute doit être un nombre.";
...
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute doit être une URL valide qui inclut le protocole ('http://' or 'https://').";
$_LANG['edit'] = "Modifier";
$_LANG['email'] = "Adresse e-mail";
$_LANG['emailMarketing']['joinOurMailingList'] = "Rejoignez notre liste d'envoi";
$_LANG['emailMarketingAlreadyOptedIn'] = "Vous êtes déjà sur notre liste de diffusion.";
$_LANG['emailMarketingAlreadyOptedOut'] = "Vous êtes déjà désinscrit de notre liste de diffusion.";
$_LANG['emailPreferences']['affiliate'] = "E-mails d'affiliation - Recevoir des notifications d'affiliation";
$_LANG['emailPreferences']['domain'] = "E-mails de domaine - Avis de confirmation d'enregistrement, de transfert et de renouvellement";
...
$_LANG['emailPreferences']['product'] = "E-mails de produits - Messages de bienvenue, suspensions et autres notifications de cycle de vie";
...
$_LANG['emailVerification']['notFound'] = "Oups ! Nous n'avons pas trouvé de vérification en attente correspondant à votre demande. ";
...
$_LANG['emailoptout'] = "Désinscription de la lettre d'information";
$_LANG['emailoptoutdesc'] = "Cochez cette case pour vous désinscrire de nos lettres d'information.";
$_LANG['emailstagline'] = "Voici une copie des derniers e-mails que nous vous avons envoyés…";
$_LANG['emailviewmessage'] = "Voir le message";
$_LANG['emptycart'] = "Vider le panier";
$_LANG['enabled'] = "Activée";
$_LANG['encryption_failed'] = "Échec du chiffrement : %s";
$_LANG['enkompasslogin'] = "Se connecter à Enkompass";
$_LANG['enomfrregistration']['EU Non-French Companies']['Name'] = "Entreprises non françaises EU";
$_LANG['enomfrregistration']['EU Non-French Companies']['Requirements'] = "Veuillez fournir le \"Numéro DUNS\" et la \"Date de naissance\" du contact propriétaire.";
$_LANG['enomfrregistration']['EU Non-French Individuals']['Name'] = "Personnes non françaises EU";
$_LANG['enomfrregistration']['EU Non-French Individuals']['Requirements'] = "Veuillez indiquer votre \"Date de naissance\" et votre \"Numéro de carte d'identité\".";
$_LANG['enomfrregistration']['French Companies']['Name'] = "Entreprises françaises";
$_LANG['enomfrregistration']['French Companies']['Requirements'] = "Veuillez indiquer la \"Date de naissance\", la \"Ville de naissance\" et le \"Code postal du lieu de naissance\" pour le propriétaire du contact, avec votre numéro de SIRET.";
$_LANG['enomfrregistration']['French Individuals']['Name'] = "Personnes françaises";
$_LANG['enomfrregistration']['French Individuals']['Requirements'] = "Veuillez indiquer votre \"Date de naissance\", votre \"Ville de naissance\", le \"Code postal du lieu de naissance\" et le \"Numéro de carte d'identité\".";
$_LANG['enomfrregistration']['Heading'] = "Les domaines .fr ont des valeurs différentes requises en fonction de votre nationalité et du type d'enregistrement :";
$_LANG['enomfrregistration']['Non-EU Warning'] = "Les coordonnées du client doivent se trouver dans l'UE, sinon l'enregistrement échouera.";
...
$_LANG['enomtrustelogin'] = "Se connecter au panneau de contrôle TrustE";
$_LANG['enteremail'] = "Saisissez l'adresse e-mail";
$_LANG['error'] = "Erreur";
$_LANG['errorButTryAgain'] = "Une erreur s'est produite. Veuillez réessayer.";
$_LANG['errorPage']['404']['description'] = "Essayez les options ci-dessous pour poursuivre la navigation !";
...
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Page d'accueil";
...
$_LANG['errors']['badRequest'] = "Requête incorrecte";
$_LANG['errors']['badRequestTryAgain'] = "Une erreur s'est produite. Veuillez réessayer.";
$_LANG['errors']['tryAgainOrSupport'] = "Veuillez réessayer plus tard ou <a href=\"submitticket.php\">contacter l'assistance</a>.";
$_LANG['estimateTaxes'] = "Estimation des taxes";
$_LANG['every'] = "Chaque";
$_LANG['exampledomain'] = "par exemple : example.com";
$_LANG['excludeTLDs'] = "Sauf certains TLD et renouvellements récents";
...
$_LANG['feedbackclickreview'] = "Cliquez ici pour consulter le ticket";
...
$_LANG['feedbackimprove'] = "Que pouvons-nous mettre en place pour améliorer votre expérience à l'avenir ?";
$_LANG['feedbacklastreplied'] = "Dernière réponse à";
$_LANG['feedbackopenedat'] = "Date d'ouverture :";
$_LANG['feedbackpleasecomment1'] = "Veuillez saisir votre avis";
$_LANG['feedbackpleaserate1'] = "Veuillez attribuer une note sur une échelle de 1 à 10 :";
...
$_LANG['feedbacksupplyrating'] = "Veuillez attribuer au moins une note pour :staffname (les commentaires sont facultatifs)";
$_LANG['feedbackthankyou'] = "Nous vous remercions de prendre le temps de partager vos commentaires.";
...
$_LANG['fileManager'] = "Gestionnaire de fichiers";
...
$_LANG['flashtutorialsheadertext'] = "Nos tutoriels Flash vous aideront à optimiser l'utilisation de votre panneau de contrôle. Sélectionnez une tâche ci-dessous pour suivre les étapes d'optimisation pas-à-pas.";
$_LANG['fluidvmrestart'] = "Redémarrer le serveur VPS";
$_LANG['forJust'] = "pour seulement";
...
$_LANG['fraud']['furtherVal'] = "De plus amples vérifications sont nécessaires pour traiter votre commande. Cliquez sur le bouton et suivez les indications pour le processus d'envoi sécurisé. Vous aurez terminé dans moins d'une minute.";
...
$_LANG['fraud']['status']['notReviewed'] = "Requis";
$_LANG['fraud']['status']['reviewRequested'] = "Envoyé";
$_LANG['fraud']['status']['validated'] = "Vérifié(e)";
$_LANG['fraud']['submitDocs'] = "Envoyer les documents";
$_LANG['fraud']['submitSuccessMsg'] = "Merci ! Les documents ont été fournis et vont être manuellement contrôlés par notre équipe.";
$_LANG['fraud']['title'] = "Vérification des fraudes";
...
$_LANG['fromJust'] = "à partir de seulement";
$_LANG['gamecplogin'] = "Se connecter à GameCP";
...
$_LANG['generatePassword']['lengthValidationError'] = "Veuillez saisir un nombre entre 8 et 64 pour la longueur du mot de passe.";
...
$_LANG['genericerror']['title'] = "Oups, il y a eu un problème !";
$_LANG['getStartedNow'] = "Démarrer";
$_LANG['getsupport'] = "Obtenir de l'aide";
...
$_LANG['go'] = "OK";
$_LANG['goCardless']['automaticPayment'] = "Il y a une configuration de paiement automatique pour ce compte. Aucun paiement manuel n'est requis.";
...
$_LANG['headertext'] = "Bienvenue sur notre portail d'assistance.";
$_LANG['heartinternetlogin'] = "Se connecter au panneau de contrôle";
$_LANG['hello'] = "Bonjour";
$_LANG['helloname'] = "Bonjour, %s !";
$_LANG['helmlogin'] = "Se connecter à Helm Control Panel";
$_LANG['hideMenu'] = "Masquer le menu";
$_LANG['hideSearchControls'] = "Masquer les commandes de recherche";
$_LANG['homebegin'] = "Vérification de la disponibilité d'un nom de domaine en cours…";
...
$_LANG['idnLanguage']['kir'] = "Kirghize";
...
$_LANG['imagecheck'] = "Veuillez saisir le code de sécurité affiché dans l'image. Cette étape est obligatoire pour éviter les envois automatiques.";
...
$_LANG['insufficientstockmessage'] = "Certains articles sont actuellement en rupture de stock, c'est pourquoi les quantités dans votre panier ont été ajustées.";
...
$_LANG['invalidchars'] = "Veuillez supprimer les espaces ou les caractères spéciaux de ponctuation.";
$_LANG['invoicePaymentAutoWhenDue'] = "Votre paiement vous sera demandé automatiquement à l'échéance.";
$_LANG['invoicePaymentInitiated'] = "Merci ! Votre paiement a bien été initié. Vous recevrez un courriel de confirmation une fois le paiement effectué.";
...
$_LANG['invoicePaymentSuccessAwaitingNotify'] = "Merci d'avoir terminé le processus de paiement. Nous attendons une notification pour confirmer le paiement que vous venez de faire. Nous vous enverrons un courriel de confirmation dès que celui-ci nous sera parvenu.";
$_LANG['invoiceaddcreditamount'] = "Saisissez le montant à appliquer";
$_LANG['invoiceaddcreditapply'] = "Utiliser le crédit";
$_LANG['invoiceaddcreditdesc1'] = "Votre solde";
$_LANG['invoiceaddcreditdesc2'] = "Vous pouvez l'utiliser pour payer votre facture via le formulaire ci-dessous.";
...
$_LANG['invoicelineitems'] = "Articles sur la facture";
$_LANG['invoicenumber'] = "Facture nᵒ ";
$_LANG['invoiceofflinepaid'] = "Le paiement hors ligne par carte bancaire est une opération manuelle.<br />Lorsque vous aurez effectué votre paiement, vous recevrez un courriel.";
$_LANG['invoiceoneoffpayment'] = "Effectuer un paiement unique";
$_LANG['invoicepaymentfailedconfirmation'] = "Malheureusement, votre tentative de paiement a échoué.<br />Merci d'essayer à nouveau ou contactez le service d'assistance.";
$_LANG['invoicepaymentpendingreview'] = "Merci ! Votre paiement a bien été pris en compte et sera appliqué à votre facture dès que le processus de vérification de 2CheckOut sera terminé.<br /><br />Cela peut prendre jusqu'à quelques heures ; nous vous remercions de votre patience.";
$_LANG['invoicepaymentsuccessconfirmation'] = "Merci ! Le paiement a bien été effectué.";
...
$_LANG['invoicesadjustments'] = "Ajustements des factures";
...
$_LANG['invoiceserror'] = "Une erreur s'est produite. Veuillez réessayer.";
$_LANG['invoicesintro'] = "Vous pouvez consulter ici votre historique de facturation.";
$_LANG['invoicesinvoicedto'] = "Facturé adressée à";
...
$_LANG['invoicesoutstandingbalance'] = "Solde dû";
$_LANG['invoicesoutstandinginvoices'] = "Factures ouvertes";
...
$_LANG['invoicestitle'] = "Facture nᵒ ";
...
$_LANG['invoicestransid'] = "Transaction nᵒ ";
...
$_LANG['jobtitle'] = "Poste";
$_LANG['jobtitlereqforcompany'] = "(Obligatoire si vous avez saisi un nom d'organisation)";
$_LANG['jumpto'] = "Aller à";
$_LANG['kbquestionsearchere'] = "Vous avez une question ? Commencez votre recherche ici.";
$_LANG['kbsearchexplain'] = "Vous avez une question ? Commencez votre recherche ici.";
$_LANG['kbsuggestions'] = "Suggestions pour la base de connaissance";
$_LANG['kbsuggestionsexplanation'] = "Les articles suivants proviennent de la base de connaissance et pourraient répondre à votre question. Veuillez vérifier ces suggestions avant de nous faire parvenir votre question.";
...
$_LANG['knowledgebasedescription'] = "Consultez notre base de connaissances pour trouver les réponses aux questions fréquentes (FAQ).";
...
$_LANG['licensingaddon']['validips'] = "IP valides";
...
$_LANG['loginbutton'] = "Se connecter";
$_LANG['loginemail'] = "Adresse e-mail";
$_LANG['loginforgotten'] = "Mot de passe oublié ?";
$_LANG['loginforgotteninstructions'] = "Réinitialiser le mot de passe";
$_LANG['loginincorrect'] = "Adresse e-mail ou mot de passe incorrect. Veuillez réessayer.";
$_LANG['loginintrotext'] = "Vous devez vous connecter pour accéder à cette page. Ces identifiants de connexion sont différents du nom d'utilisateur et du mot de passe du panneau de contrôle de votre site Web.";
...
$_LANG['logoutsuccessful'] = "La déconnexion a bien été effectuée.";
$_LANG['logouttitle'] = "Se déconnecter";
$_LANG['makepayment'] = "Effectuer un paiement";
$_LANG['manage'] = "Gérer";
$_LANG['manageSubscription'] = "Gérer l'abonnement";
$_LANG['managecontacts'] = "Gérer les contacts";
...
$_LANG['markdown']['bigHeader'] = "Grand titre";
$_LANG['markdown']['bold'] = "gras";
$_LANG['markdown']['columnOne'] = "Colonne 1";
$_LANG['markdown']['columnThree'] = "Colonne 3";
$_LANG['markdown']['columnTwo'] = "Colonne 2";
$_LANG['markdown']['displayingCode'] = "Affichage du code";
$_LANG['markdown']['doe'] = "Dupont";
$_LANG['markdown']['emphasis'] = "Accentuation du texte";
$_LANG['markdown']['exampleLink'] = "http://www.example.com";
$_LANG['markdown']['female'] = "Femme";
$_LANG['markdown']['genericListItem'] = "Élément de liste générique";
$_LANG['markdown']['headers'] = "Titres";
$_LANG['markdown']['italics'] = "italique";
$_LANG['markdown']['john'] = "Dupont";
$_LANG['markdown']['links'] = "Liens";
$_LANG['markdown']['lists'] = "Listes";
$_LANG['markdown']['male'] = "Homme";
$_LANG['markdown']['mary'] = "Anne";
$_LANG['markdown']['mediumHeader'] = "Titre moyen";
$_LANG['markdown']['numberedListItem'] = "Élément de liste numéroté";
$_LANG['markdown']['quoteMultipleLines'] = "Elle peut s'étendre sur plusieurs lignes !";
$_LANG['markdown']['quotes'] = "Devis";
$_LANG['markdown']['saved'] = "enregistré";
$_LANG['markdown']['saving'] = "enregistrement automatique";
$_LANG['markdown']['smallHeader'] = "Petit titre";
$_LANG['markdown']['smith'] = "Dupont";
...
$_LANG['markdown']['tinyHeader'] = "Tout petit titre";
$_LANG['markdown']['title'] = "Guide Markdown";
$_LANG['markdown']['withoutAligning'] = "Ou sans aligner les colonnes…";
$_LANG['marketConnect']['codeGuard']['manage'] = "Se connecter au panneau de configuration de CodeGuard";
...
$_LANG['marketConnect']['emailServices']['manageEmail'] = "Gérer les courriers électroniques";
$_LANG['marketConnect']['marketgoo']['manage'] = "Se connecter au tableau de bord";
...
$_LANG['marketConnect']['siteBuilder']['buildWebsite'] = "Créer votre site Web";
...
$_LANG['marketConnect']['sitelock']['manage'] = "Se connecter à SiteLock";
$_LANG['marketConnect']['sitelock']['manageSecurity'] = "Gérer votre sécurité";
...
$_LANG['marketConnect']['sitelockvpn']['manageVPN'] = "Gérer votre VPN";
$_LANG['marketConnect']['socialbee']['manage'] = "Se connecter à SocialBee";
...
$_LANG['marketConnect']['threesixtymonitoring']['manage'] = "Se connecter au tableau de bord";
$_LANG['marketConnect']['websiteBuilder']['buildWebsite'] = "Créer votre site Web";
...
$_LANG['marketConnect']['websiteBuilder']['manage'] = "Se connecter à Weebly";
...
$_LANG['masspaydescription'] = "Vous trouverez ci-dessous un récapitulatif des factures sélectionnées ainsi que le montant total à régler. Pour procéder au paiement, choisissez le mode de paiement ci-dessous et validez.";
$_LANG['masspayintro'] = "Effectuez un paiement unique pour toutes ces factures";
$_LANG['masspaymakepayment'] = "Effectuer un paiement";
$_LANG['masspaymentselectgateway'] = "Sélectionnez la passerelle de paiement";
$_LANG['masspayselected'] = "Payer la ou les factures sélectionnées";
...
$_LANG['maxmind_addressinvalid'] = "Votre adresse n'est pas reconnue. Veuillez vérifier et saisir de nouveau votre adresse.";
$_LANG['maxmind_anonproxy'] = "Nous n'autorisons pas les commandes passées via un proxy anonyme.";
$_LANG['maxmind_callingnow'] = "Vous allez recevoir un appel automatique sur votre numéro de téléphone. Il s'agit d'une mesure de sécurité pour lutter contre les fraudes. Vous recevrez un code de sécurité à 4 chiffres. Veuillez saisir ce code ci-dessous pour terminer votre commande.";
...
$_LANG['maxmind_countrymismatch'] = "Le pays de votre adresse IP et celui de votre adresse de facturation ne correspondent pas. Nous ne pouvons donc pas accepter votre commande.";
...
$_LANG['maxmind_rejectemail'] = "Nous n'acceptons pas les commandes utilisant une adresse e-mail gratuite. Veuillez utiliser une autre adresse.";
$_LANG['maxmind_title'] = "Max Mind";
$_LANG['metrics']['billing'] = "Facturation";
$_LANG['metrics']['currentUsage'] = "Utilisation actuelle";
$_LANG['metrics']['explanation'] = "En plus du tarif de base, les frais de facturation de ce produit incluent l'utilisation. Les statistiques d'utilisation et leurs informations de tarification sont affichées ci-dessous.";
$_LANG['metrics']['from'] = "De";
$_LANG['metrics']['includedInBase'] = "inclus dans le tarif de base";
$_LANG['metrics']['includedNotCounted'] = "Inclus";
$_LANG['metrics']['invoiceitem']['included'] = ":included :metricname inclus";
$_LANG['metrics']['invoiceitem']['perunit'] = ":consumed :metricname à :price par :perUnitName";
...
$_LANG['metrics']['pricePer'] = "Tarif par";
$_LANG['metrics']['pricePerUnit'] = "Prix par unité";
$_LANG['metrics']['pricing'] = "Tarif";
$_LANG['metrics']['pricingschema']['flat']['detail'] = "Le tarif unitaire est déterminé par le volume total consommé.";
$_LANG['metrics']['pricingschema']['flat']['info'] = "Cet article a un tarif fixe par volume.";
$_LANG['metrics']['pricingschema']['grad']['detail'] = "Le tarif unitaire est calculé par période de consommation. Le tarif total est la somme des calculs de périodes.";
$_LANG['metrics']['pricingschema']['grad']['info'] = "Cet article a une tarification progressive par paliers.";
$_LANG['metrics']['pricingschema']['simple']['detail'] = "Le tarif unitaire est constant quel que soit le volume.";
$_LANG['metrics']['pricingschema']['simple']['info'] = "Cet article a une tarification unique.";
$_LANG['metrics']['startingFrom'] = "À partir de";
$_LANG['metrics']['startingQuantity'] = "Quantité initiale";
$_LANG['metrics']['title'] = "Métriques";
$_LANG['metrics']['to'] = "à";
...
$_LANG['moduleactionsuccess'] = "Action bien terminée !";
$_LANG['more'] = "Plus";
...
$_LANG['navMarketConnectService']['sitelock'] = "Sécurité des sites Web";
...
$_LANG['navmanagecc'] = "Gérer les cartes bancaires";
...
$_LANG['networkIssues']['scheduled'] = "Il y a :count problèmes impactant le réseau programmé.";
$_LANG['networkIssuesAware'] = "Nous avons connaissance d'un problème pouvant avoir des conséquences sur le service.";
...
$_LANG['networkissuesaffectingyourservers'] = "Veuillez noter que les problèmes affectant un serveur sur lequel vous avez un compte sont surlignés.";
...
$_LANG['networkissuespriorityhigh'] = "Élevée";
$_LANG['networkissuesprioritylow'] = "Faible";
$_LANG['networkissuesprioritymedium'] = "Moyenne";
$_LANG['networkissuesstatusinprogress'] = "En cours";
$_LANG['networkissuesstatusinvestigating'] = "Examen en cours";
$_LANG['networkissuesstatusopen'] = "Ouvert";
$_LANG['networkissuesstatusoutage'] = "Panne";
$_LANG['networkissuesstatusreported'] = "Signalé";
...
$_LANG['networkstatusintro'] = "Informations relatives à l'état du service et annonces liées au réseau";
$_LANG['networkstatusnone'] = "Il n'y a aucun problème de réseau %s actuellement.";
$_LANG['networkstatussubtitle'] = "Nouveautés et informations";
$_LANG['networkstatustitle'] = "État du réseau";
$_LANG['never'] = "Jamais";
$_LANG['new'] = "Nouveau";
$_LANG['newPrice'] = "Nouveau prix";
$_LANG['newcustomer'] = "Nouveau client";
$_LANG['newcustomersignup'] = "<strong>Pas d'inscription encore ?</strong> %sInscrivez-vous ici%s";
$_LANG['newpassword'] = "Nouveau mot de passe";
$_LANG['news'] = "Actualités";
$_LANG['newsletterremoved'] = "Votre adresse électronique a bien été supprimée de notre liste de diffusion.";
$_LANG['newsletterresubscribe'] = "Vous pouvez vous réabonner à tout moment si vous le souhaitez. Pour cela, allez dans la section %sMes informations%s de votre espace client.";
$_LANG['newslettersubscribed'] = "Votre adresse électronique a bien été ajoutée à notre liste de diffusion.";
$_LANG['next'] = "Suivant";
$_LANG['nextdue'] = "Prochaine échéance";
$_LANG['nextpage'] = "Page suivante";
$_LANG['no'] = "Non";
$_LANG['noDomain'] = "Aucun domaine";
$_LANG['noDomainsFound'] = "Aucun domaine n'a été trouvé";
$_LANG['noPasswordResetWhenLoggedIn'] = "Vous ne pouvez pas demander à réinitialiser votre mot de passe lorsque vous êtes connecté. Veuillez d'abord vous déconnecter.";
$_LANG['noPermission'] = "Aucune autorisation";
$_LANG['noannouncements'] = "Aucune annonce à afficher";
$_LANG['nocarddetails'] = "Aucune info de carte bancaire n'est enregistrée";
$_LANG['nodeworxlogin'] = "Se connecter au panneau de contrôle NodeWorx";
$_LANG['nodomain'] = "Aucun domaine spécifié";
$_LANG['nodomainextensions'] = "Il n'y a pas d'extensions de domaines configurées actuellement pour l'achat.";
$_LANG['noinvoicesduemsg'] = "Vous n'avez actuellement aucune facture impayée.";
$_LANG['nokbcategories'] = "Aucune catégorie existante";
$_LANG['none'] = "Aucun(e)";
$_LANG['nonotifications'] = "Aucune notification";
$_LANG['noquotes'] = "Il n'y a aucun devis dans votre compte.<br />Pour demander un devis, veuillez ouvrir un ticket.";
...
$_LANG['nschoicecustom'] = "Utiliser des serveurs de noms personnalisés (à spécifier ci-dessous)";
...
$_LANG['oauth']['badTwoFactorAuthModule'] = "Ce module d'authentification à deux facteurs n'est pas utilisable. Veuillez contacter l'assistance.";
...
$_LANG['oauth']['notYou'] = "Ce n'est pas vous ?";
$_LANG['oauth']['permAccessNameAndEmail'] = "Accéder à votre nom et adresse e-mail";
$_LANG['oauth']['redirectDescriptionOne'] = "Nous vous redirigeons vers l'application. Cela peut prendre un petit moment.";
...
$_LANG['oops'] = "Oups";
$_LANG['opennewticket'] = "Ouvrir un ticket";
$_LANG['or'] = "ou";
...
$_LANG['orderForm']['addHosting'] = "Ajouter un hébergement";
$_LANG['orderForm']['addToCart'] = "Ajouter au panier";
$_LANG['orderForm']['addedToCartRemove'] = "Ajouté au panier (Retirer)";
$_LANG['orderForm']['additionalInformation'] = "Autres informations";
$_LANG['orderForm']['additionalNotes'] = "Autres infos";
$_LANG['orderForm']['alreadyRegistered'] = "Vous avez déjà un compte ?";
$_LANG['orderForm']['applyPromoCode'] = "Appliquer le code promotionnel";
$_LANG['orderForm']['authCode'] = "Code d'autorisation";
$_LANG['orderForm']['authCodePlaceholder'] = "Code EPP / Auth Code";
$_LANG['orderForm']['authCodeTooltip'] = "Pour initier ce transfert, vous avez besoin d'un code que vous pouvez obtenir gratuitement auprès de votre bureau d'enregistrement actuel. Ce code est communément désigné comme code EPP ou Auth code. Il agit comme un mot de passe et est unique à chaque nom de domaine.";
...
$_LANG['orderForm']['companyName'] = "Nom d'entreprise";
$_LANG['orderForm']['configureDesiredOptions'] = "Configurez les options et procédez à la commande.";
$_LANG['orderForm']['continueShopping'] = "Continuer vos achats";
...
$_LANG['orderForm']['domainAddedToCart'] = "Le domaine a été ajouté à votre panier.";
$_LANG['orderForm']['domainAlternativeContact'] = "Vous pouvez spécifier des informations de contact différentes pour l'enregistrement du nom de domaine si vous passez une commande pour une autre personne ou entité. Si ce n'est pas le cas, vous pouvez ignorer cette section.";
$_LANG['orderForm']['domainAvailabilityCached'] = "Les résultats de disponibilité des domaines sont mis en cache. Par conséquent, certains domaines enregistrés récemment pourraient être affichés comme disponibles.";
...
$_LANG['orderForm']['domainInvalid'] = "Nom de domaine fourni non valide";
...
$_LANG['orderForm']['domainLengthRequirements'] = " et comporter entre <span class=\"min-length\"></span> et <span class=\"max-length\"></span> caractères.";
$_LANG['orderForm']['domainLetterOrNumber'] = "Les domaines doivent commencer par une lettre ou un nombre";
$_LANG['orderForm']['domainOrKeyword'] = "Saisissez un domaine ou un mot-clé";
$_LANG['orderForm']['domainPriceRegisterLabel'] = "Continuez pour enregistrer ce domaine pour";
$_LANG['orderForm']['domainPriceTransferLabel'] = "Transférez votre domaine chez nous et prolongez d'un an* pour :";
$_LANG['orderForm']['downgradeNotPossible'] = "Il n'y a pas de rétrogradation disponible pour ce produit. À la place, nous vous invitons à passer une nouvelle commande pour ce service.";
$_LANG['orderForm']['edit'] = "Modifier";
$_LANG['orderForm']['emailAddress'] = "Adresse e-mail";
$_LANG['orderForm']['enterDomain'] = "Veuillez spécifier votre domaine.";
$_LANG['orderForm']['enterPersonalDetails'] = "Veuillez saisir vos informations personnelles et votre adresse de facturation.";
$_LANG['orderForm']['errorNoGateways'] = "Aucune passerelle de paiement disponible, impossible de traiter la commande.";
...
$_LANG['orderForm']['errorUnavailableGateway'] = "La passerelle sélectionnée n'est pas disponible. Merci de choisir une option dans la section Informations de paiement.";
$_LANG['orderForm']['estimateTaxes'] = "Estimation des taxes";
$_LANG['orderForm']['existingCustomerLogin'] = "Connexion client existante";
$_LANG['orderForm']['exploreNow'] = "Parcourir les offres";
$_LANG['orderForm']['extendExclusions'] = "Sauf certains TLD et renouvellements récents";
$_LANG['orderForm']['findNewDomain'] = "Trouvez votre nouveau nom de domaine. Saisissez votre nom ou des mots clés ci-dessous pour vérifier la disponibilité.";
...
$_LANG['orderForm']['haveQuestionsClickHere'] = "Cliquez ici";
$_LANG['orderForm']['haveQuestionsContact'] = "Vous avez des questions ? Contactez notre équipe commerciale pour obtenir de l'aide.";
...
$_LANG['orderForm']['mediumStrength'] = "Moyennement fort";
$_LANG['orderForm']['optional'] = "Facultatif";
$_LANG['orderForm']['packagesForBudget'] = "Nous avons des offres pour chaque budget";
$_LANG['orderForm']['paymentDetails'] = "Informations de paiement";
$_LANG['orderForm']['personalInformation'] = "Informations personnelles";
$_LANG['orderForm']['phoneNumber'] = "Numéro de téléphone";
$_LANG['orderForm']['postcode'] = "Code postal";
$_LANG['orderForm']['preferredPaymentMethod'] = "Veuillez choisir votre mode de paiement.";
$_LANG['orderForm']['priceCycle'] = "Tarif/Cycle";
$_LANG['orderForm']['productOptions'] = "Produit/Options";
$_LANG['orderForm']['promoCycles'] = "Expire après :cycles périodes de facturation";
$_LANG['orderForm']['promotionAccepted'] = "Code promotionnel accepté ! Le montant total de votre commande a été mis à jour.";
$_LANG['orderForm']['qty'] = "Qté";
$_LANG['orderForm']['registerLongerAndSave'] = "Inscrivez-vous pour une durée plus longue et économisez !";
$_LANG['orderForm']['remove'] = "Retirer";
$_LANG['orderForm']['removeItem'] = "Retirer un article";
$_LANG['orderForm']['removePromotionCode'] = "Retirer le code promo";
$_LANG['orderForm']['required'] = "Obligatoire";
$_LANG['orderForm']['requiredField'] = "(les champs obligatoires sont indiqués par un *)";
$_LANG['orderForm']['returnToClientArea'] = "Revenir à l'espace client";
$_LANG['orderForm']['reviewDomainAndAddons'] = "Veuillez vérifier votre sélection de noms de domaine ainsi que les modules complémentaires disponibles pour chacun.";
...
$_LANG['orderForm']['singleTransfer'] = "Transfert d'un domaine unique";
$_LANG['orderForm']['state'] = "État/Province/Région";
$_LANG['orderForm']['streetAddress'] = "Adresse";
$_LANG['orderForm']['streetAddress2'] = "Adresse 2";
$_LANG['orderForm']['submitTicket'] = "Soumettre un ticket";
$_LANG['orderForm']['suggestedDomains'] = "Domaines suggérés";
$_LANG['orderForm']['totals'] = "Total";
$_LANG['orderForm']['transfer'] = "Transférer";
$_LANG['orderForm']['transferAlternativelyRegister'] = "Vous pouvez aussi effectuer une recherche pour enregistrer ce domaine.";
$_LANG['orderForm']['transferDomain'] = "Transférer un domaine";
$_LANG['orderForm']['transferEligible'] = "Votre domaine est éligible au transfert.";
$_LANG['orderForm']['transferExistingDomain'] = "Transférez vos noms de domaines chez nous et économisez.";
$_LANG['orderForm']['transferExtend'] = "Transférez dès maintenant pour prolonger votre domaine d'un an !";
...
$_LANG['orderPromoCodePlaceholder'] = "Saisissez le code promo si vous en avez un.";
$_LANG['orderadditionalrequiredinfo'] = "Autres informations";
$_LANG['orderaddon'] = "Module complémentaire";
$_LANG['orderaddondescription'] = "Les modules complémentaires suivants sont disponibles pour ce service/produit. Choisissez ci-dessous les modules complémentaires souhaités.";
$_LANG['orderavailable'] = "Disponible";
$_LANG['orderavailableaddons'] = "Cliquez pour afficher les modules complémentaires disponibles.";
$_LANG['orderbillingcycle'] = "Cycle de facturation";
$_LANG['ordercategories'] = "Catégories";
$_LANG['orderchangeaddons'] = "Modifier les modules complémentaires";
$_LANG['orderchangeconfig'] = "Modifier les options configurables";
$_LANG['orderchangedomain'] = "Modifier un nom de domaine";
$_LANG['orderchangenameservers'] = "Modifier les serveurs de noms seulement";
$_LANG['orderchangeproduct'] = "Modifier un produit";
$_LANG['ordercheckout'] = "Terminer";
$_LANG['orderchooseaddons'] = "Choisir des modules complémentaires pour le produit";
$_LANG['orderchooseapackage'] = "Choisir une offre";
$_LANG['ordercodenotfound'] = "Le code promotionnel saisi n'existe pas.";
$_LANG['ordercompletebutnotpaid'] = "Attention ! Votre commande a été terminée mais n'est pas payée. Votre compte ne sera pas activé. <br />Cliquez sur le lien ci-dessous pour effectuer votre paiement.";
...
$_LANG['orderdomainoption2'] = "Je vais mettre à jour mes serveurs de noms sur un domaine existant ou enregistrer un nouveau domaine.";
...
$_LANG['orderdomainregistration'] = "Enregistrement de domaine";
$_LANG['orderdomainregonly'] = "Enregistrement de domaine";
$_LANG['orderdomaintransfer'] = "Transfert de domaine";
...
$_LANG['ordererrordomainalreadyexists'] = "Le nom de domaine que vous avez saisi est déjà enregistré chez nous. Vous devez l'annuler avant de poursuivre votre commande.";
$_LANG['ordererrordomaininvalid'] = "Le nom de domaine saisi n'est pas valide.";
$_LANG['ordererrordomainnotld'] = "Vous devez indiquer le TLD du domaine.";
$_LANG['ordererrordomainnotregistered'] = "Vous ne pouvez pas transférer un nom de domaine non enregistré.";
$_LANG['ordererrordomainregistered'] = "Le nom de domaine saisi est déjà enregistré.";
$_LANG['ordererrornameserver1'] = "Vous devez saisir le nom du serveur de noms 1.";
$_LANG['ordererrornameserver2'] = "Vous devez saisir le nom du serveur de noms 2.";
$_LANG['ordererrornodomain'] = "Vous devez saisir un nom de domaine.";
$_LANG['ordererrorpassword'] = "Vous n'avez pas saisi de mot de passe.";
$_LANG['ordererrorsbudomainbanned'] = "Le préfixe de sous-domaine que vous avez saisi n'est pas accepté, veuillez en essayer un autre.";
$_LANG['ordererrorserverhostnameinuse'] = "Le nom d'hôte que vous avez saisi est déjà utilisé. Veuillez en choisir un autre.";
$_LANG['ordererrorservernohostname'] = "Vous devez saisir le nom d'hôte de votre serveur.";
$_LANG['ordererrorservernonameservers'] = "Vous devez saisir le préfixe des deux serveurs de noms.";
$_LANG['ordererrorservernorootpw'] = "Vous devez saisir le mot de passe racine (root) souhaité.";
$_LANG['ordererrorsoccurred'] = "Les erreurs suivantes se sont produites et doivent être corrigées avant de poursuivre :";
$_LANG['ordererrorsubdomaintaken'] = "Le sous-domaine que vous avez inscrit est déjà utilisé. Veuillez essayer un autre nom.";
...
$_LANG['ordererrortransfersecret'] = "Vous devez saisir le code de transfert secret.";
$_LANG['ordererroruserexists'] = "Un utilisateur avec cette adresse e-mail existe déjà.";
...
$_LANG['orderhosting'] = "Commander l'hébergement";
...
$_LANG['orderlogininfopart1'] = "Veuillez saisir le mot de passe que vous souhaitez utiliser pour vous connecter à votre";
$_LANG['orderlogininfopart2'] = "Espace client : le mot de passe et le nom d'utilisateur sont différents de ceux du panneau de contrôle de votre site Web.";
$_LANG['ordernewuser'] = "Je suis un nouveau client et je veux créer un compte.";
$_LANG['ordernoproducts'] = "Aucun produit trouvé";
$_LANG['ordernotes'] = "Notes / Autres infos";
$_LANG['ordernotesdescription'] = "Saisissez ici vos notes supplémentaires ou les informations nécessaires au traitement de votre commande.";
$_LANG['ordernowbutton'] = "Commander";
$_LANG['ordernumberis'] = "Votre numéro de commande :";
...
$_LANG['orderpaymentterm36month'] = "Tarif 36 mois";
...
$_LANG['orderpaymenttermadjectivemonthly'] = "Mensuel";
$_LANG['orderpaymenttermadjectiveonetime'] = "Une fois";
$_LANG['orderpaymenttermadjectivequarterly'] = "Trimestriel";
...
$_LANG['orderpaymenttermbiennially'] = "Tous les deux ans";
...
$_LANG['orderpaymenttermtriennially'] = "Tous les trois ans";
$_LANG['orderprice'] = "Tarif";
$_LANG['orderproduct'] = "Produit/Service";
$_LANG['orderprogress'] = "Progression";
$_LANG['orderpromoexpired'] = "Le code promotionnel saisi a expiré.";
$_LANG['orderpromofreesetup'] = "Installation gratuite";
$_LANG['orderpromoinvalid'] = "Le code promotionnel saisi ne s'applique à aucun article de votre commande.";
$_LANG['orderpromomaxusesreached'] = "Le code promotionnel saisi a déjà été utilisé.";
$_LANG['orderpromoprestart'] = "Cette promotion n'a pas encore commencé. Veuillez réessayer plus tard.";
$_LANG['orderpromopriceoverride'] = "Prix modifié";
...
$_LANG['orderregperiod'] = "Durée d'inscription";
$_LANG['ordersecure'] = "Ce formulaire est fourni dans un environnement sécurisé. Afin d'éviter les fraudes, votre adresse IP";
$_LANG['ordersecure2'] = "est en cours d'enregistrement.";
...
$_LANG['orderservernameserversdescription'] = "Les préfixes saisis ici détermineront les noms des serveurs par défaut. Exemple : ns1.votredomaine.com et ns2.votredomaine.com.";
$_LANG['orderservernameserversprefix1'] = "Préfixe 1";
$_LANG['orderservernameserversprefix2'] = "Préfixe 2";
$_LANG['orderserverrootpassword'] = "Mot de passe racine (root)";
...
$_LANG['ordertaxstaterequired'] = "Vous devez inscrire le nom de votre état/province/région pour que le calcul des taxes s'effectue correctement.";
...
$_LANG['ourlatestnews'] = "Nos dernières actualités";
...
$_LANG['outofstockdescription'] = "Cet article est actuellement en rupture de stock et a donc été suspendu jusqu'à ce que de nouveaux stocks soient disponibles. Pour plus d'informations, n'hésitez pas à nous contacter.";
...
$_LANG['overdueInvoiceAlert'] = "Vous avez une facture non payée.";
$_LANG['overdueinvoicesdesc'] = "Pour éviter une interruption de service, merci de payer vos factures en suspens dès que possible. %sPayer maintenant &raquo;%s";
$_LANG['overview'] = "Vue d'ensemble";
$_LANG['ox']['accessSuite'] = "Portail de connexion OX App Suite";
$_LANG['ox']['accountCount'] = "Vous avez créé <span class=\"number\">:number</span> sur <span class=\"limit\">:limit</span> comptes disponibles.";
$_LANG['ox']['accountCreated'] = "Le compte a bien été créé.";
$_LANG['ox']['accountDeleted'] = "Le compte a bien été supprimé.";
$_LANG['ox']['accountModified'] = "Le compte a bien été modifié.";
...
$_LANG['ox']['deleteAccountQuestion'] = "Voulez-vous vraiment supprimer ce compte ?";
...
$_LANG['ox']['emailAccounts'] = "Comptes courriel";
...
$_LANG['ox']['passwordRequired'] = "Le mot de passe est un champ obligatoire.";
...
$_LANG['ox']['required']['lastName'] = "Le nom est un champ obligatoire.";
...
$_LANG['ox']['settings']['email'] = "Saisissez l'adresse électronique complète : nom d'utilisateur@:domain";
$_LANG['ox']['settings']['incoming'] = "Serveur entrant (IMAP)";
$_LANG['ox']['settings']['migrationIntro'] = "Migrez de tous les services de messagerie électronique courants, notamment Apple iCloud, Gmail, Outlook.com/Windows Live/Hotmail, Yahoo Mail, GMX ou T-Online, ou saisissez manuellement les informations de votre fournisseur en utilisant les protocoles IMAP/POP3 ou un autre protocole disponible.";
$_LANG['ox']['settings']['migrationLaunch'] = "Démarrer l'outil de migration";
$_LANG['ox']['settings']['migrationTitle'] = "Outil de migration";
$_LANG['ox']['settings']['outgoing'] = "Serveur sortant (SMTP)";
$_LANG['ox']['settings']['password'] = "Utilisez le mot de passe du compte de messagerie.";
$_LANG['ox']['settings']['pop'] = "Serveur entrant (POP3)";
$_LANG['ox']['settings']['port'] = "Port : :port";
$_LANG['ox']['settings']['retrieval'] = "Paramètres du client de messagerie";
...
$_LANG['packageDomain'] = "Offre/Domaine";
$_LANG['page'] = "Page";
$_LANG['pageof'] = "sur";
...
$_LANG['paymentMethods']['achMandateAcceptance'] = "En cliquant sur \"Effectuer un paiement\", vous autorisez :companyName à débiter le compte bancaire indiqué ci-dessus de tout montant dû pour les frais liés à votre utilisation des services de :companyName et/ou pour l'achat de produits auprès de :companyName, conformément au site Web et aux conditions d'utilisation de :companyName, jusqu'à ce que cette autorisation soit révoquée. Vous pouvez modifier ou annuler cette autorisation à tout moment en envoyant un préavis de 30 (trente) jours à :companyName. Si vous utilisez les services :companyName ou si vous achetez des produits supplémentaires périodiquement conformément aux conditions de :companyName, vous autorisez :companyName à débiter périodiquement votre compte bancaire. Les paiements qui ne figurent pas dans les débits habituels autorisés ci-dessus ne seront débités qu'après l'obtention de votre autorisation.";
...
$_LANG['paymentMethods']['addNewCC'] = "Ajouter une nouvelle carte bancaire";
$_LANG['paymentMethods']['addedSuccess'] = "Le mode de paiement a bien été ajouté.";
$_LANG['paymentMethods']['areYouSure'] = "Voulez-vous vraiment poursuivre ?";
...
$_LANG['paymentMethods']['defaultUpdateSuccess'] = "Le mode de paiement par défaut a bien été mis à jour.";
...
$_LANG['paymentMethods']['deleteSuccess'] = "Le mode de paiement a bien été supprimé.";
$_LANG['paymentMethods']['description'] = "Descriptif";
$_LANG['paymentMethods']['descriptionInput'] = "Veuillez saisir un nom pour cette carte.";
$_LANG['paymentMethods']['edit'] = "Modifier";
$_LANG['paymentMethods']['fieldRequired'] = "Ce champ est obligatoire.";
...
$_LANG['paymentMethods']['title'] = "Modes de paiement";
$_LANG['paymentMethods']['type'] = "Tapez";
$_LANG['paymentMethods']['updateSuccess'] = "Le mode de paiement a bien été mis à jour.";
...
$_LANG['paymentMethodsManage']['accountNumberNotValid'] = "Le numéro de compte bancaire que vous avez saisi ne semble pas être valide.";
...
$_LANG['paymentMethodsManage']['addPaymentMethod'] = "Ajouter un nouveau mode de paiement";
$_LANG['paymentMethodsManage']['bankAccount'] = "Compte bancaire";
$_LANG['paymentMethodsManage']['bankName'] = "Nom de la banque";
$_LANG['paymentMethodsManage']['cardNumberNotValid'] = "Le numéro de carte que vous avez saisi ne semble pas être valide.";
$_LANG['paymentMethodsManage']['checking'] = "Compte courant";
$_LANG['paymentMethodsManage']['creditCard'] = "Carte bancaire";
...
$_LANG['paymentMethodsManage']['expiryDateNotValid'] = "La date d'expiration que vous avez saisie ne semble pas être valide.";
$_LANG['paymentMethodsManage']['invalidCardDetails'] = "Le numéro de carte que vous avez saisi n'est pas valide. Veuillez réessayer.";
$_LANG['paymentMethodsManage']['optional'] = "(Facultatif)";
$_LANG['paymentMethodsManage']['routingNumberNotValid'] = "Le numéro d'acheminement bancaire que vous avez saisi ne semble pas être valide.";
$_LANG['paymentMethodsManage']['savings'] = "Épargne";
$_LANG['paymentMethodsManage']['sortCodeRoutingNumber'] = "Code de tri / Numéro d'acheminement bancaire";
...
$_LANG['paymentmethoddefault'] = "Utiliser la valeur par défaut (définie par commande)";
...
$_LANG['paypalEmailAddress'] = "Adresse e-mail PayPal";
$_LANG['perYear'] = "par an";
$_LANG['permissions']['descriptions']['affiliates'] = "Accès pour afficher et demander des retraits";
$_LANG['permissions']['descriptions']['contacts'] = "Accéder aux contacts et les gérer";
...
$_LANG['permissions']['descriptions']['invoices'] = "Consulter les factures et accéder au paiement des factures";
...
$_LANG['permissions']['descriptions']['orders'] = "Autoriser les nouvelles commandes";
...
$_LANG['permissions']['descriptions']['profile'] = "Accéder aux informations de profil client et les modifier";
...
$_LANG['please'] = "SVP";
$_LANG['pleasechooseone'] = "Veuillez en choisir un…";
$_LANG['pleaserate2'] = "a traité cette demande d'assistance";
...
$_LANG['plesklogin'] = "Se connecter à Plesk";
$_LANG['poweroffforced'] = "Éteindre (Forcé)";
$_LANG['poweron'] = "Allumer";
$_LANG['powerreboot'] = "Redémarrer";
$_LANG['powershutdown'] = "Arrêter";
$_LANG['premium'] = "Prime";
$_LANG['presalescontactdescription'] = "Pour toute demande de renseignements avant la vente, cliquez ici";
...
$_LANG['priceStandard'] = "Renouvellement annuel, à :renewalPrice, plus taxes.";
...
$_LANG['pricing']['transfer'] = "Transférer";
...
$_LANG['primaryIP'] = "IP principale";
$_LANG['print'] = "Imprimer";
$_LANG['problemgoback'] = "Revenir et réessayer";
$_LANG['processing'] = "En cours de traitement…";
...
$_LANG['proformainvoicenumber'] = "Facture pro forma nᵒ ";
$_LANG['projectManagement']['activeProjects'] = "Vos projets actifs";
$_LANG['promoappliedbutnodiscount'] = "Le code promo que vous avez saisi a été appliqué à votre panier. Toutefois, aucun article n'est compatible actuellement. Veuillez vérifier les conditions de l'offre.";
...
$_LANG['pwresetcheckemail'] = "La réinitialisation de votre mot de passe a débuté. Merci de consulter vos e-mails afin de poursuivre la procédure.";
$_LANG['pwresetdesc'] = "Vous pouvez réinitialiser votre mot de passe si vous l'avez oublié. Une fois votre adresse e-mail saisie (et après avoir répondu à la question de sécurité si elle est activée), vous allez recevoir par courriel les instructions pour procéder à la réinitialisation de votre mot de passe.";
$_LANG['pwresetemailneeded'] = "Vous avez oublié votre mot de passe ? Veuillez saisir votre adresse e-mail pour initier la réinitialisation.";
$_LANG['pwresetemailnotfound'] = "Aucun compte client ne correspond à l'adresse e-mail saisie";
$_LANG['pwresetemailrequired'] = "Veuillez saisir votre adresse e-mail.";
$_LANG['pwresetenternewpw'] = "Veuillez saisir votre nouveau mot de passe ci-dessous.";
$_LANG['pwresetkeyexpired'] = "Le lien de réinitialisation que vous avez suivi a expiré. Veuillez réessayer.";
...
$_LANG['pwresetsecurityquestionrequired'] = "Vous avez une question de sécurité validée dans votre profil, vous devez donc saisir sa réponse ci-dessous.";
...
$_LANG['pwstrengthenter'] = "Saisissez un mot de passe";
...
$_LANG['quote'] = "Devis";
$_LANG['quoteacceptagreetos'] = "Veuillez accepter les Conditions d'utilisation.";
$_LANG['quoteacceptancehowto'] = "Pour accepter le devis, veuillez confirmer que vous acceptez nos conditions de service disponibles sous @";
$_LANG['quoteacceptancetitle'] = "Approbation du devis";
$_LANG['quoteacceptancewarning'] = "En acceptant ce devis, vous vous engagez à contracter le produit. Ce contrat ne peut être annulé.";
...
$_LANG['quotelineitems'] = "Éléments du devis";
$_LANG['quotelinetotal'] = "Total";
$_LANG['quotenumber'] = "Devis nᵒ ";
$_LANG['quoteproposal'] = "Proposition";
$_LANG['quoteqty'] = "Qté";
$_LANG['quoterecipient'] = "Destinataire";
$_LANG['quoteref'] = "Re Devis nᵒ ";
$_LANG['quotes'] = "Devis";
$_LANG['quotesdesc'] = "Voici les devis que nous avons établis pour vous.";
...
$_LANG['quotestagedelivered'] = "Actif";
...
$_LANG['quoteunitprice'] = "Tarif unitaire";
$_LANG['quotevaliduntil'] = "Valide jusqu'au";
$_LANG['quoteview'] = "Afficher";
$_LANG['readmore'] = "En savoir plus";
$_LANG['readyforquestions'] = "Nous attendons vos questions !";
$_LANG['recaptcha-incorrect-captcha-sol'] = "Les caractères saisis ne correspondent pas à la vérification des mots. Veuillez réessayer.";
$_LANG['recaptcha-invalid-request-cookie'] = "Une erreur s'est produite. Veuillez réessayer. (code d'erreur : CAP2)";
$_LANG['recaptcha-invalid-site-private-key'] = "Une erreur s'est produite, veuillez contacter l'assistance (code d'erreur : cap1).";
...
$_LANG['recurringpromodesc'] = "Ce code de promotion comprend aussi une remise récurrente de %s<br />(Cette réduction s'appliquera au tarif total des futurs renouvellements du produit)";
...
$_LANG['registerCreateAccountOrder'] = "passer une commande";
$_LANG['registerdisablednotice'] = "Pour vous inscrire, merci de <strong><a href=\"cart.php\">passer une commande</a></strong>.";
$_LANG['registerdomain'] = "Enregistrer un nom de domaine";
$_LANG['registerdomaindesc'] = "Saisissez le nom de domaine dont vous voulez vérifier la disponibilité.";
...
$_LANG['registersecurityquestionblurb'] = "Les questions de sécurité permettent de renforcer la sécurité de votre compte. Elles seront posées lors de chaque modification de votre compte.";
$_LANG['relatedservice'] = "Service associé";
$_LANG['reloadexpiredsession'] = "Votre session a expiré. Veuillez recharger la page et réessayer.";
$_LANG['remoteAuthn']['accountNowLinked'] = "Votre compte est maintenant associé à votre compte :displayName.";
...
$_LANG['remoteAuthn']['areYouSure'] = "Voulez-vous vraiment poursuivre ?";
...
$_LANG['remoteAuthn']['completeSignIn'] = "Sélectionnez un fournisseur d'accès pour finaliser la connexion.";
...
$_LANG['remoteAuthn']['connectWith'] = "Se connecter avec :provider";
$_LANG['remoteAuthn']['emailAddress'] = "Adresse e-mail";
...
$_LANG['remoteAuthn']['noLinkedAccounts'] = "Aucun compte associé trouvé";
$_LANG['remoteAuthn']['oneTimeAuthRequired'] = "Veuillez vous connecter pour associer ce service à votre compte existant. Vous n'aurez à le faire qu'une seule fois.";
$_LANG['remoteAuthn']['provider'] = "Fournisseur";
$_LANG['remoteAuthn']['redirecting'] = "La connexion automatique est effectuée ! Redirection…";
...
$_LANG['remoteAuthn']['signInWith'] = "Se connecter avec :provider";
$_LANG['remoteAuthn']['signUpWith'] = "S'inscrire avec :provider";
$_LANG['remoteAuthn']['success'] = "Authentification réussie !";
$_LANG['remoteAuthn']['titleLinkedAccounts'] = "Comptes associés";
$_LANG['remoteAuthn']['titleOr'] = "Ou";
$_LANG['remoteAuthn']['titleSignUpVerb'] = "S'inscrire";
...
$_LANG['remoteTransError'] = "Échec de la transaction à distance. Veuillez contacter l'assistance.";
...
$_LANG['renewService']['titleAltSingular'] = "Renouveler le service";
$_LANG['renewService']['titlePlural'] = "Renouvellement des services";
$_LANG['renewService']['titleSingular'] = "Renouveler le service";
...
$_LANG['requiredFields'] = "Les champs obligatoires sont indiqués par un *";
$_LANG['resendEmail'] = "Renvoyer l'e-mail de vérification";
$_LANG['resourceUsage'] = "Utilisation des ressources";
$_LANG['restricted'] = "Restreint";
...
$_LANG['searchResults'] = "Résultats de la recherche";
$_LANG['searchenterdomain'] = "Saisissez le domaine à rechercher";
$_LANG['searchfilter'] = "Filtrer";
$_LANG['searchmultipletlds'] = "Rechercher plusieurs TLD";
$_LANG['searchtermrequired'] = "Vous devez saisir un nom de domaine ou un mot-clé pour lancer la recherche";
...
$_LANG['securityanswerrequired'] = "Vous devez saisir une réponse pour la question de sécurité.";
$_LANG['securitybothnotmatch'] = "Votre réponse et la confirmation ne correspondent pas.";
$_LANG['securitycurrentincorrect'] = "Votre question et la réponse sont incorrectes.";
...
$_LANG['serverchangepasswordconfirm'] = "Confirmer le mot de passe";
$_LANG['serverchangepasswordenter'] = "Saisissez le nouveau mot de passe";
...
$_LANG['serverchangepasswordsuccessful'] = "Le mot de passe a bien été modifié !";
...
$_LANG['servername'] = "Nom du serveur";
...
$_LANG['serverstatusdescription'] = "Consultez en temps réel l'état de nos serveurs";
$_LANG['serverstatusheadingtext'] = "Le tableau ci-dessous affiche l'état de nos serveurs en temps réel. Vous pouvez consulter cette page pour vérifier l'état des services disponibles sur le serveur.";
...
$_LANG['serverstatusphpinfo'] = "Infos PHP";
...
$_LANG['servicesRenew'] = "Renouveler";
...
$_LANG['sidebars']['viewAccount']['billingInformation'] = "Informations de facturation";
$_LANG['sidebars']['viewAccount']['changePassword'] = "Modifier le mot de passe";
...
$_LANG['siteworxlogin'] = "Se connecter au panneau de contrôle SiteWorx";
...
$_LANG['ssl']['certError3'] = "Si vous continuez à voir ce message, <a href=\"submitticket.php\">contactez l'assistance</a>.";
$_LANG['ssl']['changeApproverEmail'] = "Changer l'adresse e-mail de l'approbateur";
...
$_LANG['ssl']['dnsMethodDescription'] = "L'autorité de certification examinera les enregistrements DNS du domaine à la recherche d'un enregistrement spécifique possédant une valeur unique. Assurez-vous de disposer des autorisations nécessaires pour administrer les paramètres DNS du domaine. Les informations relatives aux enregistrements DNS vous seront fournies une fois la configuration terminée.";
$_LANG['ssl']['dnsRecordInformation'] = "Informations sur l'enregistrement DNS";
$_LANG['ssl']['dnsSteps'] = "L'autorité de certification va maintenant interroger les enregistrements DNS du domaine pour trouver un enregistrement correspondant aux informations ci-dessous. Accédez aux paramètres DNS de votre domaine et créez l'enregistrement. Une fois l'enregistrement trouvé, le certificat sera émis.";
$_LANG['ssl']['emailInformation'] = "Informations sur l'adresse e-mail";
$_LANG['ssl']['emailMethod'] = "Adresse e-mail";
$_LANG['ssl']['emailMethodDescription'] = "L'autorité de certification effectuera la validation en envoyant un e-mail contenant des instructions supplémentaires à l'adresse que vous choisirez ci-dessous.";
$_LANG['ssl']['emailSteps'] = "L'autorité de certification vous enverra des instructions supplémentaires à l'adresse e-mail que vous avez indiquée afin de valider la propriété du domaine. Une fois ces étapes terminées, le certificat sera émis.";
$_LANG['ssl']['fileInformation'] = "Informations sur le fichier";
$_LANG['ssl']['fileMethod'] = "Fichier HTTP";
$_LANG['ssl']['fileMethodDescription'] = "L'autorité de certification va effectuer une requête HTTP vers un chemin hébergé dans le domaine et s'attendra à ce que la réponse contienne une valeur unique. Le chemin et la valeur seront fournis une fois que vous aurez terminé le processus de configuration.";
$_LANG['ssl']['fileSteps'] = "L'autorité de certification va maintenant envoyer des requêtes à l'URL ci-dessous pour valider si la réponse correspond à la valeur fournie. Lorsqu'une réponse avec la valeur spécifiée est détectée, le certificat est émis.";
...
$_LANG['ssl']['x500DN']['state'] = "État/Province/Région";
...
$_LANG['sslconfigure'] = "Configuration";
...
$_LANG['sslerrorapproveremail'] = "Vous devez saisir l'adresse e-mail du responsable de ce certificat.";
...
$_LANG['sslinvalidlink'] = "Lien non valide. Veuillez retourner à l'étape précédente et réessayer.";
...
$_LANG['sslserverinfodetails'] = "Utilisez le logiciel de votre serveur pour générer une demande de signature de certificat (CSR) incluant le domaine pour lequel le certificat doit être émis. Sélectionnez le serveur le plus proche dans la liste afin de recevoir un certificat au format compatible avec votre serveur.";
...
$_LANG['sso']['summary'] = "Des applications tierces utilisent la fonctionnalité de connexion unique pour vous fournir un accès direct à votre compte de facturation sans avoir à vous réauthentifier.";
...
$_LANG['state'] = "État/Province/Région";
...
$_LANG['store']['addToExistingPackage'] = "pour ajouter ceci à une offre d'hébergement existante.";
...
$_LANG['store']['addon']['notFound']['productUnavailableText'] = "Ce produit n'est pas disponible actuellement.<br>Veuillez nous contacter si vous pensez qu'il s'agit d'une erreur.";
...
$_LANG['store']['addon']['wptk']['smartUpdates']['featureBody1'] = "Smart Updates clone et met à jour une copie du site web en ligne, puis compare les deux versions afin de déterminer si l'application de mises à jour risque d'affecter ou non le site.";
...
$_LANG['store']['addon']['wptk']['smartUpdates']['featureTitle1'] = "Fonctionnement";
...
$_LANG['store']['chooseDomain'] = "Choisir un domaine";
$_LANG['store']['chooseExistingDomain'] = "Choisissez un domaine existant";
$_LANG['store']['choosePaymentTerm'] = "Choisissez les modalités de paiement";
$_LANG['store']['codeGuard']['adminPreview'] = "Les forfaits CodeGuard que vous activez seront affichés ici";
$_LANG['store']['codeGuard']['changeAlerts'] = "Surveillance et alertes de modifications de fichiers";
$_LANG['store']['codeGuard']['chooseBackupPlan'] = "Choisissez l'espace de stockage pour les sauvegardes";
...
$_LANG['store']['codeGuard']['faq']['a3'] = "CodeGuard effectue quotidiennement des clichés instantanés automatisés de votre site Web. À l'aide de ces clichés instantanés, vous pouvez restaurer à tout moment votre site entier ou un fichier spécifique vers une version antérieure.";
...
$_LANG['store']['codeGuard']['faq']['q3'] = "Fonctionnement";
...
$_LANG['store']['codeGuard']['faq']['q6'] = "Les sauvegardes sont-elles chiffrées ?";
...
$_LANG['store']['codeGuard']['features']['email'] = "Sauvegarde de la messagerie";
$_LANG['store']['codeGuard']['features']['emailDescription'] = "Protégez également votre messagerie : les messages sont sauvegardés dans les fichiers de votre site Web.";
$_LANG['store']['codeGuard']['features']['fileMonitoring'] = "Surveillance des modifications de fichiers";
$_LANG['store']['codeGuard']['features']['fileMonitoringDescription'] = "Recevez une notification par courrier électronique à chaque modification du code source de votre site.";
...
$_LANG['store']['codeGuard']['features']['unlimitedFilesDescription'] = "Sauvegardez un nombre illimité de fichiers et de bases de données : seul l'espace de stockage que vous utilisez est limité.";
$_LANG['store']['codeGuard']['features']['wp'] = "Mises à jour automatiques de WordPress";
$_LANG['store']['codeGuard']['features']['wpDescription'] = "Mettez automatiquement à jour WordPress et ses extensions pour préserver sa sécurité avec la récupération automatique en cas de problème.";
...
$_LANG['store']['codeGuard']['tab']['pricing'] = "Tarif";
...
$_LANG['store']['codeGuard']['timeMachine'] = "Historique de site Web";
$_LANG['store']['codeGuard']['title'] = "Sauvegarde CodeGuard";
$_LANG['store']['codeGuard']['wpPlugin'] = "Mises à jour des extensions WordPress";
...
$_LANG['store']['codeguard']['cartTitle'] = "Sauvegarde de sites Web CodeGuard";
...
$_LANG['store']['collaborate'] = "Collaborer";
...
$_LANG['store']['emailServices']['archiving']['title'] = "Archivage du courrier électronique";
$_LANG['store']['emailServices']['benefits']['archiving']['1'] = "Filtrage des messages entrants et sortants inclut !";
$_LANG['store']['emailServices']['benefits']['archiving']['2'] = "Plus aucun message égaré";
$_LANG['store']['emailServices']['benefits']['archiving']['3'] = "Respect de la conformité avec les législations en vigueur";
$_LANG['store']['emailServices']['benefits']['archiving']['4'] = "Amélioration des performances du système informatique";
$_LANG['store']['emailServices']['benefits']['archiving']['5'] = "Gestion facile de la protection des données";
$_LANG['store']['emailServices']['benefits']['archiving']['6'] = "Augmentation de la disponibilité des courriels, prise en charge de la journalisation et de redistribution facile";
$_LANG['store']['emailServices']['benefits']['archiving']['7'] = "Archive compressée, chiffrée et sécurisée";
$_LANG['store']['emailServices']['benefits']['archiving']['a1'] = "L'archivage des e-mails préserve et protège tous les e-mails entrants et sortants pour un accès ultérieur. C'est un excellent moyen de récupérer des e-mails perdus ou supprimés accidentellement, d'accélérer les réponses aux audits, de sécuriser les e-mails et les pièces jointes contenant des informations confidentielles et de faciliter la recherche de preuves électroniques en cas de litige.";
...
$_LANG['store']['emailServices']['benefits']['archiving']['a2b'] = "Dans le même temps, étant donné que les échanges d'e-mails ont un pouvoir judiciaire et sont juridiquement contraignants, la conformité des e-mails est devenue une préoccupation extrêmement importante pour les organisations. Par conséquent, il est obligatoire dans certains secteurs de conserver une sauvegarde sécurisée de tous les messages électroniques et d'être conforme avec la législation en vigueur.";
$_LANG['store']['emailServices']['benefits']['archiving']['q1'] = "Archivage du courrier électronique";
$_LANG['store']['emailServices']['benefits']['archiving']['q2'] = "Vos avantages";
$_LANG['store']['emailServices']['benefits']['archiving']['title'] = "Voici les avantages de l'archivage du courrier électronique…";
$_LANG['store']['emailServices']['benefits']['incoming']['1'] = "Protection complète de la boîte de réception à des tarifs compétitifs";
...
$_LANG['store']['emailServices']['benefits']['incoming']['4'] = "Service sans interruption et redondance des e-mails entrants";
$_LANG['store']['emailServices']['benefits']['incoming']['5'] = "Diverses options de rapport";
$_LANG['store']['emailServices']['benefits']['incoming']['6'] = "Contrôle total grâce à l'interface conviviale";
$_LANG['store']['emailServices']['benefits']['incoming']['7'] = "Augmentation de la productivité des employés";
$_LANG['store']['emailServices']['benefits']['incoming']['8'] = "Compatibilité avec n'importe quel serveur de messagerie";
$_LANG['store']['emailServices']['benefits']['incoming']['a1'] = "Le filtrage des e-mails entrants filtre tous les e-mails entrants. Son objectif : éliminer le spam et les virus avant que ces menaces n'atteignent votre réseau avec un taux de précision de près de 100 %. Le panneau de commande complet vous permet de garder le contrôle total. Par ailleurs, si votre serveur de messagerie est en panne, votre e-mail sera mis en file d'attente. Les e-mails en file d'attente peuvent être consultés, lus et traités via l'interface Web, d'où un service sans interruption pour vos e-mails entrants !";
...
$_LANG['store']['emailServices']['benefits']['incoming']['a3'] = "Une fois que votre domaine est (automatiquement) déployé sur le filtre entrant et que le filtrage est activé, le courrier électronique passera par le cloud de filtrage SpamExperts. Les e-mails entrants sont analysés et scannés en temps réel en toute sécurité. Aucune formation ou configuration n'est requise, car tout est disponible immédiatement. Tout message détecté comme spam est placé en quarantaine, tandis que les messages sans spam sont envoyés à votre serveur de messagerie. Vous pouvez surveiller les messages placés en quarantaine, depuis l'interface conviviale SpamPanel, via des rapports par e-mail ou encore directement depuis votre client de messagerie ! Plus de temps perdu à gérer le spam, concentrez simplement votre énergie sur les tâches commerciales, tout en gardant le contrôle total.";
...
$_LANG['store']['emailServices']['benefits']['incoming']['q3'] = "Fonctionnement";
$_LANG['store']['emailServices']['benefits']['incoming']['title'] = "Voici les avantages du filtrage des e-mails entrants…";
$_LANG['store']['emailServices']['benefits']['outgoing']['1'] = "Plus de liste noire";
$_LANG['store']['emailServices']['benefits']['outgoing']['2'] = "Protection de la réputation de votre marque et de vos systèmes informatiques";
$_LANG['store']['emailServices']['benefits']['outgoing']['3'] = "Aucuns coûts liés à la radiation";
$_LANG['store']['emailServices']['benefits']['outgoing']['4'] = "Optimisation de la remise des e-mails et disponibilité continue du service";
$_LANG['store']['emailServices']['benefits']['outgoing']['5'] = "Amélioration de la productivité des employés";
$_LANG['store']['emailServices']['benefits']['outgoing']['6'] = "Amélioration de la gestion des abus";
...
$_LANG['store']['emailServices']['benefits']['outgoing']['q2'] = "Vos avantages";
$_LANG['store']['emailServices']['benefits']['outgoing']['title'] = "Voici les avantages du filtrage des e-mails sortants…";
...
$_LANG['store']['emailServices']['faqs']['a1'] = "Les e-mails sont acheminés via des serveurs d'autoapprentissage intelligents SpamExperts qui détectent et bloquent le spam avant qu'il n'atteigne votre boîte de réception.";
$_LANG['store']['emailServices']['faqs']['a2'] = "Comme nous traitons des millions d'e-mails chaque jour, nos filtres de messageries obtiennent un taux de précision proche de 100 %, à la pointe du secteur.";
$_LANG['store']['emailServices']['faqs']['a3'] = "Oui, un panneau de contrôle complet avec recherche dans les journaux, mise en quarantaine et de nombreux autres outils vous permet de vérifier le statut de tout e-mail qui est passé par le système.";
$_LANG['store']['emailServices']['faqs']['a4'] = "La configuration est rapide et automatisée. Elle sera opérationnelle et protégera votre courrier électronique en quelques minutes.";
$_LANG['store']['emailServices']['faqs']['a5'] = "De nos jours, le courrier électronique est incontournable. L'archivage est une solution pour stocker en toute sécurité vos messages.";
$_LANG['store']['emailServices']['faqs']['a6'] = "L'archivage des e-mails comprend 10 Go de stockage d'e-mails compressés par défaut. Si vous avez besoin de plus de stockage, vous pouvez ajouter des licences supplémentaires de 10 Go.";
$_LANG['store']['emailServices']['faqs']['q1'] = "Fonctionnement";
...
$_LANG['store']['emailServices']['headline'] = "La sécurité de votre messagerie, conçue pour vous";
$_LANG['store']['emailServices']['incoming']['title'] = "Filtrage des e-mails entrants";
$_LANG['store']['emailServices']['manageService'] = "Se connecter au panneau de configuration SpamExperts";
...
$_LANG['store']['emailServices']['signup']['additional'] = "Autres options";
$_LANG['store']['emailServices']['signup']['choose'] = "Choisir un produit";
$_LANG['store']['emailServices']['signup']['none'] = "Aucune option disponible";
$_LANG['store']['emailServices']['signup']['order'] = "Commander";
$_LANG['store']['emailServices']['signup']['title'] = "S'inscrire et commencer";
$_LANG['store']['emailServices']['tab']['faq'] = "FAQ";
$_LANG['store']['emailServices']['tab']['howitworks'] = "Fonctionnement";
$_LANG['store']['emailServices']['tab']['overview'] = "Vue d'ensemble";
$_LANG['store']['emailServices']['tab']['pricing'] = "Tarification";
$_LANG['store']['emailServices']['tagline'] = "Récupérez le contrôle de votre boîte de réception";
$_LANG['store']['emailServices']['title'] = "Services de courrier électronique";
$_LANG['store']['engage'] = "Engager";
...
$_LANG['store']['forJust'] = "pour seulement";
...
$_LANG['store']['marketgoo']['faqs']['a2'] = "Marketgoo est un outil DIY. Nous vous aidons à analyser votre site et vous donnons des recommandations ainsi que des tâches et des instructions pour optimiser votre site : toutefois, nous n'effectuons pas ces changements pour vous.";
$_LANG['store']['marketgoo']['faqs']['a3'] = "Vous travaillez sur votre référencement afin d'améliorer le classement de votre site dans les résultats de recherche. Votre objectif : augmenter le trafic et dans l'idéal, convertir ce trafic en clients et en prospects.";
...
$_LANG['store']['marketgoo']['faqs']['q2'] = "L'outil Marketgoo apporte-t-il les modifications recommandées ou dois-je le faire ?";
...
$_LANG['store']['marketgoo']['tab']['features'] = "Caractéristiques et tarif";
$_LANG['store']['marketgoo']['tab']['how'] = "Fonctionnement";
$_LANG['store']['marketgoo']['tab']['testimonials'] = "Avis des autres utilisateurs";
...
$_LANG['store']['marketgoo']['title'] = "Outils Marketgoo SEO";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "À chaque fois que vous téléchargez un fichier, la fonctionnalité Threat Protection Pro ™ inspecte ce fichier à la recherche de logiciels malveillants.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "La fonctionnalité Threat Protection Pro ™ bloque les publicités intrusives et les traqueurs web, analyse automatiquement les URL et bloque les URL malveillantes.";
...
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "La fonctionnalité :tagOpenThreat Protection Pro ™:tagClose de NordVPN change la donne en offrant encore plus d'avantages de sécurité et une meilleure protection en un seul clic supplémentaire.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Plus qu'un simple VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Même si vous n'avez rien à cacher, vous n'aimez probablement pas l'idée d'être surveillé et suivi.Les internautes choisissent les services VPN notamment pour la confidentialité en ligne et la sécurité générale.:tagBreakVoici pourquoi :";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Cela empêche les tiers, comme les fournisseurs de services Internet, de voir et de suivre vos activités en ligne quotidiennes.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Les publicités en ligne sont généralement ennuyeuses et distrayantes. Elles occupent une large place sur les sites Web, ralentissent la vitesse de connexion et peuvent être malveillantes.";
...
$_LANG['store']['ox']['faq1']['answer'] = "Tous les forfaits OX App Suite incluent l'accès à la messagerie Web, au calendrier, aux tâches et au carnet d'adresses. Le package Productivity inclut en supplément des documents OX Drive et OX (texte, feuilles de calcul et présentations).";
$_LANG['store']['ox']['faq1']['question'] = "Quelles applications sont incluses dans OX App Suite ?";
$_LANG['store']['ox']['faq2']['answer'] = "Oui, OX App Suite prend en charge la connexion de tous les comptes courriel IMAP externes, y compris les fournisseurs populaires tels que Gmail, Yahoo et Outlook.com. Ajoutez simplement votre adresse e-mail et votre mot de passe dans App Suite et tout e-mail envoyé à ces comptes s'affichera dans votre interface App Suite.";
...
$_LANG['store']['ox']['faq4']['question'] = "L'application OX App Suite fonctionnera-t-elle sur mon appareil ?";
$_LANG['store']['ox']['faq5']['answer'] = "Oui ! OX App Suite utilise une technologie propriétaire ainsi que des partenariats avec des fournisseurs bien établis dans le secteur de l'antispam pour préserver au mieux la sécurité de votre boîte de réception et vous épargner les pourriels.";
$_LANG['store']['ox']['faq5']['question'] = "L'application OX App Suite protège-t-elle contre le spam et les virus ?";
...
$_LANG['store']['ox']['faq8']['answer'] = "L'application OX App Suite prend en charge les langues suivantes : anglais, allemand, espagnol, français, italien, néerlandais, polonais, 中文 简体, 中文 繁體, 日本語";
...
$_LANG['store']['ox']['feature1']['detail'] = "Stockez et partagez vos documents importants en toute sécurité dans le cloud. Et avec (jusqu'à) 50 Go, vous disposez de beaucoup d'espace pour les années à venir.";
...
$_LANG['store']['ox']['feature3']['detail'] = "Vos fonctionnalités de messagerie préférées sont toutes disponibles, y compris les redirecteurs, les alias, les répondeurs automatiques, les filtres, les signatures, les notifications et bien plus encore !";
...
$_LANG['store']['ox']['feature6']['detail'] = "Ni App Suite, ni nous-mêmes, ne lirons, ne numériserons ni ne partagerons vos informations personnelles ni les informations communiquées par voie électronique avec des tiers. Jamais.";
$_LANG['store']['ox']['feature6']['title'] = "Le respect de la vie privée est essentiel";
$_LANG['store']['ox']['featuresHeadline'] = "Fonctionnalités";
$_LANG['store']['ox']['manage'] = "Gérer les comptes courriel";
...
$_LANG['store']['ox']['promo']['sidebar']['body'] = "Messagerie fiable et abordable pour votre petite entreprise";
...
$_LANG['store']['ox']['standout']['feature1']['bullet1'] = "email@votre-domaine.com";
...
$_LANG['store']['ox']['standout']['feature1']['title'] = "Une messagerie à la hauteur de vos attentes";
...
$_LANG['store']['ox']['standout']['feature2']['title'] = "Fini le spam !";
...
$_LANG['store']['ox']['standout']['feature3']['title'] = "Travaillez où vous voulez";
...
$_LANG['store']['price'] = "Tarif";
$_LANG['store']['recommendedForYou'] = "Recommandations personnalisées";
$_LANG['store']['sampleProduct'] = "Ceci est un exemple de produit";
$_LANG['store']['save'] = "Économisez :saving %";
$_LANG['store']['schedule'] = "Planifier";
...
$_LANG['store']['siteBuilder']['features']['store']['tagline'] = "Les ventes en ligne peuvent dynamiser vos affaires. Créez un site Web comme un magasin, une boutique ou une enseigne.";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['store']['8'] = "Vous pouvez fournir à vos clients les tarifs des transporteurs en temps réel au moment du paiement. Pour cela, connectez votre boutique en ligne à une ou plusieurs sociétés de transport.";
...
$_LANG['store']['siteBuilder']['pricingTitle'] = "Tarif";
...
$_LANG['store']['siteBuilder']['upgrade']['recommended'] = "Le forfait recommandé est affiché.";
...
$_LANG['store']['siteBuilder']['upgrade']['to'] = "Mettre à niveau vers :product pour :amount";
$_LANG['store']['siteBuilder']['viewPricing'] = "Afficher les tarifs et les offres";
...
$_LANG['store']['sitelock']['cartTitle'] = "Sécurité des sites Web SiteLock";
...
$_LANG['store']['sitelock']['contentBodyParagraph1'] = "SiteLock&trade;, le leader mondial de la sécurité de site Web, protège votre site Web pour assurer votre sérénité.";
...
$_LANG['store']['sitelock']['contentBodyParagraph3'] = "Par ailleurs, vous obtenez le sceau de confiance SiteLock qui renforce la confiance des clients et qui augmente les ventes et le taux de conversion.";
$_LANG['store']['sitelock']['contentHeadline'] = "Sécurité et protection contre les logiciels malveillants pour votre site Web";
$_LANG['store']['sitelock']['emergencyPlanAftercareContent'] = "Nous continuerons à surveiller votre site pendant 7 jours pour nous assurer qu'il reste exempt de logiciels malveillants après la restauration.";
...
$_LANG['store']['sitelock']['emergencyPlanPaymentContent'] = "Le service d'urgence est disponible pour un tarif unique, il n'y a pas de frais récurrents ni d'abonnement.";
$_LANG['store']['sitelock']['emergencyPlanPaymentTitle'] = "Paiement unique";
$_LANG['store']['sitelock']['emergencyPlanPriorityContent'] = "Avec l'offre urgence, vous bénéficiez d'un accès prioritaire et passez en tête de la file d'attente.";
...
$_LANG['store']['sitelock']['emergencyPlanUpdatesContent'] = "Suivez les progrès grâce à nos mises à jour en temps réel tout au long du processus de nettoyage et de récupération de votre site.";
$_LANG['store']['sitelock']['emergencyPlanUpdatesTitle'] = "Mises à jour en temps réel";
$_LANG['store']['sitelock']['faq'] = "FAQ";
$_LANG['store']['sitelock']['faqFiveBody'] = "Non. Lors d'une analyse de site Web, SiteLock télécharge les fichiers pertinents sur un serveur sécurisé et procède à des analyses. Il n'y a aucun impact sur le contenu du site Web, le code, la bande passante ou les ressources du serveur hébergeant le site Web.";
$_LANG['store']['sitelock']['faqFiveTitle'] = "L'utilisation de SiteLock aura-t-elle un impact sur les performances du site Web ?";
$_LANG['store']['sitelock']['faqFourBodyParagraph1'] = "Une :vulnerabilityStrong est une faiblesse ou une mauvaise configuration dans le code d'un site Web ou d'une application Web qui permet à un attaquant d'obtenir un certain niveau de contrôle du site, voire du serveur d'hébergement. La plupart des vulnérabilités sont exploitées par des moyens automatisés, tels que des scanners de vulnérabilité et des botnets.";
...
$_LANG['store']['sitelock']['faqOneBodyLearnLinkText'] = "cliquez ici pour regarder la vidéo 'How SiteLock Works' (Fonctionnement de SiteLock, en anglais)";
...
$_LANG['store']['sitelock']['faqThreeBody'] = "SiteLock dispose de la technologie pour effectuer une analyse complète du site Web, dont :";
...
$_LANG['store']['sitelock']['faqThreeBodyList2'] = "SiteLock analyse des applications de site Web pour détecter les vulnérabilités courantes qui pourraient compromettre le site.";
...
$_LANG['store']['sitelock']['features']['dailyBlacklistMonitoring'] = "Surveillance quotidienne de la liste noire";
...
$_LANG['store']['sitelock']['featuresCDNContent'] = "Améliorez les performances de votre site web. Distribuez-le et servez-le depuis l'emplacement de la plus proche des internautes pour un chargement plus rapide où qu'ils soient.";
...
$_LANG['store']['sitelock']['featuresTrustSealContent'] = "Rassurez les internautes en affichant que votre site Web est protégé par SiteLock.";
...
$_LANG['store']['sitelock']['title'] = "Sécurité des sites Web SiteLock";
...
$_LANG['store']['sitelockvpn']['cartShortDescription'] = "Le VPN SiteLock permet des sessions de navigation anonymes et chiffrées sur n'importe quelle connexion réseau.";
...
$_LANG['store']['sitelockvpn']['feature1']['highlights']['one'] = "Masquez votre adresse IP";
$_LANG['store']['sitelockvpn']['feature1']['highlights']['six'] = "Naviguez en toute sécurité sur les réseaux Wi-Fi publics";
...
$_LANG['store']['sitelockvpn']['feature1']['subtitle'] = "<strong> Protégez vos données personnelles </strong> et ayez l'esprit tranquille chaque fois que vous utilisez le Wi-Fi public, accédez à des comptes personnels et professionnels en déplacement, ou souhaitez simplement garder votre historique de navigation privé.";
...
$_LANG['store']['sitelockvpn']['feature2']['highlights']['four'] = "Jouez à des jeux verrouillés par région";
$_LANG['store']['sitelockvpn']['feature2']['highlights']['one'] = "Accédez aux sites Web bloqués";
$_LANG['store']['sitelockvpn']['feature2']['highlights']['six'] = "Préservez votre vie privée et restez anonyme";
...
$_LANG['store']['sitelockvpn']['feature2']['subtitle'] = "Du streaming vidéo aux réseaux sociaux, <strong> notre VPN fonctionne partout </strong>. Il vous permet d'accéder aux sites et applications que vous aimez. Bénéficiez d'une plus grande vitesse pour une navigation plus agréable : fini la mise en mémoire tampon et l'attente interminable.";
$_LANG['store']['sitelockvpn']['feature2']['title'] = "Naviguez sur le Web et diffusez du contenu sans limitations.";
$_LANG['store']['sitelockvpn']['feature3']['subtitle'] = "<strong> Configuration VPN en 1 clic</strong> pour Mac, Windows, iOS et Android.";
$_LANG['store']['sitelockvpn']['feature3']['subtitle2'] = "Accédez à Internet où que vous soyez à partir d'un ordinateur, d'un téléphone mobile ou d'une tablette. La configuration automatique est prise en charge pour toutes les principales plates-formes <sup> * </sup>, ce qui vous permet de surfer sans restriction, sans codage ni configuration complexe. <strong> Téléchargez le client et connectez-vous simplement. </strong>";
...
$_LANG['store']['sitelockvpn']['getStarted'] = "Démarrer";
$_LANG['store']['sitelockvpn']['manageService'] = "Gérez votre service VPN SiteLock";
$_LANG['store']['sitelockvpn']['plans']['features']['allInclude'] = "Éléments inclus dans tous les forfaits d'abonnement";
...
$_LANG['store']['sitelockvpn']['subtitle1'] = "Sécuriser et protéger";
...
$_LANG['store']['sitelockvpn']['world']['features']['title'] = "Vitesse très élevée, bande passante illimitée";
...
$_LANG['store']['socialbee']['comparison']['analytics'] = "Analyse des réseaux sociaux";
...
$_LANG['store']['socialbee']['comparison']['comparePrices'] = "Comparaison des tarifs";
...
$_LANG['store']['socialbee']['comparison']['curator'] = "Intégrations de curateurs de contenu";
...
$_LANG['store']['socialbee']['comparison']['exportBrandedReports'] = "Export des rapports de marque";
$_LANG['store']['socialbee']['comparison']['giphy'] = "Intégration GIPHY";
$_LANG['store']['socialbee']['comparison']['importFeeds'] = "Import des flux RSS";
...
$_LANG['store']['socialbee']['comparison']['postSuggestions'] = "Suggestions des meilleures heures de publication";
...
$_LANG['store']['socialbee']['comparison']['unlimited'] = "Illimité";
$_LANG['store']['socialbee']['comparison']['unsplash'] = "Intégration Unsplash";
$_LANG['store']['socialbee']['comparison']['urlshorteners'] = "Intégrations de réducteurs de liens (URL)";
$_LANG['store']['socialbee']['comparison']['users'] = "Utilisateurs";
$_LANG['store']['socialbee']['comparison']['workspaces'] = "Espaces de travail dédiés";
$_LANG['store']['socialbee']['content']['header'] = "Centralisez la gestion de toutes vos tâches liées aux réseaux sociaux.";
...
$_LANG['store']['socialbee']['faq']['a2']['i2'] = "Nous vous proposons l'assistance <a href='href=https://socialbee.com/calendar/'>téléphonique</a>, depuis l'espace de discussion ou par courriel. Nous sommes l'un des rares outils de réseaux sociaux à offrir encore une assistance par téléphone.";
$_LANG['store']['socialbee']['faq']['a2']['i3'] = "<a href='https://socialbee.com/webinars/'>Démonstrations mensuelles en direct</a> de l'utilisation de SocialBee, <a href='https://help.socialbee.com/'>documentation d'aide détaillée</a>, <a href='https://www.youtube.com/@SocialBeeHQ'>courts tutoriels</a>et <a href='https://socialbee.com/resources/'>de nombreuses autres ressources sur les réseaux sociaux</a>.";
$_LANG['store']['socialbee']['faq']['a2']['i4'] = "Une <a href='https://socialbee.com/roadmap/'>feuille de route des produits transparente</a> pour les prochaines étapes de SocialBee.";
$_LANG['store']['socialbee']['faq']['a2']['i5'] = "<a href='https://changelog.socialbee.com/'>Sorties mensuelles de produits</a>.";
$_LANG['store']['socialbee']['faq']['a2']['text'] = "Bénéficiez des avantages suivants avec SocialBee :";
...
$_LANG['store']['socialbee']['features']['analyze']['i1'] = "Obtenez une vue d'ensemble claire de vos progrès sur les réseaux sociaux grâce à des statistiques faciles à comprendre, des graphiques visuels, des cartes, etc.";
...
$_LANG['store']['socialbee']['features']['analyze']['i6'] = "Téléchargez des rapports d'analyse professionnels au format PDF pour les partager avec les clients ou les membres de l'équipe.";
...
$_LANG['store']['socialbee']['features']['collaborate']['i4'] = "Évitez le travail redondant grâce à un espace de collaboration partagé.";
...
$_LANG['store']['socialbee']['features']['create']['i2'] = "Générez des légendes et des images en quelques secondes grâce à l'IA, et accédez à plus de 1 000 invites prédéfinies (prompts) pour gagner du temps.";
...
$_LANG['store']['socialbee']['features']['engage']['i1'] = "Répondez à tous vos commentaires, mentions et messages privés sur les plateformes de réseaux sociaux à partir d'une boîte de réception unique et facile à gérer.";
$_LANG['store']['socialbee']['features']['engage']['i2'] = "Gardez du temps et suivez toutes les conversations sans passer d'un compte de réseau social à l'autre.";
...
$_LANG['store']['socialbee']['features']['schedule']['i5'] = "Réutilisez le contenu à succès intemporel en reprogrammant les publications pour garder votre fil d'actualité à jour, sans avoir à créer constamment de nouveaux contenus.";
...
$_LANG['store']['socialbee']['packages'] = "Afficher les tarifs et les offres";
...
$_LANG['store']['socialbee']['pricing']['header']['body'] = "Afficher les tarifs et les offres";
$_LANG['store']['socialbee']['pricing']['header']['title'] = "Essayez SocialBee et commencez à développer votre présence sur les réseaux sociaux.";
$_LANG['store']['socialbee']['profiles'] = "Profils sociaux : :num";
$_LANG['store']['socialbee']['promo']['sidebar']['body'] = "Centralisez la gestion de tous vos profils de réseaux sociaux.";
$_LANG['store']['socialbee']['promo']['sidebar']['title'] = "SocialBee";
$_LANG['store']['socialbee']['title'] = "SocialBee";
$_LANG['store']['socialbee']['websitePricing']['title'] = "Tarif";
$_LANG['store']['socialbee']['workspaces'] = "Espaces de travail : :num";
$_LANG['store']['socialbee']['workspaceusers'] = "Utilisateurs par espace de travail : :num";
...
$_LANG['store']['spamexperts']['cartTitle'] = "Sécurité de messagerie SpamExperts";
$_LANG['store']['spamexperts']['promo']['sidebar']['body'] = "Bloquez le spam grâce au filtrage de spam professionnel";
...
$_LANG['store']['ssl']['competitiveUpgrades']['buyWithTime'] = "Achetez votre certificat SSL chez nous et bénéficiez de la durée restante de votre certificat SSL actuel, jusqu'à 12 mois supplémentaires.";
...
$_LANG['store']['ssl']['competitiveUpgrades']['enterDomain'] = "Saisissez votre domaine ici";
...
$_LANG['store']['ssl']['competitiveUpgrades']['replace'] = "Remplacez votre certificat SSL actuel sans perte de temps ni d'argent.";
...
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "Qu'est-ce que le certificat \"Basic DV SSL\" ?";
$_LANG['store']['ssl']['dv']['tagline'] = "Sécurisez votre site en quelques minutes !";
$_LANG['store']['ssl']['dv']['title'] = "Certificat SSL de validation de domaine (DV)";
$_LANG['store']['ssl']['ev']['descriptionContent'] = "<p>Le certificat SSL EV est un certificat de validation étendue, la classe de certificat SSL la plus élevée disponible aujourd'hui. Il renforce la crédibilité et la confiance envers votre site Web, davantage qu'un certificat SSL de validation de l'organisation (OV) ou de validation de domaine (DV).</p> <p>Dans la plupart des cas, un certificat de validation étendue affiche le nom de votre organisation ou de votre site en vert dans la barre d'adresse. Cette indication visuelle bien mise en évidence rassure les internautes : elle confirme que l'identité du site a été vérifiée avec rigueur. Cela renforce le niveau de confiance et la perception de fiabilité de votre site. C'est pourquoi, la majorité des grandes entreprises et organisations privilégient les certificats EV.</p>";
$_LANG['store']['ssl']['ev']['descriptionTitle'] = "Qu'est-ce qu'un SSL de validation étendue (EV) ?";
$_LANG['store']['ssl']['ev']['orgInfo'] = "Contient les détails de votre organisation authentifiée EV";
$_LANG['store']['ssl']['ev']['orgInfoDescription'] = "Les détails du certificat indiquent que votre site Web utilise un certificat SSL de validation étendue et incluent l'autorité de certification émettrice, le statut de validité et la date d'expiration.";
$_LANG['store']['ssl']['ev']['tagline'] = "Activez la barre d'adresse verte pour une confiance optimale et des conversions plus élevées.";
$_LANG['store']['ssl']['ev']['title'] = "Certificat SSL de validation étendue (EV)";
...
$_LANG['store']['ssl']['landingPage']['benefits']['higherResults'] = "Google souhaite renforcer la sécurité sur le Web. Cela implique notamment de s'assurer que les sites auxquels les internautes accèdent via Google sont sécurisés. C'est pourquoi il a été démontré que les sites Web utilisant un certificat SSL bénéficient d'un meilleur classement dans les résultats de recherche.";
$_LANG['store']['ssl']['landingPage']['benefits']['https'] = "Activer HTTPS et l'icône de verrouillage";
$_LANG['store']['ssl']['landingPage']['benefits']['legitimacy'] = "Prouver la légitimité";
$_LANG['store']['ssl']['landingPage']['benefits']['privacy'] = "Protéger la confidentialité des internautes";
$_LANG['store']['ssl']['landingPage']['benefits']['reasons'] = "Découvrez encore plus de raisons d'utiliser un certificat SSL pour votre site Web…";
$_LANG['store']['ssl']['landingPage']['benefits']['secure'] = "Sécuriser les transactions en ligne";
$_LANG['store']['ssl']['landingPage']['benefits']['seo'] = "Amélioration du référencement";
$_LANG['store']['ssl']['landingPage']['benefits']['subtitle'] = "Instaurez la confiance et la sécurité en ligne pour les internautes qui consultent votre site Web et pour votre entreprise.";
...
$_LANG['store']['ssl']['landingPage']['browser']['insecureNotice'] = "Les pages Web non diffusées via HTTPS sont désormais affichées comme \"non sécurisées\" dans <strong>Google Chrome </strong> et <strong>Mozilla Firefox</strong>. Ne laissez pas votre site Web en faire partie. Ajoutez un certificat SSL dès maintenant.";
$_LANG['store']['ssl']['landingPage']['browser']['title'] = "Les navigateurs ont évolué, ne vous laissez pas distancer";
$_LANG['store']['ssl']['landingPage']['buy'] = "Acheter";
$_LANG['store']['ssl']['landingPage']['buyNow'] = "Acheter maintenant";
$_LANG['store']['ssl']['landingPage']['certTypeInfo'] = "<a href=\":dvLink\">Les certificats SSL de base (DV, validation de domaine)</a> sont le type de certificat SSL le plus simple et le plus courant. Les certificats <a href=\":ovLink\">OV</a> et <a href=\":evLink\">EV </a> authentifient également l'identité de l'entreprise ou de l'organisation qui détient le certificat, ce qui renforce la confiance des utilisateurs finaux. <br><br>Grâce à nos services de certificats SSL*, vous n'aurez pas à effectuer d'étapes manuelles pour configurer et déployer de nouveaux certificats chaque année. Nous générons un ordre de renouvellement automatiquement lorsque votre certificat approche de la fin de sa validité. Après le paiement, nous configurerons, validerons et fournirons automatiquement votre nouveau certificat pour vous.<br><br><small>* Votre domaine doit être hébergé par le même fournisseur d'hébergement que celui qui a vendu le certificat SSL, et le serveur doit utiliser cPanel, Plesk ou DirectAdmin.</small>";
...
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['trusted'] = "Mondialement reconnu pour sa fiabilité.";
...
$_LANG['store']['ssl']['landingPage']['evs']['dontLeave'] = "Ne laissez pas la porte dérobée de votre site Web aux pirates informatiques : protégez l'ensemble de votre site avec un certificat SSL générique !";
...
$_LANG['store']['ssl']['landingPage']['evs']['secureTitle'] = "Sécurisez l'ensemble de votre site avec un certificat Wildcard SSL";
...
$_LANG['store']['ssl']['landingPage']['evs']['wildcardDescription'] = "Un certificat SSL générique protège votre domaine principal et un nombre illimité de sous-domaines (par exemple : mail.example.com ou ftp.example.com). Même si vous n'avez créé aucun sous-domaine vous-même, vous possédez probablement plusieurs sous-domaines pour les fonctionnalités incluses dans votre offre d'hébergement.";
...
$_LANG['store']['ssl']['landingPage']['faq']['a3'] = "Les certificats SSL reposent sur 3 niveaux de contrôle différents : Validation de domaine (DV), Validation de l'organisation (OV) et Validation étendue (EV). La principale différence entre les types de certificats concerne les informations que l'autorité de certification, RapidSSL, GeoTrust et DigiCert, requièrent et valident pour émettre un certificat. Les niveaux de certificat plus élevés nécessitent plus d'informations et sont souvent affichés dans la barre du navigateur. Avec un certificat SSL EV, la barre de navigateur devient verte et affiche le nom de l'organisation aux internautes pour renforcer la confiance.";
...
$_LANG['store']['ssl']['landingPage']['faq']['a6'] = "Vous pouvez changer à tout moment ! Nous proposons des tarifs très compétitifs et si vous avez déjà un certificat, nous ajouterons la durée de validité restante de votre certificat SSL actuel concurrent, dans la limite de 12 mois supplémentaires.";
...
$_LANG['store']['ssl']['landingPage']['faq']['q3'] = "Quels sont les différents types de certificats SSL ?";
$_LANG['store']['ssl']['landingPage']['faq']['q4'] = "Qu'est-ce qu'un certificat SSL générique (SSL WildCard) ?";
...
$_LANG['store']['ssl']['landingPage']['help']['dv']['browse'] = "Parcourir les certificats de validation de domaine (DV)";
...
$_LANG['store']['ssl']['landingPage']['help']['dv']['type'] = "Un certificat de validation de domaine (DV), c'est un peu comme obtenir une carte de bibliothèque : très peu de formalités, aucune confirmation approfondie de votre identité et une émission en quelques minutes.";
$_LANG['store']['ssl']['landingPage']['help']['dv']['verify'] = "Vérifie la propriété et le contrôle du nom de domaine uniquement";
$_LANG['store']['ssl']['landingPage']['help']['ev']['browse'] = "Parcourir les certificats de validation étendue (EV)";
...
$_LANG['store']['ssl']['landingPage']['help']['ev']['type'] = "Un certificat de validation étendue (EV), c'est un peu comme obtenir un passeport : les processus sont beaucoup plus rigoureux, les délais plus longs et il y a plus de vérifications de votre identité qu'avec une carte de bibliothèque ou un permis de conduire. La validation étendue est reconnue internationalement comme le moyen le plus fiable pour vérifier votre identité.";
...
$_LANG['store']['ssl']['landingPage']['help']['guide'] = "Le besoin de sécurité en ligne est universel, toutefois, les certificats SSL n'ont pas tous les mêmes avantages. Le guide ci-dessous est conçu pour vous aider à choisir le type de certificat qui répond à vos besoins.";
$_LANG['store']['ssl']['landingPage']['help']['ov']['browse'] = "Parcourir les certificats de validation de l'organisation (OV)";
...
$_LANG['store']['ssl']['landingPage']['help']['ov']['type'] = "Un certificat de validation de l'organisation (OV), c'est un peu comme obtenir un permis de conduire : plus de formalités qu'une carte de bibliothèque, mais plus fiable.";
...
$_LANG['store']['ssl']['landingPage']['rapidSSL']['title'] = "Protection basique pour un domaine principal";
...
$_LANG['store']['ssl']['landingPage']['secureInMinutes'] = "Sécurisez votre site en quelques minutes grâce à notre système de provisionnement et de déploiement entièrement automatisé.";
$_LANG['store']['ssl']['landingPage']['tagline1'] = "Sécurisez votre site et inspirez confiance aux internautes.";
$_LANG['store']['ssl']['landingPage']['tagline2'] = "Avec une large gamme de marques, nous avons le bon certificat pour tous les besoins de sécurité de votre site.";
...
$_LANG['store']['ssl']['landingPage']['whatInfo'] = "Les certificats SSL sont essentiels pour la sécurité sur Internet. Ils sont utilisés pour établir une connexion chiffrée et permettre la transmission sécurisée des données entre un navigateur ou l'ordinateur d'un internaute et un serveur ou un site Web.";
$_LANG['store']['ssl']['ov']['descriptionContent'] = "<p>Les certificats SSL de validation de l'organisation (OV) fournissent une confirmation d'identité instantanée et une protection SSL forte pour votre site Web et votre entreprise.</p><p>Le certificat SSL OV est un certificat de validation de l'organisation qui augmente la crédibilité de votre site Web par rapport aux certificats SSL validés par domaine. Il active le cadenas du navigateur et HTTPS, il montre votre identité d'entreprise et assure à vos clients que vous prenez la sécurité très au sérieux. Les internautes qui consultent votre site peuvent vérifier que le site Web est exploité par une entreprise légitime et n'est pas un site imposteur.</p>";
$_LANG['store']['ssl']['ov']['descriptionTitle'] = "Qu'est-ce que le certificat SSL de validation de l'organisation ?";
$_LANG['store']['ssl']['ov']['orgInfo'] = "Contient les informations relatives à votre organisation authentifiée";
$_LANG['store']['ssl']['ov']['orgInfoDescription'] = "Les détails du certificat indiquent que votre site Web utilise un certificat SSL validé par l'organisation et incluent l'autorité de certification émettrice, le statut de validité et la date d'expiration.";
$_LANG['store']['ssl']['ov']['tagline'] = "Le certificat SSL haute sécurité prouve aux internautes qui consultent votre site Web votre identité authentifiée.";
$_LANG['store']['ssl']['ov']['title'] = "Certificat SSL de validation de l'organisation ";
...
$_LANG['store']['ssl']['shared']['dvSsl'] = "Certificat Basic DV SSL (SSL de base, DV)";
...
$_LANG['store']['ssl']['shared']['ev']['visualVerification'] = "Identité visuelle hors pair";
...
$_LANG['store']['ssl']['shared']['fastestSsl'] = "Certifcat SSL le plus puissant et le plus rapide";
$_LANG['store']['ssl']['shared']['features'] = "Caractéristiques du certificat";
$_LANG['store']['ssl']['shared']['freeReissues'] = "Réémissions gratuites";
$_LANG['store']['ssl']['shared']['googleRanking'] = "Boostez votre classement Google";
$_LANG['store']['ssl']['shared']['googleRankingDescription'] = "Google utilise SSL / HTTPS comme facteur pour déterminer le classement des moteurs de recherche. Ajoutez un certificat SSL dès aujourd'hui pour améliorer votre classement Google !";
...
$_LANG['store']['ssl']['shared']['ov']['ov'] = "Validation de l'organisation (OV)";
$_LANG['store']['ssl']['shared']['ov']['ovDescription'] = "Avec un certificat SSL OV, l'identité de la société ou de l'organisation qui détient le certificat est validée, ce qui renforce la confiance des utilisateurs finaux.";
...
$_LANG['store']['ssl']['shared']['price'] = "Tarif";
$_LANG['store']['ssl']['shared']['pricing'] = "Tarif des certificats";
$_LANG['store']['ssl']['shared']['secureTransactions'] = "Sécuriser les transactions en ligne";
$_LANG['store']['ssl']['shared']['seoRank'] = "Amélioration du référencement";
$_LANG['store']['ssl']['shared']['siteSeal'] = "Sceau de confiance du site";
$_LANG['store']['ssl']['shared']['siteSealDescription'] = "Nos certificats SSL sont livrés avec un sceau de confiance qui augmente la confiance des internautes et les conversions de clients.";
$_LANG['store']['ssl']['shared']['switch'] = "Rejoignez-nous !";
...
$_LANG['store']['ssl']['useCases']['infoPages'] = "Pages<br>d'informations";
...
$_LANG['store']['ssl']['useCases']['webmail'] = "Messagerie web";
...
$_LANG['store']['ssl']['wildcard']['descriptionTitle'] = "Qu'est-ce qu'un certificat SSL générique (SSL WildCard) ?";
$_LANG['store']['ssl']['wildcard']['tagline'] = "Sécurisez un nombre illimité de sous-domaines à l'aide d'un certificat unique.";
...
$_LANG['store']['threesixtymonitoring']['button']['startMonitoringLong'] = "Surveillez votre site web";
...
$_LANG['store']['threesixtymonitoring']['comparison']['tagBusiness'] = "Charges élevées";
...
$_LANG['store']['threesixtymonitoring']['modal']['currentStatus'] = "Statut actuel";
...
$_LANG['store']['threesixtymonitoring']['notifications']['email'] = "Adresse e-mail";
...
$_LANG['store']['threesixtymonitoring']['websitePricing']['cta'] = ":tagOpenVous souhaitez surveiller vos serveurs ?:tagClose Des mesures telles que l'utilisation du CPU, du réseau, de la mémoire et du disque.";
$_LANG['store']['threesixtymonitoring']['websitePricing']['title'] = "Tarif";
...
$_LANG['store']['websiteBuilder']['tab']['pricing'] = "Tarif";
...
$_LANG['store']['websiteBuilder']['upgrade']['recommended'] = "Le forfait recommandé est affiché.";
...
$_LANG['store']['websiteBuilder']['upgrade']['to'] = "Mettre à niveau vers :product pour :amount";
$_LANG['store']['weebly']['cartShortDescription'] = "Ajoutez l'outil de création de sites Web en glisser-déposer de Weebly à votre hébergement et créez un site Web, une boutique ou un blog impressionnant.";
...
$_LANG['subaccountSsoDenied'] = "Vous n'avez pas l'autorisation de vous connecter avec l'authentification unique.";
...
$_LANG['subaccountallowedperms'] = "Voici vos autorisations :";
$_LANG['subaccountcontactmaster'] = "Contactez le propriétaire du compte principal si vous pensez qu'il y a une erreur.";
$_LANG['subaccountpermissiondenied'] = "Vous n'avez pas l'autorisation requise pour accéder à cette page.";
$_LANG['subaccountpermissions'] = "Autorisations du sous-compte";
...
$_LANG['subaccountpermsorders'] = "Passer de nouvelles commandes/mises à niveau/annulations";
$_LANG['subaccountpermsproducts'] = "Voir les produits et services";
$_LANG['subaccountpermsproductsso'] = "Procéder à l'authentification unique";
$_LANG['subaccountpermsprofile'] = "Modification du profil du compte principal";
$_LANG['subaccountpermsquotes'] = "Voir et accepter les devis";
...
$_LANG['submitticketdescription'] = "Envoyer une demande d'aide";
$_LANG['subscription']['active'] = "Vous avez un abonnement actif";
$_LANG['subscription']['errorFetchingDetails'] = "Une erreur s'est produite lors de la tentative d'obtention des informations d'abonnement. Veuillez contacter l'assistance.";
...
$_LANG['subscription']['manual'] = "Vous pouvez toujours effectuer un paiement manuel, mais cela peut entraîner un trop-perçu.";
...
$_LANG['subscription']['subscriptionWarning'] = "Tout abonnement actif ci-dessous sera automatiquement appliqué à cette facture. Si un paiement d'abonnement entraîne un trop-perçu, vous recevrez un crédit qui sera appliqué automatiquement à votre prochaine facture.";
...
$_LANG['support']['addCcRecipients'] = "Saisir l'adresse e-mail";
...
$_LANG['support']['clientEmail'] = "L'adresse e-mail du client ne peut pas être ajoutée en tant que destinataire CC.";
$_LANG['support']['deleteEmailNotExisting'] = "Cette adresse :email n'est pas en CC.";
$_LANG['support']['emailNotPossible'] = "Il n'est pas possible d'ajouter l'adresse e-mail :email comme destinataire CC.";
$_LANG['support']['invalidEmail'] = "L'adresse e-mail saisie n'est pas valide.";
...
$_LANG['supportticketclosedmsg'] = "Ce ticket est fermé. Vous pouvez y répondre pour l'ouvrir de nouveau.";
...
$_LANG['supportticketsclientemail'] = "Adresse e-mail";
...
$_LANG['supportticketsdescription'] = "Voir les demandes existantes et y répondre";
$_LANG['supportticketserror'] = "Erreur";
$_LANG['supportticketserrornoemail'] = "Vous n'avez pas saisi votre adresse e-mail.";
...
$_LANG['supportticketsstatuscloseticket'] = "Si le problème est résolu, cliquez ici pour fermer le ticket.";
...
$_LANG['supportticketssystemdescription'] = "Notre système de demande d'assistance nous permet de répondre à vos demandes le plus rapidement possible. Lorsqu'une réponse est disponible, un courriel vous en informe immédiatement.";
$_LANG['supportticketsticketattachments'] = "Pièce(s) jointe(s)";
$_LANG['supportticketsticketcreated'] = "Demande créée";
$_LANG['supportticketsticketcreateddesc'] = "Votre demande de support a bien été créée. Un courriel avec les détails de votre demande vous a été expédié. Si vous désirez consulter votre demande, vous pouvez le faire dès à présent.";
...
$_LANG['supportticketsticketurgencyhigh'] = "Élevée";
...
$_LANG['supportticketsuploadtoolarge'] = "Le fichier joint est trop volumineux. Veuillez essayer avec un fichier plus petit.";
$_LANG['supportticketsviewticket'] = "Afficher le ticket";
$_LANG['suspendreason'] = "Motif de suspension";
$_LANG['suspendreasonoverdue'] = "Paiement en retard";
$_LANG['switchAccount']['cancelAndReturn'] = "Annuler et revenir à la page d'accueil";
$_LANG['switchAccount']['choose'] = "Choisissez un compte pour la connexion et la gestion";
$_LANG['switchAccount']['createInstructions'] = "Pour créer un nouveau compte, vous devrez passer une nouvelle commande.";
$_LANG['switchAccount']['forcedSwitchRequest'] = "Pour accéder à cette URL, il faut être connecté comme un autre client.";
...
$_LANG['tableempty'] = "Affichage : 0 à 0 /sur 0";
$_LANG['tableentersearchterm'] = "Saisissez un mot-clé…";
$_LANG['tablefiltered'] = "(filtré sur : _MAX_ résultats au total)";
$_LANG['tablelength'] = "Afficher les entrées _MENU_";
$_LANG['tableloading'] = "Chargement en cours…";
$_LANG['tablepagesfirst'] = "Premier";
$_LANG['tablepageslast'] = "Dernier";
$_LANG['tablepagesnext'] = "Suivant";
$_LANG['tablepagesprevious'] = "Précédent";
$_LANG['tableprocessing'] = "En cours de traitement…";
$_LANG['tableshowing'] = "Affichage : _START_ à _END_ / _TOTAL_";
$_LANG['tableviewall'] = "Toutes";
...
$_LANG['tax']['taxLabel'] = "Numéro fiscal";
$_LANG['tax']['vatLabel'] = "Numéro TVA";
$_LANG['telesignincorrectpin'] = "Code PIN incorrect !";
$_LANG['telesigninitiatephone'] = "Nous ne pouvons pas procéder à la validation téléphonique de votre numéro. Veuillez nous contacter.";
$_LANG['telesigninvalidnumber'] = "Numéro de téléphone non valide";
$_LANG['telesigninvalidpin'] = "Le code PIN que vous avez saisi n'est pas valide !";
$_LANG['telesigninvalidpin2'] = "Le code PIN que vous avez saisi n'est pas valide.";
$_LANG['telesigninvalidpinmessage'] = "Échec de la vérification du code PIN";
$_LANG['telesignmessage'] = "La vérification téléphonique pour le numéro %s a débuté. Veuillez patienter…";
$_LANG['telesignphonecall'] = "Appel téléphonique";
$_LANG['telesignpin'] = "Saisissez votre code PIN : ";
$_LANG['telesignsms'] = "SMS";
$_LANG['telesignsmstextmessage'] = "Merci d'utiliser notre service de vérification par SMS. Votre code est : %s Veuillez saisir ce code sur votre ordinateur maintenant.";
...
$_LANG['telesignverificationproblem'] = "Il y a un problème avec le service de vérification téléphonique et votre commande n'a pu être validée. Veuillez réessayer ultérieurement.";
$_LANG['telesignverify'] = "Votre numéro de téléphone %s doit être vérifié afin de terminer votre commande.";
$_LANG['thankYou'] = "Merci";
$_LANG['thereisaproblem'] = "Oups, il y a un problème…";
$_LANG['ticketfeedbackforticket'] = "pour le ticket nᵒ ";
$_LANG['ticketfeedbackrequest'] = "Évaluation";
$_LANG['ticketfeedbacktitle'] = "Demande d'évaluation liée à votre ticket";
$_LANG['ticketinfo'] = "Informations sur le ticket";
$_LANG['ticketmerge'] = "FUSIONNÉ";
$_LANG['ticketratingexcellent'] = "Excellente";
$_LANG['ticketratingpoor'] = "Pauvre";
$_LANG['ticketratingquestion'] = "Comment évalueriez-vous cette réponse ?";
$_LANG['ticketreatinggiven'] = "Vous avez déjà donné votre avis sur cette réponse.";
$_LANG['ticketsyourhistory'] = "Historique de vos tickets";
$_LANG['tld'] = "TLD";
$_LANG['tldpricing'] = "Tarifs des TLD";
$_LANG['toggleNav'] = "Basculer la navigation";
$_LANG['top'] = "Haut";
$_LANG['total'] = "Total";
$_LANG['transferExtend'] = "Transférez dès maintenant pour prolonger votre domaine d'un an.";
$_LANG['transferYourDomain'] = "Transférez votre domaine";
$_LANG['transferdomain'] = "Transférer un domaine";
$_LANG['transferdomaindesc'] = "Vous souhaitez transférer votre domaine chez nous ? Si oui, saisissez votre domaine ci-dessous pour commencer.";
...
$_LANG['twoFactor']['disabled'] = "Authentification à deux facteurs désactivée";
...
$_LANG['twoFactor']['enabled'] = "Authentification à deux facteurs activée";
...
$_LANG['twofa2ndfactorincorrect'] = "Le deuxième facteur saisi est incorrect. Veuillez réessayer. Vous avez encore :attempts tentatives.";
$_LANG['twofa2ndfactorreq'] = "Un second facteur d'authentification est requis pour finaliser la connexion.";
$_LANG['twofaactivationerror'] = "Impossible d'activer l'authentification à deux facteurs. Veuillez réessayer ultérieurement.";
$_LANG['twofaactivationintro'] = "L'authentification à deux facteurs ajoute une couche de protection supplémentaire lors des connexions. Une fois qu'elle est activée et configurée, vous devrez saisir votre identifiant et mot de passe ainsi qu'un second facteur d'identification comme code de sécurité à chaque nouvelle connexion.";
$_LANG['twofaactivationmultichoice'] = "Pour continuer, veuillez choisir ci-dessous la méthode d'authentification à deux facteurs que vous souhaitez utiliser.";
...
$_LANG['twofadisableintro'] = "Pour désactiver l'authentification à deux facteurs, veuillez confirmer votre mot de passe dans le champ ci-dessous.";
$_LANG['twofaenable'] = "Activer l'authentification à deux facteurs";
$_LANG['twofaenableclickhere'] = "Cliquez ici pour activer";
$_LANG['twofaenforced'] = "Pour votre sécurité, vous devez activer l'authentification à deux facteurs avant de continuer vers votre espace client. Cette page vous guidera tout au long du processus.";
$_LANG['twofageneralerror'] = "Une erreur est survenue lors du chargement du module. Veuillez réessayer.";
$_LANG['twofaloginusingbackupcode'] = "Connexion avec votre code de récupération";
$_LANG['twofamoduleerror'] = "Une erreur est survenue lors du chargement du module. Veuillez réessayer.";
...
$_LANG['twofasetupgetstarted'] = "Démarrer";
$_LANG['twoipcodemissmatch'] = "Le code que vous avez saisi ne correspond pas à celui attendu. Veuillez réessayer.";
$_LANG['twoipconnect'] = "Connecter votre application";
$_LANG['twoipduo'] = "Duo";
$_LANG['twoipenterauth'] = "Saisissez le code d'authentification";
...
$_LANG['twoipverificationstepmsg'] = "Saisissez le code à 6 chiffres généré par l'application pour vérifier et terminer la configuration.";
...
$_LANG['unlink'] = "Supprimer le lien";
...
$_LANG['unsubscribehashinvalid'] = "Lien non valide. Veuillez réessayer.";
$_LANG['unsubscribesuccess'] = "Désabonnement réussi";
$_LANG['upTo'] = "Jusqu'à :num";
$_LANG['update'] = "Mettre à jour";
$_LANG['updateProductQuantity'] = "Mettre à jour";
$_LANG['updateTotals'] = "Mettre à jour le total";
$_LANG['updateWhoisContact'] = "Mettre à jour les informations WHOIS de votre domaine";
$_LANG['updatecart'] = "Mettre à jour le panier";
$_LANG['upgrade'] = "Mettre à niveau";
...
$_LANG['upgradeService']['recommended'] = "Recommandé";
...
$_LANG['upgradechooseconfigoptions'] = "Passez à une version supérieure ou inférieure pour les options configurables de ce produit.";
...
$_LANG['upgradeexistingupgradeinvoice'] = "Vous ne pouvez ni mettre à niveau ni rétrograder ce produit actuellement : une mise à niveau/rétrogradation est déjà en cours.<br /><br />Pour continuer, veuillez d'abord régler la facture impayée. Vous serez alors en mesure d'effectuer la mise à niveau/rétrogradation et vous serez soit facturé soit crédité de la différence.<br/><br/>Si vous pensez que vous recevez ce message par erreur, veuillez ouvrir un ticket d'incident.";
...
$_LANG['upgradesummary'] = "Ci-dessous se trouve le récapitulatif de votre commande de mise à niveau.";
$_LANG['usageLastUpdated'] = "Dernière mise à jour";
...
$_LANG['usagebilling']['metric']['emailAccounts'] = "Comptes courriel";
...
$_LANG['userManagement']['accountOwnerPermissionsInfo'] = "Les propriétaires de compte disposent toujours de toutes les autorisations sur un compte client.";
$_LANG['userManagement']['actions'] = "Actions";
$_LANG['userManagement']['allPermissions'] = "Toutes les autorisations";
$_LANG['userManagement']['alreadyInvited'] = "Il y a déjà une invitation active correspondant à cette adresse e-mail.";
...
$_LANG['userManagement']['removeAccessInfo'] = "Ce compte ne sera plus accessible ni gérable.";
...
$_LANG['userProfile']['changeEmail'] = "Changer l'adresse e-mail";
...
$_LANG['validation']['accepted'] = "L'attribut :attribute doit être accepté.";
$_LANG['validation']['active_url'] = ":attribute n'est pas une URL valide.";
$_LANG['validation']['after'] = ":attribute doit être une date ultérieure à :date.";
$_LANG['validation']['alpha'] = ":attribute ne peut contenir que des lettres.";
$_LANG['validation']['alpha_dash'] = "Le :attribute ne peut contenir que des lettres, des chiffres et des tirets.";
$_LANG['validation']['alpha_num'] = "L'attribut :attribute ne peut contenir que des lettres et des chiffres.";
$_LANG['validation']['array'] = ":attribute doit être un tableau.";
$_LANG['validation']['before'] = "L'attribut :attribute doit être une date antérieure à :date.";
$_LANG['validation']['between']['array'] = ":attribute doit comporter entre :min et :max éléments.";
$_LANG['validation']['between']['file'] = ":attribute doit avoir entre :min et :max kilo-octets.";
$_LANG['validation']['between']['numeric'] = ":attribute doit être entre :min et :max.";
$_LANG['validation']['between']['string'] = ":attribute doit comporter entre :min et :max caractères.";
$_LANG['validation']['boolean'] = "La valeur du champ :attribute doit être vrai ou faux.";
$_LANG['validation']['confirmed'] = "La confirmation :attribute ne correspond pas.";
$_LANG['validation']['date'] = ":attribute n'est pas une date valide.";
$_LANG['validation']['date_format'] = "L'attribut :attribute ne correspond pas au format :format.";
$_LANG['validation']['different'] = ":attribute et :other doivent être différents.";
$_LANG['validation']['digits'] = ":attribute doit comporter :digits chiffres.";
$_LANG['validation']['digits_between'] = ":attribute doit comporter entre :min et :max chiffres.";
$_LANG['validation']['email'] = ":attribute doit être une adresse e-mail valide.";
$_LANG['validation']['exists'] = "L'attribut :attribute sélectionné n'est pas valide.";
$_LANG['validation']['filled'] = "Le champ :attribute est obligatoire.";
$_LANG['validation']['image'] = "Cet attribut :attribute doit être une image.";
$_LANG['validation']['in'] = "L'attribut :attribute sélectionné n'est pas valide.";
$_LANG['validation']['integer'] = ":attribute doit être un nombre entier.";
$_LANG['validation']['ip'] = ":attribute doit correspondre à une adresse IP valide.";
$_LANG['validation']['json'] = "L'attribut :attribute doit être une chaîne JSON valide.";
$_LANG['validation']['max']['array'] = ":attribute : ne peut pas comporter plus de :max éléments.";
$_LANG['validation']['max']['file'] = "Le fichier :attribute ne peut pas être supérieur à :max kilo-octets.";
$_LANG['validation']['max']['numeric'] = "L'attribut :attribute ne peut pas être supérieur à :max.";
$_LANG['validation']['max']['string'] = ":attribute doit comporter moins de :max caractères.";
$_LANG['validation']['mimes'] = ":attribute doit être un fichier de type : :values.";
$_LANG['validation']['min']['array'] = ":attribute doit avoir au moins :min éléments.";
$_LANG['validation']['min']['file'] = "Le fichier :attribute doit avoir au moins :min kilo-octets.";
$_LANG['validation']['min']['numeric'] = ":attribute doit être au moins :min.";
$_LANG['validation']['min']['string'] = ":attribute doit comporter au moins :min caractères.";
$_LANG['validation']['not_in'] = ":attribute n'est pas valide.";
$_LANG['validation']['numeric'] = "L'attribut :attribute doit être un nombre.";
$_LANG['validation']['present'] = "Le champ :attribute doit être présent.";
$_LANG['validation']['regex'] = "Le format :attribute n'est pas valide.";
$_LANG['validation']['required'] = "Le champ :attribute est obligatoire.";
$_LANG['validation']['required_if'] = "Le champ :attribute est obligatoire lorsque :other est :value.";
$_LANG['validation']['required_unless'] = "Le champ :attribute est obligatoire sauf si :other se trouve dans :values.";
$_LANG['validation']['required_with'] = "Le champ :attribute est obligatoire lorsque :values est présent.";
$_LANG['validation']['required_with_all'] = "Le champ :attribute est obligatoire lorsque :values est présent.";
$_LANG['validation']['required_without'] = "Le champ :attribute est obligatoire lorsque :values n'est pas présent.";
$_LANG['validation']['required_without_all'] = "Le champ :attribute est obligatoire lorsqu'aucune valeur :values n'est présente.";
$_LANG['validation']['same'] = ":attribute et :other doivent correspondre.";
$_LANG['validation']['size']['array'] = ":attribute doit contenir :size éléments.";
$_LANG['validation']['size']['file'] = ":attribute doit avoir :size kilo-octets.";
$_LANG['validation']['size']['numeric'] = ":attribute doit être :size.";
$_LANG['validation']['size']['string'] = "L'attribut:attribute doit avoir :size caractères.";
$_LANG['validation']['string'] = "L'attribut :attribute doit être une chaîne.";
$_LANG['validation']['timezone'] = "L'attribut :attribute doit être une zone valide.";
$_LANG['validation']['unique'] = "L'attribut :attribute a déjà été utilisé.";
...
$_LANG['veportallogin'] = "Se connecter à vePortal";
$_LANG['verifyEmailAddress'] = "Merci de vérifier votre messagerie et d'ouvrir le lien pour vérifier votre adresse.";
$_LANG['view'] = "Afficher";
...
$_LANG['virtualminlogin'] = "Se connecter au panneau de contrôle";
...
$_LANG['vpsnetdaily'] = "Tous les jours";
$_LANG['vpsnetgenbackup'] = "Générer la sauvegarde";
$_LANG['vpsnethourly'] = "Toutes les heures";
...
$_LANG['vpsnetpowermanagement'] = "Gestion alimentation";
...
$_LANG['websitepanellogin'] = "Se connecter au panneau de contrôle";
$_LANG['weekly'] = "Hebdomadaire";
$_LANG['welcomeback'] = "C'est un plaisir de vous revoir !";
$_LANG['whmsoniclogin'] = "Se connecter au panneau de contrôle";
...
$_LANG['wptk']['installWordPress'] = "Installer WordPress";
...
$_LANG['xpanellogin'] = "Se connecter à XPanel";
$_LANG['xpanelmaillogin'] = "Se connecter au Webmail";
$_LANG['year'] = "An";
$_LANG['years'] = "Ans";
$_LANG['yes'] = "Oui";
$_LANG['youhaveoverdueinvoices'] = "Vous avez %s facture(s) en retard";
$_LANG['yourProfile'] = "Votre profil";
$_LANG['yourclientareahostingaddons'] = "Les modules complémentaires suivants sont disponibles pour ce produit.";
