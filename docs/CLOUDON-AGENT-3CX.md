...
mod_cpm_calls            μία γραμμή ανά κλήση (3CX call)
  ...
  recording_storage_id,                  ← δικό μας Storage layer
  transcript TEXT, pbx_summary TEXT, sentiment INT,
...
- Ηχογραφήσεις = προσωπικά δεδομένα. Πρόσβαση με ρητό cap, καταγραφή ποιος
  άκουσε τι, πολιτική διαγραφής. **Δεν κατεβάζουμε ηχογραφήσεις χωρίς απόφαση.**
