<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/orderforms/cloudon/css/all.min.css?v={$versionHash}" />
<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/orderforms/cloudon/css/style.css?v={$versionHash}" />
<script type="text/javascript" src="{$WEB_ROOT}/templates/orderforms/cloudon/js/scripts.min.js?v={$versionHash}"></script>
