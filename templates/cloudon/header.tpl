...
<html lang="{if $language == 'greek'}el{else}en{/if}">
    ...
    {literal}<script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"Cloud On","url":"https://my.cloudon.gr/","logo":"https://my.cloudon.gr/templates/cloudon/assets/img/logo-cloudon.png","telephone":"+302102241998","contactPoint":{"@type":"ContactPoint","telephone":"+302102241998","contactType":"customer service","areaServed":"GR","availableLanguage":["el","en"]},"sameAs":["https://cloudon.gr/"]}</script>{/literal}
