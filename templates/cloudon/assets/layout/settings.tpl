		...
		<div class="dropdown-menu settings">
			...
			{if $language eq 'chinese' || $language eq 'danish' || $language eq 'estonian' || $language eq 'german' || $language eq 'italian' || $language eq 'portuguese-br' || $language eq 'russian' || $language eq 'turkish' || $language eq 'azerbaijani' || $language eq 'croatian' || $language eq 'dutch' || $language eq 'macedonian' || $language eq 'portuguese-pt' || $language eq 'spanish' || $language eq 'ukranian' || $language eq 'catalan' || $language eq 'czech' || $language eq 'english' || $language eq 'french' || $language eq 'hungarian' || $language eq 'norwegian' || $language eq 'romanian' || $language eq 'swedish'}<html dir="ltr">
				...
				<div class="dir-version">
					<div class="btnv" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="LTR Version"><a href="{$WEB_ROOT}/cart.php?carttpl=cloudon&systpl=cloudon&language=english">L</a></div>
					<div class="btnv" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="RTL Version"><a href="{$WEB_ROOT}/cart.php?carttpl=cloudon&systpl=cloudon&language=arabic">R</a></div>
				</div>
			<html>
			{/if}
			...
			{if $language eq 'arabic' || $language eq 'farsi' || $language eq 'hebrew'}<html dir="rtl">
				...
				<!-- LTR & RTL Version -->
				<div class="dir-version">
					<div class="btnv" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="LTR Version"><a href="{$WEB_ROOT}/cart.php?carttpl=cloudon&systpl=cloudon&language=english">L</a></div>
					<div class="btnv" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="RTL Version"><a href="{$WEB_ROOT}/cart.php?carttpl=cloudon&systpl=cloudon&language=arabic">R</a></div>
				</div>
