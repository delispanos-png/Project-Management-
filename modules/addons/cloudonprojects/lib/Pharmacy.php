...
CSS;
    ...
    public static function docHtml($cfg)
    {
        ...
        $P[] = self::mk('<h2 class="sub"><span class="num">2.5</span>Τρόπος Πληρωμής</h2>'
            ...
            . '</tbody></table>'
            /* ΔΕΝ δεσμευόμαστε σε ποσό 2ου έτους (απόφαση 11/9/2026): οι αξίες των
               αδειών αναπροσαρμόζονται, οπότε ένα γραμμένο νούμερο γίνεται υπόσχεση
               που δεν μπορούμε να κρατήσουμε. Λέμε ΤΙ ανανεώνεται, όχι πόσο. */
            ...
            . 'αυτόματα κάθε έτος, με βάση τον εκάστοτε ισχύοντα τιμοκατάλογο. Οι εφάπαξ '
            . 'υπηρεσίες παραμετροποίησης και διασύνδεσης χρεώνονται μία μόνο φορά.</p>'
