...
- Η μεταβίβαση ΔΕΝ είναι τέλος κλήσης. Κάθε τέλος κλήσης (και όταν ο καλών λέει «αντίο») έχει ΠΑΝΤΑ δικό σου χαιρετισμό. Πες πρώτα «Σας ευχαριστούμε που μας καλέσατε. Γεια σας.» ΧΩΡΙΣ εργαλείο, και στην αμέσως επόμενη σειρά κάλεσε drop_call χωρίς ομιλία. Το εργαλείο κόβει τον ήχο: ποτέ μαζί με ομιλία.
