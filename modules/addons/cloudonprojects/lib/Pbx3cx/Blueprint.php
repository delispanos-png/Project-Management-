    ...
    public static function modeBlock($mode)
    {
        $rules = [
            ...
            'emergency' => "- Το γραφείο είναι ΚΛΕΙΣΤΟ. Λειτουργεί ΜΟΝΟ η έκτακτη γραμμή. Το πρώτο μήνυμα το είπε ήδη — μην το επαναλάβεις.\n"
                ...
                . "- Ticket: πάρε όνομα, επιχείρηση, τηλέφωνο επιστροφής και σύντομη περιγραφή, μετά σύνδεσε στο «Καταχώρηση αιτήματος» για να το πει και ηχογραφημένα. Μήνυμα: σύνδεσε αμέσως στο «Καταχώρηση αιτήματος».\n"
                . "- Και στα δύο πες ότι θα τον καλέσουμε την επόμενη εργάσιμη ημέρα.",
