...
έργα πελατών. Η αποθήκευση **μπλοκάρει** έργο πελάτη χωρίς `clientid`: το datalist δέχεται
ελεύθερο κείμενο και μέχρι τώρα το έργο αποθηκευόταν σιωπηλά χωρίς πελάτη.
